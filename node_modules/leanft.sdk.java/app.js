...
var JavaFactory = require("./lib/java_factory.js").JavaFactory;
var DescriptionsAndEnums = {
    UiObject: require("./lib/ui_object.js").UiObject,
    Window: require("./lib/window.js").Window,
    Applet: require("./lib/applet.js").Applet,
    Dialog: require("./lib/dialog.js").Dialog,
    InternalFrame: require("./lib/internal_frame.js").InternalFrame,
    ...
    SpinBox: require("./lib/spin_box.js").SpinBox,
    ...
    ExpandBar: require("./lib/expand_bar.js").ExpandBar,
    TreeView: require("./lib/tree_view.js").TreeView,
    CheckBox: require("./lib/check_box.js").CheckBox,
    List: require("./lib/list.js").List,
    Slider: require("./lib/slider.js").Slider,
    SliderOrientation: require("./lib/slider.js").SliderOrientation,
    UiEvent: require("./lib/event_info.js").UiEvent,
    UiEventInfo: require("./lib/event_info.js").UiEventInfo,
    KeyboardEvent: require("./lib/event_info.js").KeyboardEvent,
    KeyboardEventInfo: require("./lib/event_info.js").KeyboardEventInfo,
    MouseEvent: require("./lib/event_info.js").MouseEvent,
    MouseEventInfo: require("./lib/event_info.js").MouseEventInfo
};
...
// SIG // lvl4OgMXrw1gY6is5M7xXTjvxS3tMwqMpRR7e2ZYNrCg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDW84ebdMyet0Pq0Cn2BVO2
// SIG // RcohIWlXQKkQR/1XV/MxlTANBgkqhkiG9w0BAQEFAASC
// SIG // AQCs9abbVz/bLZiCuTKr6J50nhYd+MnX96o1wGljQ4yV
// SIG // q8bkf/j0RW8F/Y22mAgE9lxtdd9DaP3qs26DwNm5unQz
// SIG // FfMvGsYP8ULd+KeM15jF+xspyM3DPHe3WlNXiAyg+GWb
// SIG // MM42lPWxx9m1OQ57ph6PiEgRHEz2oCTXCVHbEb8pjAHG
// SIG // o/oTgM9j0Dr8JIH3eXn+Pe4kyLXaGDJFUhwJTqxYLBJy
// SIG // IsFOV+EQ5bJlbUuZ8pDTE/2n8q2WtpZUC9JsqR5IPbLF
// SIG // ZCfH8JX97gXZgEJfacbOBX1RCnNBhi6WE02ScfsuJQQx
// SIG // GWezOV2dKnNKH12X9wHXu0s4cAqnb+TgQYyQoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgapeEQ0fYJJHbTds9
// SIG // ZpLLBl6mihkWHpYFFeWQ9x0vKdoCFFpBv4KioltMED9F
// SIG // b8Y2EGGpMZ8mGA8yMDE4MDIxMzE2NDUzOVowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDUzOVowLwYJ
// SIG // KoZIhvcNAQkEMSIEIETk8R+uRAFvjqkccAqoH16SWlNk
// SIG // znzKlT6omdA60ymgMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBC4oe4lmoKJDARKQav
// SIG // gLcj83Ujz1jSMYT6Fw7mlmOu4bRSj5hC8TAOSKzc0yeZ
// SIG // Bs134zLKOARWrwFAcFWn2icuRWD3SNjZjzGUANnevLPu
// SIG // 5u5WNqCy40KBA5iLThVWkClgQWi6N5szgBUqQFaHXA0S
// SIG // fQddIduH0DUsAm+UM0e7jzEaHMTQRp7Uf+BJOg/DjME6
// SIG // uNXgQCJOP1FaVjevR+iwQHKYyogQwQFK1GaLb35nvdMR
// SIG // jzpdb8knFv/rKBlMyW/pONv1nWYPMK/VH+Dns0VSXfIi
// SIG // lPCJ3nOu6KCusznndrL9Z9asybIm9T9+t0Jh+V/eq/Sc
// SIG // F/hbupy/rQC9tjsQ
