...
var AppletTO = require("./applet.js").AppletTO;
var DialogTO = require("./dialog.js").DialogTO;
var InternalFrameTO = require("./internal_frame.js").InternalFrameTO;
var ButtonTO = require("./button.js").ButtonTO;
var EditorTO = require("./editor.js").EditorTO;
var LinkTO = require("./link.js").LinkTO;
var SliderTO = require("./slider.js").SliderTO;
...
var ExpandBarTO = require("./expand_bar.js").ExpandBarTO;
var TreeViewTO = require("./tree_view.js").TreeViewTO;
var CheckBoxTO = require("./check_box.js").CheckBoxTO;
var ListTO = require("./list.js").ListTO;

function JavaFactory(session){	
    this._logger = new Logger("Java.TestObjectFactory");
    this._session = session;
    this._technology = "Java";

    ObjUtils.extend(this, ConcreteFactoryBehavior);
}

JavaFactory.prototype = {
    _logger: null,
    _session: null,
    _technology: null,
    ...
    _nativeClassToLeanFtType: {
        ...
        "javaapplet": "applet",
        "javadialog": "dialog",
        "javainternalframe": "internalframe",
        "javabutton": "button",
        "javaedit": "editor",
        "javalink": "link",
        "javaslider": "slider",
        "javatab": "tabcontrol",
        "javamenu": "menu",
        "javastatictext": "label",
        "javacalendar": "calendar",
        "javaspin": "spinbox",
        "javatable": "table",
        "javatoolbar": "toolbar",
		"javaradiobutton": "radiobutton",
		"javaexpandbar": "expandbar",
		"javatree": "treeview",
        "javacheckbox": "checkbox",
        "javalist": "list"
    }
};
module.exports.JavaFactory = JavaFactory;
...
// SIG // 8bMw9KVcY2Y7NDhksaYaxy9pJg8gI/BKiVhBf9PtNumg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDhV22qYSaoTVYi1rNQtJ2m
// SIG // 87Oet2DC2qDmXzVGbw/N/jANBgkqhkiG9w0BAQEFAASC
// SIG // AQCnQvo0a8jj2AlStHH4Er9YJvw2n0UtKTnh7yi7vn01
// SIG // nrKiGODvO1V7OOxdG/y0RIDYqelZdjyjKKCkOYhv5mgO
// SIG // l+ehINm1S15NzsJLjg2CNVMdcXlmOvlNzjC+u8NlJT1v
// SIG // 3I+YV+zMvc1vkwr4LsS8+wuD8i09jlrYqZ1BCEh/hubS
// SIG // y+KYzyla6yjot9ynLIwC1/tx3tdqYC1Go1q0Cs5+Dxam
// SIG // sU7qhRkvoZIowqtnnb3NUh+B5lFdy1Cqy/G3oAAlrCHM
// SIG // H5kjsshM1tNSQ4It8e9rSbQi+TvvuqX5jkMNFmQOzyh0
// SIG // As0x98l4G980LJkcyPfzPX3xTfcLsZXV4tSVoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgpB3EnNOKTLy1FDql
// SIG // DO4JpJwZw1AHZ8j8ghGzSzhra3kCFQCh0OSH62lnjcDG
// SIG // 2d9F9r/ipOs+gRgPMjAxODAyMTMxNjQ1MzlaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjQ1MzlaMC8G
// SIG // CSqGSIb3DQEJBDEiBCAKGswREi1L5ubvh5e5OG66Ue3t
// SIG // r+LrUdJS0+8Gz/wQtzA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAg0UYKs/iCZdu+Ljb
// SIG // bTxRDhe0B/gbiry3by1dtgZo4jBif4oVnEVJgCUZ2OkC
// SIG // ZI8V8J2r/eWD2Txx4PZonYUJv7NPE+bC64SmInVbqhwS
// SIG // GKe0nRiiWkTn0dJaMzTHVmcMK+ku2Q5hVWbNwtFo/MwE
// SIG // ngqekx/brwSmIeClpM0L1GJRkK8h5aEcjBWquPN+oxqF
// SIG // 09Yan98lS6zeLTNTCd0tQ5FjHg7kHJ15W8YztjuLa0Us
// SIG // O0lk0e+2oy4x6be09L4MKFm7+4LM+jYQtuGVMBskcByG
// SIG // 0ARn61RyKHcliDXkd3nETAJb4+4tv5je/IloQPYZwUFn
// SIG // W2jBIEVOk2746P0Ypw==
