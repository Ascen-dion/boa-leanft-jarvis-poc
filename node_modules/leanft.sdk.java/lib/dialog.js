...
function Dialog(props) {
    ...
    ObjUtils.extend(dialogDesc, WindowDescriptionBehavior);
    dialogDesc._defineByPropertyBag(props);
    return dialogDesc;
}

/**
 * A Java Dialog test object
 * @constructor
 * @class DialogTO
...
function DialogTO(session, description) {
    ...
    var dialogTO = new UiObjectBaseTO("JavaDialog", session, description);
    ObjUtils.extend(dialogTO, WindowObjectBaseBehavior);
    ObjUtils.extend(dialogTO, WindowObjectBaseExtendedBehavior);
...
// SIG // GQX0ZfDOArHZagX/rEud28hzVXYGHTGr5w27AQ5qVyig
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCCtIHbpkW1agnmus/XvX4/2
// SIG // l6VhzQILnH+uPFXL/tXUmjANBgkqhkiG9w0BAQEFAASC
// SIG // AQBDy3oahUXhvHGLMUjVgUSgZb3EITx5+VMYXmA/JGJD
// SIG // 0FnFh+vDs8tqKoLPuvYksdh9BWVDmaMJxMJm1jGM8yQM
// SIG // 5BFrUGKp8ZP1XQxFON+n3TBWsUOGxK4VITiwkHJi0KFi
// SIG // 3PBIp9vFaJKKhrA+CT/SJ2BXkXNWlw7gA0t1cM37VCNq
// SIG // CjnFMWQLLcolRnRHIfibugJZ2wl/vJWbNmn7B9QKb0Rl
// SIG // zaTXJv578riD0Gls6/yDYal/i+L0PrvLf0Zqj5qrF2tS
// SIG // iIPxCKyoszt61pSI07f2MpykfUJrWvB8Z6ca9YgdG2qh
// SIG // krcDSfX1l/LSMBXNTFpTInfKKgyUD7pRhNN3oYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQg7hdvTVu4LOGKGmBF
// SIG // QpC07dOZwNMnEbwwnsoOV8I04u4CFQDJsUsPmihcqCJc
// SIG // 8KSZOBpv/ZPa5BgPMjAxODAyMTMxNjQ1MzhaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjQ1MzhaMC8G
// SIG // CSqGSIb3DQEJBDEiBCBqCgWGhf1jRkH2UDtpKAhwUOcm
// SIG // pSQP3OfzhWPX+EYy1jA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAgT0Si/qKph4YqsAj
// SIG // fq+C9DIJT45hYJkvMlOZMA+el4g3w6fYerkq1zuXoOe4
// SIG // 9+bswsL0KHbDPpvEFVkgeolOo4TwXF60Qxr9DjjDPq07
// SIG // 22+7fbO10ZPt2khNiTppr63sKmTxg9gH/RzbelZs6kVg
// SIG // TDu3Oxm7PAr6+VXwmpfYu14XUmGkzTDOBSHiEk38Ipa6
// SIG // 9ZSXCDutzyKbYprhwffyQJlY8P0Zra0Hm2zly7TBT0pq
// SIG // Wsn04LzAOZ0H0/5wHDzKkNg0rMT2lJV25luiIIgO1ZeB
// SIG // ACDzqtBMVVLRZMr2d4cEJrcEKYoHSeYvh1vYEsGOZBuf
// SIG // c8aaKjUMWaA8usUcMQ==
