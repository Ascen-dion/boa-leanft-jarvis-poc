...
var TableTOBehavior = {
    ...
    _methods: {
        ...
        /**
         * Selects a range of cells in a table by rows and columns indices or column headers.
    ...
    _helpers: {
        ...
        _clickCell: function (rowIdentifier, columnIdentifier, button, modifier) {
            if (button == null)
                button = MouseButton.left;
            if (modifier != null)
                return this._executeNotWrapped(arguments, "ClickCell", rowIdentifier, columnIdentifier, JavaConvertHelper.convertMouseButtonToString(button), TableKeyModifier._tableKeyModifierToNative(modifier));
        ...
        _doubleClickCell: function (rowIdentifier, columnIdentifier, button, modifier) {
            if (button == null)
                button = MouseButton.left;
            if (modifier != null)
                return this._executeNotWrapped(arguments, "DoubleClickCell", rowIdentifier, columnIdentifier, JavaConvertHelper.convertMouseButtonToString(button), TableKeyModifier._tableKeyModifierToNative(modifier));
        ...
        _dragAndDropOn: function (fromRow, fromColumn, toRow, toColumn, button, modifier) {
            if (button == null)
                button = MouseButton.left;
            if (modifier != null)
                return this._executeNotWrapped(arguments, "Drag", fromRow, fromColumn, toRow, toColumn, JavaConvertHelper.convertMouseButtonToString(button), TableKeyModifier._tableKeyModifierToNative(modifier));
         ...
         * @param {number} columnIndex 0-based index.
         * @returns {Java.TableCell} A TableCell object.
         * @ignore
         */
        _createCell: function (rowIndex, columnIndex) {
            return new TableCell(this, rowIndex, columnIndex);
        }
    },
...
// SIG // JBZGTSwyy7eeLLLHCjHJCwZzvrdXAFtvKiAt+DZtSs6g
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBzoUV/kQkyRQlTMXTHwHB1
// SIG // uosZUVJeedgJs38IV1d00DANBgkqhkiG9w0BAQEFAASC
// SIG // AQDAf6Dqez/3Aw/hQP2A6Faf7WqP8SwATGBLDS9bYy4n
// SIG // 1wkoo4APTdQGXV+lA298Jag4fVTiy6V0CvUqoyy7xCam
// SIG // Ub6VNn0HdAkI8LKjXJgeNUTdhk6vWZWdUgus2Gtzk744
// SIG // H8+tGEo0WHz/ikyZEsI+wIJVBhiDWcJtZRgUmJ1k1iGG
// SIG // VtZITxLAlO9hgsYwZ3uqid/YS5JKZqAQQcu13dKSB+M1
// SIG // fcbjSquinEVWH2Bfd+ub1yPJPw7bv4cqoTKCJVaft0gx
// SIG // 3+Wnq4qSV92DphGrdZSJB/1Um19B6EmZqxT/j8+02dZP
// SIG // 2kFaJv5Eh+ZRCyd3tvni9+HbMR6zDKrO59hyoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgvtGzkhHyaO7N5sMF
// SIG // QSqBeUBKCT64e1f3XDSMJRVGSSoCFHtt+b6FBXV4sSst
// SIG // DDJ8W+nHhvh0GA8yMDE4MDIxMzE2NDYwMVowAwIBHqCB
...
// SIG // KoZIhvcNAQkEMSIEIAAcB0FBKy5+YFDE9ZpEefpDNx37
// SIG // eI+jbcIyCWYPtCgtMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQAEu439MGbs/1lpjKUI
// SIG // byhTbUyq1jMZ/0OoW+5GwrpArvMfy5ZSlPlREofcai5A
// SIG // zR2KxaCaJhIDiGGU4O3cZB2Av+IPFQOqeO0PqO+rk07A
// SIG // +3AgA2DpPf4ohFfs7EK4oeJuTT0SSnnJsMzHb50PzQcu
// SIG // pV59AW2pzSvM/ZFPJ4L4jAFOz5LgBloZLxd613+OuW1T
// SIG // lPjIrsNinK6QNAzQQu6JoOwtraKGvXAiq2UGsqcPWSFU
// SIG // mryozFaW6yRrdo7KgVZdY2xiLGyhpcHVWMM1927ws0i5
// SIG // R1C+c8xLe693hq5hrh9IXFqNk6TALqF5EOMLzkfdU/nq
// SIG // +dTkMiLSA6Ag3+7+
