 ...
 * @param {Object} [props] Initializes a Java Applet test object using the supplied property bag.
 * @returns {Applet} the description object that was initialized.
 * @class Applet
 * @extends Java.UiObjectBaseDescription
 * @memberof Java
 */
function Applet(props) {
    var appletDesc = new UiObjectBaseDescription("Applet");
    appletDesc._defineByPropertyBag(props);
    return appletDesc;
}

/**
 * A Java Applet test object
 * @constructor
 * @class AppletTO
 * @extends Java.UiObjectBaseTO 
 * @memberof Java
 */
function AppletTO(session, description) {
    description = description || Applet();
    var appletTO = new UiObjectBaseTO("JavaApplet", session, description);
    return appletTO;
}

module.exports.Applet = Applet;
module.exports.AppletTO = AppletTO;
// SIG // Begin signature block
// SIG // MIIi1gYJKoZIhvcNAQcCoIIixzCCIsMCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // Up5VfhgB2WPeVEVwAP1qga8PGJrbXylq2RFtAH7eb+Gg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBdd98p4at2m8hRrrK+EPeq
// SIG // G2rBnPyR4X+GYn8UMrfxYDANBgkqhkiG9w0BAQEFAASC
// SIG // AQCSl9lfXZwRQLGQjdfwDQjM9u+PLU1zrNRfIz+PKpZN
// SIG // kupWFym8Lhliq2K603ADMQMJ0AnYfeK7Vq0CSP7KlDPo
// SIG // 0VAs0vnmqhm78RTtG0O8rDJA4hOfPHxj/C2emeKOOobU
// SIG // KNg21bSDCQWXp2H/4e8kpxYwjY8+fZLS1C6IaECTothX
// SIG // a7zytEvsuJkRUmDFgYmDo29h8sZPOS+V0R+kSBOwl9Aq
// SIG // b1B8DZxIbVlrzlCAe0/7lzVJfcp589426N/O2pfLqQxX
// SIG // ZdRdv94Rs1w3nE8GNXuqMOef/PqIOhL716rlIweCcTCA
// SIG // ZFOHQBptGVxp/SRTXWLUUPwxmgxzUr8MwSs8oYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgvunq242EYLj2hzNG
// SIG // PqiUk7v1nETsmQwpSX5WjZj1iXECFGRRVP6N1iGa1EVD
// SIG // 5BPh4u7YOMLeGA8yMDE4MDIxMzE2NDUzOFowAwIBHqCB
...
// SIG // KoZIhvcNAQkEMSIEIBGmH7eiUTZpT/9UHJqBFt76DhSz
// SIG // aETTG+CQ72KdwwKNMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBb1Qi+kVReB+2U9RAT
// SIG // Vk4Y0OiaQUiECYZf0G4I1neoZ1co8HeTObu7ySoNhIyT
// SIG // b/9B7Iwx/F4ZPHHCw1eWjw5838UVNnBkCw46/8WunK5i
// SIG // 5VsBWFrjDRZ7FdEB32watBuXtuolEolwYBl55eJp+yuq
// SIG // DzSq65GGeakSGHa/b4nUkmfbV0kDAh9RuNipZjRjxDLa
// SIG // 0K0gdHB+ehVMZVGZ3oFLNH2+OioaKta/aca1eLaLDi47
// SIG // pCUjuQYZ/mj1aWHgTsEMUJrkETuab/kff8HF3hnbcZx3
// SIG // xo6hsNMQmfo04NUad5vnCXbQNFEL4ycsoftcyBNbLBf+
// SIG // /2Gls3StjO40oeXN
