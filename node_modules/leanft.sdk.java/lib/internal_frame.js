...
var WindowBaseBehavior = Core.WindowObjectBaseBehavior;
var WindowObjectBaseExtendedBehavior = Core.WindowObjectBaseExtendedBehavior;
var UiObjectBase = require("./ui_object_base.js");
var UiObjectBaseTO = UiObjectBase.UiObjectBaseTO;
var UiObjectBaseDescription = UiObjectBase.UiObjectBaseDescription;
var WindowPackage = require("./window.js");
var WindowDescriptionBehavior = WindowPackage.WindowDescriptionBehavior;
var WindowTOBehavior = WindowPackage.WindowTOBehavior;

/**
 * The description of a Java InternalFrame test object.
 * @param {Object} [props] Initializes a Java Dialo test object using the supplied property bag.
 * @returns {InternalFrame} the description object that was initialized.
 * @class InternalFrame
 * @extends Java.UiObjectBaseDescription
 * @mixes Java.WindowDescriptionBehavior
 * @memberof Java
 */
function InternalFrame(props) {
    var internalFrameDesc = new UiObjectBaseDescription("InternalFrame");
    ObjUtils.extend(internalFrameDesc, WindowDescriptionBehavior);
    internalFrameDesc._defineByPropertyBag(props);
    return internalFrameDesc;
}

/**
 * A Java InternalFrame test object
 * @constructor
 * @class InternalFrameTO
 * @extends Java.UiObjectBaseTO
 * @mixes WindowBaseBehavior._methods
 ...
 * @memberof Java
 */
function InternalFrameTO(session, description) {
    description = description || InternalFrame();
    var internalFrameTO = new UiObjectBaseTO("JavaInternalFrame", session, description);
    internalFrameTO._mergeBehavior(WindowBaseBehavior);
    internalFrameTO._mergeBehavior(WindowObjectBaseExtendedBehavior);
    internalFrameTO._mergeBehavior(WindowTOBehavior);
    return internalFrameTO;
}

module.exports.InternalFrame = InternalFrame;
module.exports.InternalFrameTO = InternalFrameTO;
// SIG // Begin signature block
// SIG // MIIi1gYJKoZIhvcNAQcCoIIixzCCIsMCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // 12u80qLg5lDkq44OJD7Nz+TpmQK6xmSxw37O/UDiFjqg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCC+2IJ2Tbo9HQRpXUUuvQ+Z
// SIG // phmI4vdPGk0gHXtfdxuC8zANBgkqhkiG9w0BAQEFAASC
// SIG // AQAXvP0OARSwD1qsfrVpuPQ8KGf12Zln31NPu7RlrcKv
// SIG // Gcq2sTt9iwhvaoiElWouBtz5pEZWWKas4lhYOCjbTp9h
// SIG // pwi1wlVAqtGAtJ6tD4qz3XkRbV80IMuHxBny0tj0TVpS
// SIG // ODIxNndXGJkNhjPi2nPV1/kHiGPcrsO1A+FXjIO1ioRk
// SIG // B2wPfkK+PQEVNjOTXa0Wm6vWaEKOakIxIPys6pBU+Slx
// SIG // eGxKOWtS8XCNg+1FGH0t14igekyOeUuTWAH3blyylioM
// SIG // akJ6xvQB5w7/SpHRW03y52er7rMlas7bg0K1fmcucDZw
// SIG // mC07ZRTsP8I9E08I+/B5kYiDktrx1Ej5tJ9VoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgOsKgdJYvl70B5r25
// SIG // kr6ft59S+fx9aT45xhnA1aCCP4oCFFApud8T7tzgVfoz
// SIG // s9M3fMNJ4dSiGA8yMDE4MDIxMzE2NDUzOFowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDUzOFowLwYJ
// SIG // KoZIhvcNAQkEMSIEIMGnWlJZ1bCEgxLjl8BJYG8xHCag
// SIG // pXijd6U5SNPqKKfFMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBPvDhfbv17R3850nzl
// SIG // LwTEzwZQN8pUxHzG134qBi0N+F+FBhih7QQnr2lLRMMb
// SIG // q3TrFsoK5/OtTKcJT8bw9/zKnXS1DYGgaUY9SMtxGqfi
// SIG // quCGV/FbPPuJPHvpOWk8Gar+nlgvm4vL35DXMUyfZteB
// SIG // n8VK6R+7Udmk0bPlTdi8Ftb+884g3I6PW0CaTB225ScA
// SIG // A4AmfqRz1yVu+Fs0/3pG183/tSFFQMdCxJuOUKZ7zZo5
// SIG // jODCJF+VK4nAcXCr1ajOOqk0OVg9qFgmU2dSUiKsxLab
// SIG // y52kcSKFqIKcuagL45K0HE7WZEDu/rTm2x/Nk/Fxm6nO
// SIG // Nx6/Sh0CIPzRhO6m
