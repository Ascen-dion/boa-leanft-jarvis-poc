...
describe("CheckBox Description", function () {
    ...
    var JavaCheckedState = require("../lib/check_box.js").JavaCheckedState;
    ...
    describe("state method", function () {
        it("should add 'checked' to _properties when value is given", function () {
            checkboxDescriptionUnderTest.state(JavaCheckedState.checked);
            assert.strictEqual(checkboxDescriptionUnderTest._properties["value"], "1");
        });

        it("should return this - builder pattern when value is given", function () {
            var result = checkboxDescriptionUnderTest.state(JavaCheckedState.checked);
            assert.strictEqual(result, checkboxDescriptionUnderTest);
        });

        it("should add 'checked' string to _properties when value is given", function () {
            checkboxDescriptionUnderTest.state("checked");
            assert.strictEqual(checkboxDescriptionUnderTest._properties["value"], "1");
        });

        it("should remove 'state' from _properties when value is null", function () {
            checkboxDescriptionUnderTest._properties["value"] = "1";
        ...
        it("should return the value of 'checked' from _properties when value is not given", function () {
            ...
            assert.equal(result, JavaCheckedState.checked);
        });
    });
});
...
describe("Check Box Object", function () {
    ...
    describe("state method", function () {
        it("should execute _getROProperty 'checked'", function () {
            ...
            sinon.assert.calledWith(checkboxTestObjectUnderTest._getROProperty, "value", sinon.match({}));
        });
        ...
        it("should return promise as CheckedState", function () {
            ...
            assert.strictEqual(res, JavaCheckedState.indeterminate);
        });
    });
    ...
    describe("setState method", function () {
        ...
        it("should return the execution promise", function () {
            ...
            var res = checkboxTestObjectUnderTest.setState(JavaCheckedState.checked);
            assert.equal(res, executionPromise);
        });

        it("should call _executeWithEvents and pass it the correct arguments if the input is CheckedState", function () {
            checkboxTestObjectUnderTest.setState(JavaCheckedState.checked);
            sinon.assert.calledOnce(checkboxTestObjectUnderTest._executeWithEvents);
            sinon.assert.calledWith(checkboxTestObjectUnderTest._executeWithEvents, sinon.match({ 0: JavaCheckedState.checked }), "Set", "1");
        });
        ...
        it("should call _executeWithEvents and pass it the correct arguments if the input is string", function () {
            ...
            sinon.assert.calledOnce(checkboxTestObjectUnderTest._executeWithEvents);
            sinon.assert.calledWith(checkboxTestObjectUnderTest._executeWithEvents, sinon.match({ 0: "checked" }), "Set", "1");
        });
    });
});
...
// SIG // f7QSPssCOLPHacHAXNsVCfc2OXg/I6OqdteuutZeiSeg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCCfwuCI/sRoUQ2/mjHTjajM
// SIG // kHatgirfcpmEhdSOLUX35jANBgkqhkiG9w0BAQEFAASC
// SIG // AQBDyFDJP2fap8IfcFNWttBOLZ5sk7tjQAv6xZIjQgMZ
// SIG // n9VLjBq2mgUp9SUO2lAI1wchgBhUv851fHPhcrqFCpOp
// SIG // 7DrVuGqvrK+zhFPvOZ5ooXTGvA9HFtNeGhLU2UGpMKqW
// SIG // aqQ0JgXsUotEY/NfmWiwzxPGHmuzDDzs2lked3osXhJC
// SIG // PxWPHwv8vrcGKL6lMqRWeiJB0P164XvY3dckKsgBceD8
// SIG // igq06JOe5onDIz/R9TZPYeGpCKlpXZcIXEDWwRc53ZcW
// SIG // TKtbWc68feSVi4EEca0duCMi1zu4sBXrZxD/qgDdY/1G
// SIG // Q7bqT7LxsjALh2V0E9kStv7Z7Je/8Z9EHbo3oYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQg1+MhGhg8zB65sdfH
// SIG // ma6o4RxTbr35IPJLwdCN9vCBStwCFAhVby4yLXgh4hsG
// SIG // mo3uJ/bJ42QlGA8yMDE4MDIxMzE2NDYwMVowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDYwMVowLwYJ
// SIG // KoZIhvcNAQkEMSIEIIbmpelD7i8fmBpV+BdxHP55p6xQ
// SIG // 5KBymbvKZvASN/CIMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBiBrmIIK7Ws+4qxga2
// SIG // RJQmtGDaFcawCXQFUo7qh4ogUCzuIMLRHYtsR3Gioijl
// SIG // aYgzCSgKpj78eeX/oYwCrne5YeL7p3MxGEojNPCNSlWM
// SIG // Cr+iDcUa5izllPm2iEmEegp0MEOE1MAsguQ2jPbYUu/u
// SIG // LcZf08sLm4F7kOuhx76J3RCR1J7I/s+49WfeNAxVFTj8
// SIG // 9jmtC8ceWhKFZwQnqBNTyvxyVOaVeU2/BLLO6zh9OUd5
// SIG // /PionTVafdRchwQo5PTYhGzObuIXszJ5yUiGAVreqe6z
// SIG // 9wqAa+Da64Rr/WAargdXDpjdEKCg0Hnsw4WmzItv2AMD
// SIG // 5fh6D5WkfZlrl1Se
