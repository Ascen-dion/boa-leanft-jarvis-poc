...
describe("Button Description",function() {
    ...
    beforeEach(function () {
        buttonDescUnderTest = new ButtonDesc();
    });

    describe("text method", function() {
        it("should add 'text' to _properties when value is given using property bag",function(){
            buttonDescUnderTest = ButtonDesc({
                text: "some value"
            });
            assert.strictEqual(buttonDescUnderTest._properties["text"], "some value");
        });
    });
...
// SIG // ZfcrHMscQeYiL4HF9ofqNDX9ULSuCBM2NacHZwrx56yg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCB9P5nTqWH7phtA5Q/aCdHt
// SIG // 1OCFEDnZrC+KzLxdUgKKXzANBgkqhkiG9w0BAQEFAASC
// SIG // AQB/OyVjlf/miorx0HHGMFbnzjMEVUt4acD+nji1yB91
// SIG // 8l11b/ufI26VKKB/WWR3ZJiwi2HrFc+U1VHgNmNu0glb
// SIG // bsuxr/IumrvOeux8BP6j+2X8Rp8b+I3g4R+ooSTZ/iV4
// SIG // bmmRWn0Yv3x0uQb8dyJ8XvNt247GWbcgqzyYN/5z5o5W
// SIG // GjmpJFNYesWQVJLC56jghsCyjyAY42NzQXsilsuSgFDM
// SIG // pfELCs5FCmJjnhnJK1gJktt14OnwNCf/B75lP1VN7t3L
// SIG // z1VT8AzaRJousb3m504zH68GYYZk2UUXisR2oIOCn4wW
// SIG // lLj7DDbjzJrNsdqTNMQXJiY1HWvQs1Krz6KXoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgydKdOgV0+SwN5Zdi
// SIG // zI9me5Uav1HecZ4wmnQzDN3dZGACFBkx40t5qgTr8rwo
// SIG // DLOL4XUtQfWRGA8yMDE4MDIxMzE2NDY0NVowAwIBHqCB
...
// SIG // KoZIhvcNAQkEMSIEIO9FCwnEntfyKikB41emR1WON1Aw
// SIG // PU2F3CEL1PnRsaATMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQAFQ58mgHZEQrLVy18F
// SIG // ihLIebGYxDvS5b0mRz3GJE9txUka4n2H9D4lXnU18kN3
// SIG // BThkkAlvaJWTypoPCw1M1CNSNFm9LKnhKkaEgDXALCQl
// SIG // oenHl8nB+FOReq4xjbk1wZ++4CRIbossomihDmZNJe5m
// SIG // w4QeMASa91Iojwe6qBIkAy96+6HI0vx94X14oGTnZCEp
// SIG // CjwhzKSAbGtED4RXxzdb+F6VJGgpVFWqwzBIdThhILRF
// SIG // +HVrkOm2xPygA71p0UM+J+emGF57n7Z58Dg3XBvI3BM7
// SIG // myF/QsOdTjQp+EUb8bf0pl8wfzrOhhwSFKXkuu+rPdAk
// SIG // SKcEyHHdl2+IoN7q
