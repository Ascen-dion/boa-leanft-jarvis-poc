...
var MobileFactory = require("./lib/mobile_factory.js").MobileFactory;
var DescriptionsAndEnums = {
    //Enums
    DeviceOrientation: require("./lib/device.js").DeviceOrientation,
    Keys: require("./lib/device.js").Keys,
    //Descriptions
    Device: require("./lib/device.js").Device,
    Application: require("./lib/application.js").Application,
    UiObject: require("./lib/uiobject.js").UiObject,
    ...
    Stepper: require("./lib/stepper.js").Stepper,
    Paginator: require("./lib/paginator.js").Paginator,
    DropDown: require("./lib/drop_down.js").DropDown,
    Table: require("./lib/table.js").Table,
    TabStrip: require("./lib/tab_strip.js").TabStrip,
    Toggle: require("./lib/toggle.js").Toggle,
    View: require("./lib/view.js").View,
    WebView: require("./lib/web_view.js").WebView,
    RecyclerView: require("./lib/recycler_view.js").RecyclerView
};

module.exports.MobileFactory = MobileFactory;
module.exports.MobileLab = require("./lib/mobile_lab.js").MobileLab;
...
// SIG // mnZs5fH1JMVEFsxL3dSNIckDwQl1/62om5UMJ1ZsVpGg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCCaGPRjuu8pJN2FyczA/e4Z
// SIG // k7Q7tXQbAX8fmFpR2yPuzjANBgkqhkiG9w0BAQEFAASC
// SIG // AQA27q8OIDwVJNoQ2YKHCf1XxxPlyQvirE6zcv8ahMTK
// SIG // +xk/6Y0zCgtCnJlMm7de5Oqn9s+FfyFUu2OsgJDOpe/d
// SIG // b+lELlq1R6tkpXJZjcDM+a+sG0LoHEUU8QrKff+409QO
// SIG // 9pEK+aBZ5vRTxwIFlQuxH5xntk30vDgzrYM+j7Kf874R
// SIG // 4tlALnCY3ElU5QyRfPJXOQ30fbtvX9bV4qmwm3Osvd+g
// SIG // T56EjhfYjOcLi3QY1GX8xsw070KqR3qjA3H/930l4yve
// SIG // FSCpzInSihBSii49Hs5TM552QihibczLyOK9159ZrLcV
// SIG // fu/jPGHieYrhCzcCpLIB6PNVnI8gb9c+1DgyoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgx1APsNiQH0gCx1Lg
// SIG // bERdyLxvDSuF6JNsJDNn1XmOJN0CFFmQQMaE/oxeZWTh
// SIG // TIlxH7Qst5OEGA8yMDE4MDIxMzE2NDYyNFowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDYyNFowLwYJ
// SIG // KoZIhvcNAQkEMSIEIDB4NbfQn1BYN18D38XkCtn4C9hM
// SIG // 26Lg9I734O7J8LppMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQCVCVXv7mWK7A09C1bH
// SIG // XBZqSYo84uyTfhdgCt7k7+NUSfJyYwtSPP2jmQp6wfJA
// SIG // dPUrqYvO0UrqQQxFSRV89XzYYFe2D+uqawXQkcoS7JSm
// SIG // zfFcAlSNgceCistgeIaOh6UFAg/xWbr1K7bpvqHWIWyL
// SIG // Bm2ZkZtBwWsi7WES/FJRHkyBCRRZeiqZeRUR1omqBy5m
// SIG // cL0VJhfsYkxRInCca3BKowYJsNDciQHWd+t28yywjvQQ
// SIG // 6YIfvdTpSkuO9NUUPnD/hw5iXSBXD9h3LXW0fENYft/P
// SIG // /n/REDVhJEjdZnpgEr0Hx8bzmPWfF4wjHPKIBI4EY/3G
// SIG // k9nO/xyl+ACUhCV0
