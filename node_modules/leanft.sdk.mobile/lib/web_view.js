 ...
 * @returns {WebView} the description object that was initialized.
 * @constructor
 * @memberof Mobile
 * @extends Mobile.UiObjectBaseDescription
 */
function WebView(props) {
    var webViewDes = new UiObjectBaseDesc("WebView");

    webViewDes._defineByPropertyBag(props);
 ...
 */
function WebViewTO(session, description) {
    description = description || WebView();
    var webViewTO = new UiObjectBase("MobileWebView", session, description);

    webViewTO._mergeBehavior(Behaviors.ScrollableTOBehavior);

    return webViewTO;
}

module.exports.WebView = WebView;
module.exports.WebViewTO = WebViewTO;
...
// SIG // gCr2TJgQI2D1Ntp7BtBWqxcnA/fZhrAH7clJ1QkxCeOg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDcLM6xEKVbXf12iyuPRbJK
// SIG // UdyGJNkqvli+HHNjYRlMSTANBgkqhkiG9w0BAQEFAASC
// SIG // AQBGpYOCoqk7w6F/9UMKaIIQaon5IfXTET+xvD+pTdO+
// SIG // rWftQD3Rglo6pMeSHDFIX3Z7TKRbyiG6whFZS/W18mx0
// SIG // R/0kWN15J5Q3O4sDUZ0el/qDr2EBqvOx14sQeePoC/WE
// SIG // PSi7b/rMD7UhrBgspV8TK+FQ0uh0sb+h2ksKD7ZVXhD5
// SIG // wydT2/2BjA/qXkOkA7P+ZHzwRrDERai98YJ4Ec09/Bul
// SIG // upMNnpQjxPKWJrMpcw5GNJtDEI8cPrgEApzCt1by6iye
// SIG // QJfSY+aKxIe1UIOoa7ISgMKnyTdWuvOXr4WbvFVGow9Y
// SIG // dBxzwd3Fwgdr4x00m9CnNW38u1yJUriaS+9noYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgeULvVuPPFBXZQ45p
// SIG // 3VtNDtxMBOx2TU7rnbQASuhUfOcCFCfyss2YzU0MkJiq
// SIG // v5Mubzc5ut6CGA8yMDE4MDIxMzE2NDY0NVowAwIBHqCB
...
// SIG // KoZIhvcNAQkEMSIEIPTDfPjK4w08bHu+rLH2MeiF22qX
// SIG // dmaEyBmDftJ6Tl6EMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQCY87HQ9Bve7X1c1X7Z
// SIG // E3oX9VW4dwF7W7y9sSwEtzkBW7E4GgRZnLmmeLS7rS9d
// SIG // S/60jPCU+rqP6TGPuyPhJW+u9/2v05yAehLDOcQjYVRs
// SIG // QqR5xJ/bErKPWqsWV6peyMK0BrpuCTK+rLQ++1vPV7Gm
// SIG // TZPgsnqIYS5WH6Dd8Bcvu80WaiKY/4U9bAdcA6uSYJ5i
// SIG // KCLe+TfqkSqwdMQwRsdOVYfRMkEsckC/UNv3ZggBWsOB
// SIG // DxQaVKT6AH6CzoX7bEw6GQFKlXvAY19G9C7C1H1BsziK
// SIG // HoPBzrMdqCC94pOpKeBV2LDkklJeBeIn9/yHQ3O1OT1H
// SIG // THHqYq+68qxHGUo9
