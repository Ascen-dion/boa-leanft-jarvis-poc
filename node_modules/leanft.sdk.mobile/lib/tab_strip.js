...
function TabStrip(props) {
    var tabStripDes = new UiObjectBaseDesc("TabStrip");
 ...
 * @mixes Mobile.TabStripTOBehavior._methods
 */
function TabStripTO(session, description) {
    description = description || TabStrip();
    var tabStripTO = new UiObjectBase("MobileTabStrip", session, description);
...
var TabStripTOBehavior = {
    /**
     * @ignore
     * @memberof Mobile.TabStripTOBehavior
     */
    _methods: {
        /*jshint eqnull:true */
        /**
         ...
         * @function
         * @param {string | number} state The 0-based index of the tab to select or the name of the tab to select.
         * @returns {Promise<void>} a promise that is fulfilled after the requested tab is selected.
         */
        select: {
            wiredName: selectWiredName,
            exec: function (state) {
                if (state == null)
                    throw new Error("you must pass a number or string to select() method");

                return this._executeWithEvents(arguments, selectWiredName, state);
            }
        }
    }
};
...
// SIG // TMd7FXiZxdgHz3b/2PJzeqYJZCeVL/1rjh1tUy1GrVOg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBb7ClGM1Lg1EOnhhvD9Bl4
// SIG // 2c/toa2PpdezF63UIVwAhTANBgkqhkiG9w0BAQEFAASC
// SIG // AQCi7H9SSAuRG73eVJwYiiLAl0JXuzkB5zJcDWxBDzyH
// SIG // HfJXfaXbZxHUWnTNZxpbhA3ixlMNM5xaM/1DjChdg5y8
// SIG // 9X0ZYapeskc6EAOXUOeaGBMckJ2NdUtagL27WzQchmux
// SIG // +pfLqh/dSPEeCwG1OCo+xQyZrd/NqH3jwUcS+SQ1iBTQ
// SIG // gBmDVHdUR4rot7beuUWdz+sXQ1Bo8RAWtGppwCkMSHCI
// SIG // 2FFiKQvCe0Gr5szJkP6cWzNr4gLQsEzp8B6FuQexhU7q
// SIG // QqFchE23ORFdMGzfGN4FkdZqy2KueL6iceQphWkc19r9
// SIG // QJB2ZnxLiM82ogKWQZz52qd/RumcmrR267DtoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgeuvdoYY1EJW0Grn+
// SIG // iA7HWEv7yb2foSpGWlSvsb3mvZACFHatsLGXDJNvYGGB
// SIG // 2DbeybfBuwjXGA8yMDE4MDIxMzE2NDY0NVowAwIBHqCB
...
// SIG // KoZIhvcNAQkEMSIEIAOPUx+jrgML808oqm6e4XHCzhUl
// SIG // B4NmwaYLy2RyKeSvMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBd72w7hLPhk5FWBxD4
// SIG // XY2RBiIzuCqXRSbppWCUM8+U1ZiRE9cMMzdUnHhQD+T/
// SIG // mZOKCeWkvA8s1iuJBxAYG2sOC4agddKufaDARPK/JQ+O
// SIG // IUKFtOlQsNxlkD3cUL8AhYnF32hZEqZtotVAe/wV2ask
// SIG // ivWjrhKUbt0Pzvw1vBuLAbspOomOPoLK3byv6w+HSrSQ
// SIG // 1SH/BW+BV9XzqC1UALXt+yfqFQ4li1/3mkvHjg0i78o7
// SIG // HvGIHXx95hfiWMwJo6XkIOjliuMPYMvNkqPse5kJv5nc
// SIG // 3bM78rXqUrGx+v8l1nnusuanUKosLYABi+wJbBJ0o0J7
// SIG // mLvkjxT42EtjrWtl
