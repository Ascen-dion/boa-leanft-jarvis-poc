 ...
 * @mixes Mobile.TextDescriptionBehavior
 * @mixes Mobile.CheckedDescriptionBehavior
 */
function Label(props) {
    var labelDes = new UiObjectBaseDesc("Label");

    ObjUtils.extend(labelDes, Behaviors.TextDescriptionBehavior);
    ObjUtils.extend(labelDes, Behaviors.CheckedDescriptionBehavior);

    labelDes._defineByPropertyBag(props);
 ...
 * @mixes Mobile.TextTOBehavior._properties
 * @mixes Mobile.CheckedTOBehavior._properties
 */
function LabelTO(session, description) {
    description = description || Label();
    var labelTO = new UiObjectBase("MobileLabel", session, description);

    labelTO._mergeBehavior(Behaviors.TextTOBehavior);
    labelTO._mergeBehavior(Behaviors.CheckedTOBehavior);
...
// SIG // Xizo3vPQEghp7D30xhvUereytXpnyiM6oXwt93JkWXig
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBXhgw78NuwVub2ykRx2K3T
// SIG // Y+aMdSgJaOxlqHJumviSzDANBgkqhkiG9w0BAQEFAASC
// SIG // AQB5c+pFrJ51mJEKr9mfX3eAulzhbBGsUsXTlQOJddvK
// SIG // Zz1ooFmGlqVGoZ6aoxP3LBFGJTGHi+Yq2wOBbUHhR5nN
// SIG // 4DfnXKDWOIUruuqJ6V6DV1yHxjs+2g4B8N5eY2WkzeV0
// SIG // 8TcgakO+9dcx1dD8th3YvAheQs+SYmzL9c8ST/Fnr/bX
// SIG // X2PEMkQZgjzpDHemMrzE1Rxs6PSOse7NI9iL+FsJyhIU
// SIG // Pp8qMM1YqoQUoEv4NpT2y2jTJpdu9VvzalnhstTILaEx
// SIG // 3qd0wyJRQYAnap9vc0RrnR6coLQi9DYX44FMC+W+LKlZ
// SIG // Ui5yJo5NNWxrNtKugAN4c8rM1TKf1Lk+bhw5oYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgzeoHAWa9pjcnoM1W
// SIG // w24ynphTl4D3t99ymO2ojOKDU1YCFHbe7S9uampnCLpP
// SIG // 974HNt0VXup/GA8yMDE4MDIxMzE2NDYyOFowAwIBHqCB
...
// SIG // KoZIhvcNAQkEMSIEIH1w+AmmPFsLC7hLcCKiyq7m77Ui
// SIG // 20jzzgwoynqVCz+AMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBX318y9aSQ9MvaXTR7
// SIG // lFta8zOLX9fBisdJFdTn7XAODVNfXBZYp9h98rx6ykbg
// SIG // sE0mW9f8Pp65qrQZu4Tp7FKV0hIfrw9AB4cPtkNd+roB
// SIG // UODu9QtXAqLjv61JY5XnhcaV+GYRfaip7MaPe9l6OIYq
// SIG // wFV+8fwAFHBDJtNP79nIOvo/a/C/WnCXfw9XBbcsvAEh
// SIG // MDijKn255tdoHSCZm3kiaSX/C5G8x55ch5t7O4bHMglU
// SIG // Wb30ABxp0Us95S5J6n4tw/fkACS4UN8XBmRT58jvAPnG
// SIG // CgKc6rmy6BkSVdsfoiLjiBnfB5Q+ZL7YB4xcoalOWf3Z
// SIG // MAtLylvJvCSPLl1X
