 ...
 * @mixes Mobile.CheckedDescriptionBehavior
 */
function UiObject(props) {
    var uiobjectDes = new UiObjectBaseDesc("UiObject");

    ObjUtils.extend(uiobjectDes, Behaviors.CheckedDescriptionBehavior);

    uiobjectDes._defineByPropertyBag(props);

    return uiobjectDes;
}

/*
 * Constructor method that will be called by the factory.
 * @param {Session} session The session to which the constructed object belongs.
 * @param {Description} description The description of the test object as passed to the $ method of the parent.
 * @returns {UiObjectBase} the test object that contains all the functionality of the UiObjectTO test object.
 */
/**
 ...
 * @mixes Mobile.CheckedTOBehavior._properties
 * @mixes Mobile.SetFocusTOBehavior._methods
 */
function UiObjectTO(session, description) {
    description = description || UiObject();
    var uiobjectTO = new UiObjectBase("MobileObject", session, description);

    uiobjectTO._mergeBehavior(Behaviors.CheckedTOBehavior);
    uiobjectTO._mergeBehavior(Behaviors.SetFocusTOBehavior);
...
// SIG // vFhP1jmgk89ZU8XdmB4JpzKaCKBVXATSxEXNRHpa4F2g
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCCXBkO1//lkrpCY+uwSKHGR
// SIG // L7aXQzaQeWPGt6qZoRmVaDANBgkqhkiG9w0BAQEFAASC
// SIG // AQAN2331v4mkgFMQyXCv+CFHYGtiBE4DfHvAKggnxuYX
// SIG // tJeBcMclAqfhWYvmyBpLd6/zgye6BfjCThZE6UYeQrDa
// SIG // PZOFTL3MajphDOeSqr5aT2PXCJkPRzn2bzMXUjtnqXgu
// SIG // fIgwJAZmZhIK1+tUVni+t7Sw4LRfd5pNnO+AE0NnCb3f
// SIG // nUtaAoR0B5vXhEksBBNoahlvbUyhfV9XQ67RNalzEOVI
// SIG // X6GSNVlBcwFoApLj1THoBZWBakhtq7fnk/+OW48J/r5M
// SIG // Qf1wmvIHdmM58ZCkkXUii/QPmpe03HuvBlXoAijeRQpe
// SIG // kOg+isDVzdrMQMrskM6IzF4mYYl+qJh63p0xoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQg7wnPdUR1FMxokCNt
// SIG // g9m7h+z9eRwGaRKPQazY45AptPgCFCFBVGFaQthv3VFJ
// SIG // tmIg8nzB0V9QGA8yMDE4MDIxMzE2NDY0NVowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDY0NVowLwYJ
// SIG // KoZIhvcNAQkEMSIEIPjBq/OVm5+MjSvf9hHAWzH5l1Ii
// SIG // 4p61B0aiEipwYoVJMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBn2stUzWeWgjD3AZgk
// SIG // LB9XoR0jcABHnPtQCpaJSDTgdpC2SUTJWJRYJvG0aIzi
// SIG // 71r9sSMv/VMrW9oiZKXTuCJLs8QZEaxuhQ0/9HphEYDp
// SIG // gI0BU8022SG+5qKmiTNVRWKpqF9uu/y5NVPtRQ3povOZ
// SIG // FPAz5Q91ey9injtCCwe6rWArt7K75CN8+gx1ae/DGp3J
// SIG // vT7I/VOYTwxMUFXtv4BvyzGYmllz51ClAnwmjkqUpzFa
// SIG // JheQH1RYMyKlU26F13MXi7I/AdKVIPcnRsyML4OGVaAY
// SIG // 67nd2XlI7gwor9UXolIEUycmtImU9pAelsmncNJb2WKc
// SIG // DNTyEoao2mkDOn03
