...
describe("Tree View Test Object", function () {
    ...
    describe("errorText method", function () {
        it("should return the execution promise", function () {
            var executionPromise = {};
            treeViewTOUnderTest._executeWithEventsOnError.returns(executionPromise);
            var res = treeViewTOUnderTest.errorText();
            assert.equal(res, executionPromise);
        });

        it("should execute _executeWithEvents 'GetErrorProviderText'", function () {
            treeViewTOUnderTest.errorText();
            sinon.assert.calledOnce(treeViewTOUnderTest._executeWithEventsOnError);
            sinon.assert.calledWith(treeViewTOUnderTest._executeWithEventsOnError, sinon.match({}), "GetErrorProviderText");
        });
    });
});
...
// SIG // 040y9RJQAjVMVU83gM4nfaQNatvIE0CokA6dHcRg3peg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCB4R+G5WQQS/xoV3BL3bdMd
// SIG // dyASiz7l8EyaArtFNLxdyTANBgkqhkiG9w0BAQEFAASC
// SIG // AQASTyUW+f0amsXvw5Odj3lyxWxbvNdHo8T1q/bQbr3X
// SIG // J0pc2F8+9c6VecXkNv1z1cRymlVPioD3GHsEX59L2RMi
// SIG // BJwKxeOHIkw5ZGQd8i9YqHdinWdGB3EXERMaskpAXgKo
// SIG // wt6ZSWR0soLnNRzcz2F/P7No4ObVERxGwp3hD8xs9HgR
// SIG // M6PDotMbK72rKGiKmla2aeORGECpUlDAsgj35O+ozCzi
// SIG // qAgDX8zwf3176TaPM9wZcQOlWVKDSm4SizUxj346OlIu
// SIG // 3i030Pl++esBPy5g0c87NZDON/2LrO+UKcgSN4iv4mRY
// SIG // ctRzMSaqBRo0EY8wj44LbBFS9vahENkLjcSpoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQglWZVPrjb3iV+CBEu
// SIG // reXB+CplH6gsYyxxF1IBJzm+EDYCFQCDUmj99fK6yFLj
// SIG // 3nyxqFlkI4z0LhgPMjAxODAyMTMxNjUyMDFaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjUyMDFaMC8G
// SIG // CSqGSIb3DQEJBDEiBCCtB0hK8AoYMoCFTQVSAmPmzgq4
// SIG // Cl6zPQzoYSLiyHipkzA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAgJHbDC6xJnGZ/lt8
// SIG // ZgJruuFrTOVo9lys2Lk6YrPEsEsn3BRa7tLvjDPe1aV8
// SIG // CPqEEIyyh1lNC0I39AaTKL8h5iNfKQd7Xs+3GxFK/Ad8
// SIG // Qvzgs8i5y+HHRNjTnkOmWAqoELtULItc6scFhXLjaimg
// SIG // ipBcmKM24xpsaM7nc6dftniXz9VB9JejipK2EiufcKeR
// SIG // /iDjCszJdYlEty7OE7NayNX6uE6XiSglUMJKDnDZEobO
// SIG // RqnoTB7xYi8Vzb0zekgU6hFFQbeqsWUo1y5mnOq5lMVh
// SIG // wyGqb7u3AM8fCheKnBoW4HlzzjQ7hWjo88fLcUFMFUB6
// SIG // OVKpx8LtVG5tl8nJSw==
