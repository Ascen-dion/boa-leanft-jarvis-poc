...
describe("Table Cell Description", function () {
    ...
    describe("setValue method", function () {
        ...
        it("should execute _openPossibleEntries with correct parameter", function () {
            tableCellUnderTest._ownerTable._setCellData = sinon.stub();
            tableCellUnderTest.setValue("value");
            sinon.assert.calledOnce(tableCellUnderTest._executeWithEventsOnItem);
            sinon.assert.calledWith(tableCellUnderTest._executeWithEventsOnItem, tableCellUnderTest._ownerTable._setCellData, 0, 0, "value");
        });
    });
});
...
// SIG // +Bvg2GCjX/zBJzVzYmm8qWc9qTqvlVu+Eso/ljUXet+g
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBdiFLO8J4KkJnzwE9LFtA1
// SIG // U01JGD7oMRqC0T0f422nQTANBgkqhkiG9w0BAQEFAASC
// SIG // AQCYnsiSpeuNKnhLYowyTbmXjBE5O03oQpGV6654EVX9
// SIG // urEgIJXg/vHLiFFu1RYlIE1+vO57Hv4p0N7mSgNzcCQJ
// SIG // VH2ItHr/prrf1kzMgH8a8xXDxWjjnlh+bewdrb7xlihP
// SIG // HXM0okADg2yux6DtA+qWcltp/4IA3Osrtl5lZ2N/L3Gm
// SIG // 2Dln8v9yf+MsvabQvZ0XNe5fuf5/vqx3JKPb2E8W0xeD
// SIG // KcAOTKO6XuDm3hRbqgjCnkZiyg90gZDspyd7QM5Y04/9
// SIG // 3VatMIWjDgY9+pd2PCiwL99d9CEKvs95YQIfO9zXSHmr
// SIG // 8vOchojK+IVo3oTpedzIiS17AQ435mM0jnRFoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQggtDL4lKB+wHN6J2w
// SIG // d2bALQgrGn9wX9XX0ctx5u6VlWwCFGL1y7kUWMtdGdTk
// SIG // YD39QXaU32wMGA8yMDE4MDIxMzE2NTIwMVowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NTIwMVowLwYJ
// SIG // KoZIhvcNAQkEMSIEICeHGAjPYXvQt+4tOd9il+CXU3jK
// SIG // 2GR94/6DxQtkwJQ+MDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQABBVFFFCWaxjbagj09
// SIG // DfZcR6acwxG0VbUo9Ke+Q/mqYebQoKcOhSjDfB5Y3wjO
// SIG // PJA53DBCZpriS6UtwB4ELse3R5ealjhZA1YZqTp31kXb
// SIG // r488xdkUu++Z+0xm+s2xUvM8CNmqGP57sz5Vn41ewEqb
// SIG // s9r0lVJ6YLo5tQYlJNQRNX3Gpv1J+m3G+8UeU9bzMfoy
// SIG // o6z+qU3abPEzKHf2AVN22kJ1485geI7fiPAlGs7KdJWW
// SIG // 3IaYyUkV/nS+t6+zqJ+q47jbOF4JnoO1ldZUvjRGqaqK
// SIG // OQpYLxSwKRpQWNRujXRKLxN8aCwMyhhuttibRF8Om/QM
// SIG // eoqVbFPTXim1oc19
