 ...
 * @mixes WinForms.ListViewTOBehavior._methods
 * @mixes WinForms.ListViewTOBehavior._properties
 * @memberof WinForms
 */
function ListViewTO(session, description) {
    description = description || ListView();
    var listViewTO = new UiObjectBaseTO("SwfListView", session, description);
    ...
    listViewTO._minimumItemIndex = 0;
    return listViewTO;
}

/**
 * The behaviors of the ListView object
 * @memberof WinForms
 * @ignore
 */
var ListViewTOBehavior = {
    /**
     * @ignore
     * @memberof WinForms.ListViewTOBehavior
     */
    _properties: {
        /**
         ...
         * @function
         * @returns {Promise<ListViewItem[]>} a promise that is fulfilled with a list of all checked items in the listview. See {@link WinForms.ListViewItem}
         */
        checkedItems: {
         ...
         * @function
         * @returns {Promise<ListViewItem[]>} a promise that is fulfilled with collection of all list items in the listview. See {@link WinForms.ListViewItem}
         */
        items: {
         ...
         * A list of all checked items as a read-only collection object.
         * @function
         * @returns {Promise<ListViewItem[]>} a promise that is fulfilled with a list of all checked item in the listview. See {@link WinForms.ListViewItem}
         */
        selectedItems: {
    ...
    _methods: {
         ...
         * The input can be the list item, the 0-based index of the item or the name/text of the item.  See {@link WinForms.ListViewItem}
         ...
         * @function
         * @param {...(ListViewItem | number | string)} items You can pass as many items as you like, each item can be either the ListViewItem, name of the item you wish to select,
         * or the numeric index of the item in the list. See {@link WinForms.ListViewItem}
         ...
         * @returns {ListViewItem} The ListViewItem object. See {@link WinForms.ListViewItem}
         */
...
// SIG // UPaWN2coi6SNHxzJ8DBsOX/1UinUs1UA9vnuf28vSr6g
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCCBqKTRgWgP5PCg/HKCd+Hg
// SIG // i/4lc8Mzsjc7APeXPxf3HzANBgkqhkiG9w0BAQEFAASC
// SIG // AQCTUxMYblVrzDjQ1yBV9YldLU/8xeN4SqhTy/fncXPv
// SIG // SUAr0e1B1ZvqkJCyTce+1vHtAYof8hTwJtHKvIvngO6l
// SIG // ijR1xGAzWhUp6UfuMvRqwGmxgYPsNUMrAkgWFXjrIYWY
// SIG // bXM62jBfhJA3ucTNkysM5WdmrYKgT5LQz45FNbKLtP3o
// SIG // itlJ7N4gHDnwfdJRuUQAJCXdS1YgNStr3VLYHO5ZQKDJ
// SIG // h1rZxRJ5KgNfEeFY9ndvbEux7ezTQ6ozM2USvH179JVh
// SIG // Y9WNhGnm8nw6yGv1MpObi4BsTkS8SgyMEcV8HHL7tHNa
// SIG // 4IrstXvAy+OukpXtQF3xicKh+EGOmJJsAu34oYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgZJuuwy61P3wla7nx
// SIG // YEOtYbJc/ZPVmqZ/5p8fR1slHq4CFF0KdKC98b9+h0rO
// SIG // ajCf/1grOswvGA8yMDE4MDIxMzE2NTEyMlowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NTEyMlowLwYJ
// SIG // KoZIhvcNAQkEMSIEINuqDaVMHkijoyAM0bzWeWrCQCVH
// SIG // lcJyWRrVX5D6GVRZMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQB3moMEQYwaNQ18a9RK
// SIG // lTxcLnT2sy+sX70BFbH2cWw5dZCG+EW48c+FB6XmlXxI
// SIG // 3VvP3lnXZq2kJnx032bq8tLUl/tJLLiTsy8C5x8IYz2D
// SIG // tMNGVxN8xrt1saI/77/SPCipgOh9oSdlykfZNYyU8ZLX
// SIG // 2qn3Uj3a+N5u46ezyc02guxUDloHDtcjqQSWoJqNmcsk
// SIG // wm2GG6mVaz60SP3XPoTe3p+qhc0lRi99+mWtqsUa04fl
// SIG // JW1XxQgTL7mTJkk6PxZNOGV9bXyQghrux4lZi1T6zsFc
// SIG // wbOIT8juAZ37L73qxmYzIRi1Z5lv+MnStU/9kLT5zPCo
// SIG // AMvCw7jqKk+SEfzh
