...
var ListBaseBehavior = {
    ...
    _methods: {
        ...
        selectRange: {
            ...
            exec: function (indexFrom, indexTo) {
                if (indexFrom == null)
                    throw new Error("The parameter indexFrom cannot be null.");
                if (indexTo == null)
                    throw new Error("The parameter indexTo cannot be null.");
                return this._executeWithEvents(arguments, selectRangeWiredName, Convert.toNumber(indexFrom), Convert.toNumber(indexTo));
            }
        },
    },
...
// SIG // xa3AN84S67Y8ABTzbPWjFvuD0cEUtCXPz7IpGdqz4ZKg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBt3M7DlyMjQITELxEUKmLi
// SIG // jihx5s+tg6GXdMHR1HLsxDANBgkqhkiG9w0BAQEFAASC
// SIG // AQBY1ShugrrTd/qTOrXlOrnPTQliPSfhBRJJyCS5LTO1
// SIG // /rsXtNtQflXA/G8zCfAczzpt6VY2RF3ISMJx+LR3DlF6
// SIG // BODQUWUJd4bCwugJUoFyd9YMNY56Q78BBrA2Tv2471Ez
// SIG // MovF4KBXHRlQok5M4DOnKhHFikf1mpQfDzHHiSlymaS3
// SIG // kuIbeR+ToTNTt0TB7D/cnvNqn6OLScryQWUAvbTD/UVA
// SIG // KLOouva2Md9RI188Syk2GsMYpXxVuW0MBpYHKX+EHsN+
// SIG // FKQOh3vflRlqzu4V2+K5Y0fi6hhkwsIGcMWacV4qix+o
// SIG // 3oTeuCS0MGwClzpu8AYQjGiXw4boO5Bw2R/7oYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQg0Y3+1YyilAi8TNcK
// SIG // kgpNIDwPmqzZPltoN/VLp8pszvYCFQCLYgP8z+qcT3p4
// SIG // dw0F7wfKCBMjmxgPMjAxODAyMTMxNjQ0MTBaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjQ0MTBaMC8G
// SIG // CSqGSIb3DQEJBDEiBCBVpQ0Og5o3yLJui5vnri+Sst7K
// SIG // Cc0YdgruyKJys3y6GjA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAI0H3tXqrKxDP+TSx
// SIG // rQzsV27z4NKLIz+hjB4El8ZCfVsjeXcstXI2dgPUAcFO
// SIG // fD3cLTDe2SC3zYeBvUnPAoZ5/YJI9H89VETJu8M9iMNU
// SIG // y/7adPi1oaG9TLcpOfkwyKp9dsvjh97VR8it5Ca2ps7+
// SIG // icA6cW3iGgCRyv+OL2H3HiChDgGNMJu7XE8QTbvQHlhj
// SIG // /8tOMZxDdghYOOHvY7lPPtbnDC/4LpgFH4qFaX0UF/be
// SIG // js70hUF82wnQ+EyY/qszC9syeCev/3TeP/zWRfpa7QAW
// SIG // L5QwCBMAx6hO/4QdFILEFjdnhFG4NWbhoC9XYrvbUvsC
// SIG // /gHD3Y+MjTvGIdRjpQ==
