    ...
    _methods: {
        ...
        setDate: function (date) {
            ...
            return this._getROPropertyWithoutEvents("date").then((function (res) {
                ...
                return this._executeWithEvents(originalArgs, "SetDate", CalendarConverter.convertToNativeSingleDateFormat(date));
            }).bind(this));
        },
 ...
 * @property {string} singleDateRange
 * @property {string} multipleDateRanges
*/
var DateFormatType = {
    /**
     * @type {string}
...
// SIG // fTHrBTTeq06JzXR7xiCNJF3zgMN/c2ufId+iAV8188Kg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBfpGkfP23hR5l6GXcJxCFK
// SIG // nY3+DLJGzw4LXYMbWXk5sjANBgkqhkiG9w0BAQEFAASC
// SIG // AQAM2Fpxq957AEeJfcEC3NASHbxuzFSnS3FpXjvosmvT
// SIG // qU6/nJC4dXmxIOVQbxbLmpctydRO0Qqcs5bUIRHWTFwp
// SIG // 5KEFVp5yKY7R4yGrzFqyGBdtU2CMAgLSwkvBw8zNuVb9
// SIG // gOwMRMQuPYE1lM7tTLIYhikco+9tuqwcz3CrTYIfFNYL
// SIG // clAijCU2mZmkA0wQOA0ougVuP9J2E+foSzrbNvfoT6t5
// SIG // woJCU2yUh7wnHMPYAe4TgmYIvRV39hdS+F7LaYORb2iB
// SIG // 0cZ/WE51pqEZTbA84PchaY84A5GsBwmb3Jenr329Ue/B
// SIG // xVmQ4AA9Atz60V3Fk9dILtQzudZa1yDYcy01oYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgey8X9vow4U7FiKO2
// SIG // Yc3uqKYzjNLYZifd5mLUsIAJ+dsCFEdefH1mfAcIy9mj
// SIG // uvdjX8q2PrerGA8yMDE4MDIxMzE2NDQwN1owAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDQwN1owLwYJ
// SIG // KoZIhvcNAQkEMSIEIDegK/8xjxHx/ltFBymTTdOgGjxi
// SIG // IGJ+aNVTpkWh7nEwMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBGAB8T927EEJ4z9cuk
// SIG // haAQlkkz5baC4ZJcrPEp++8J0FTtjev3jipcmTn7oZ2U
// SIG // N8OWdP+9Fh+LDsr1vRm8hKn5Y9HEWZbu1pacvBrfQX/S
// SIG // EmlwdwvCsAfiJpC/AKes3YQImBnVGTum5sbQwxfn7E1K
// SIG // kHenvgjA/0J/30P2kbpeql85JYPHPx2CAtUniumLBFrA
// SIG // Cxwy/TTfVo+7DFreDr8Zmoum6rJ9PuNCGI8VFcth5qnQ
// SIG // hMs/HLkSluWym0mAb406+2/8skhdbXvcwDpHs+ZfySIY
// SIG // Ai/Go6SU3OXs5rZ5jTjO4KZkg2p2T2rrUNrhyuO1niti
// SIG // ttIaKfAGzyf1Lvnj
