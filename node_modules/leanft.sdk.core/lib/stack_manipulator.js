...
var StackManipulator = {
    /**
     * Returns the stack string after removing the nofLinesToRemove lines from the top of the stack.
     * @function
     * @param {Object} stack The full stack from which to remove the lines.
     * @param {number} nofLinesToRemove The number of lines to remove from the top of the stack.
     * @returns {string} the stack string after removing of nofLinesToRemove lines from the top of the stack.
     */
  removeFromTop: function(stack, nofLinesToRemove) {
      var parts = stack.split("\n");

      var header = parts.splice(0,1);

      nofLinesToRemove = Math.min(nofLinesToRemove, parts.length);

      parts.splice(0,nofLinesToRemove);

      parts = header.concat(parts);
...
module.exports.StackManipulator = StackManipulator;
...
// SIG // jgeQYeZ56ADOtYDfjAS4b218aDyy+vTszvo9KU/NeRGg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBk9euYUNszePzRspmNZ1n7
// SIG // VjlyOX05oWI7ZQg780t/pzANBgkqhkiG9w0BAQEFAASC
// SIG // AQBss/k4gts0yBpg0yrsAUjVE/w0D+qjrWLPNoIH0vgK
// SIG // S6/rB5P68E5uPc9QrlBciNNARdUo7JAhSc51mZG0BGyn
// SIG // oWcgVPcoeCs2YcTYO45mNvqBO7k+NffyZEcsLUBabxzX
// SIG // GOz6bl769cX8JvJqqFY+XCx6xxGGcA4VtJoX8nVwzlJQ
// SIG // D+LiW7XZkEJkhlBTuY6eVir/R1yRWx+EuYlJqc+j06ks
// SIG // oqYcb8GWHlmP02XQUBlmJt3I8u0mKSOKgt/oMNa+I0mw
// SIG // KrBpUPifNGiVsNQ0TexL0mTiuSCcq0EJFcxCrOu8WdCG
// SIG // TZxNuyvcj2t1k1hFTPtxWdjKlUGHIMVD0dGYoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQg8iMPGzANhexqR3Go
// SIG // EDQzVh0emdMDHBEmKRlefBBRa94CFQDtOgC5uMzxbjHN
// SIG // kInmfb8HP4DClBgPMjAxODAyMTMxNjQ0MzNaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjQ0MzNaMC8G
// SIG // CSqGSIb3DQEJBDEiBCCcQEf9gnGGAArCFn9jboxJpEe6
// SIG // Wg/tk9GaYyeqI3tSITA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEABmzEnGC49YdI5Lt8
// SIG // 8FSabb3Wuq8SbNtwOiE+n75Rj8AOgsBG5dGRCFHfz0s8
// SIG // hSi6nuuF4rsuU0KoQGj2nuNNAHjybhEL4kSjrBKsmanr
// SIG // jawEt+OlNkASpBDNdcoD07qtkLO0Ikpkhq1ShrX+WIBA
// SIG // KY+HpWj/mD/xJ+nu8ddm20Rhks7Qs7ln4gcfpbB85mNZ
// SIG // AjYEtINdcrnJ5e1YLGb2cGrg/XiNDFZqBww8mua+iLr2
// SIG // 5/lILlxfZGsfVorGqfyEj/zTVG5bmBkRzDPS6pqn19CM
// SIG // rt5fIQeGLIz1ZIDtUNxZ4x2vVbw57p/RvTF5vO30NiQa
// SIG // hyvytRN8vTh8kS7oLw==
