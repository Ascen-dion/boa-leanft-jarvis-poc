...
/**
 * ImageDescriptionBehavior - the description for a WPF Image test object.
 * @memberof WPF
 * @ignore
 */
 ...
 * @mixes WPF.ImageDescriptionBehavior
 * @memberof WPF
 */
function Image(props) {
    var imageDesc = new UiObjectBaseDescription("Image");
    Utils.extend(imageDesc, ImageDescriptionBehavior);
    imageDesc._defineByPropertyBag(props); 
    return imageDesc;
}
 ...
 * @mixes WPF.ImageTOBehavior._properties
 * @memberof WPF
 */
function ImageTO(session, description) {
    description = description || Image();
    var imageTO = new UiObjectBaseTO("WpfImage", session, description);
    imageTO._mergeBehavior(ImageTOBehavior);
    return imageTO;
}

/**
 * The behavior of a WPF image object.
 * @memberof WPF
 * @ignore
 */
var ImageTOBehavior = {
...
// SIG // p21tH/ZEW5WzgztxBSjGvzT+vmerXmek6NAI7gRRw6+g
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCC9Fed9SyAV8SfeU64qxePC
// SIG // Q634+OFuXwg/p3orDTklPjANBgkqhkiG9w0BAQEFAASC
// SIG // AQA7DszQDh8SHL20HaaiotvCQ3DVYiSmwmpAxL0e7/J9
// SIG // MrpAI6ldg9XcvoQhbu8R/ph7j2FqyJiu+Pvus9gf6+sZ
// SIG // w80GgcP5wIzhC+ecZ+4bnNWNjsxsADSBqT0GW66osb5z
// SIG // wbiOosOLSOtsJ3zMNL3rztAkxBn+4b8f2XcabsaUl7Me
// SIG // WyMy+ESysYQyVAePga+IkXqaasFPmpnoGnzEPG+qwGgn
// SIG // TPZGvqT/KUETEAcjUhmGGNOprALbsFyyDuMFLC6drApu
// SIG // oluwP0+Zo/dO0MIn7ezTlLY/NdQzDSdva+IjKSVyqAOt
// SIG // /LrKIrbME8zIR/XcpzFhwzrKZzsG00uh5bTcoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgOjmQBizw1F3kpc6k
// SIG // QO3nD4FhEpakqE8fWO5CimiUEHMCFQCuxvQVJFUS94CQ
// SIG // Z4+wuNx9lIWVuxgPMjAxODAyMTMxNjUyMTdaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjUyMTdaMC8G
// SIG // CSqGSIb3DQEJBDEiBCAgwowHuJjrB/9vculg7SX3yZDD
// SIG // 9F9ONKW0RjO6lY6uzzA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAjaBccPqu5ZmaycuV
// SIG // zeaIrNnRpGrS8pX+fiJjPUaf/MRgWBQLMzUgwl8wjbMq
// SIG // 7fqubxDPQicb+RrX0K9lMV9wVTU8e9e2S22E5k5Ln6/Q
// SIG // M0gxNlMJ3rGE2DDEc/zTYsQDDTv1lXEBQhuRfOX0vmh7
// SIG // fshK3BSBJiHpj1RDlWCXPjfN+t7Q0PN65V7M8w3Q1vQE
// SIG // hdbtoWwyWlOuCzIXEFN/R11jPCh2XejotXnyCwL9hNQb
// SIG // 7DeJw3CV2l0nYjHtE0Xa9Z4ZA1iS35ykHkUbQr352NCQ
// SIG // 2m/dwRbaZKAznFt56kr4iS7k8w8CSq6byKgIgR88BYFx
// SIG // TQlyObKS4p+3fhMc6A==
