...
/**
 * The description of a Static test object.
 * @param {Object} [props] Initializes a Static test object using the supplied property bag.
 * @returns {Static} the description object that was initialized.
 * @class Static
 * @memberof StdWin
...
function Static(props) {
    var staticDesc = new UiObjectBaseDescription("Static");
    Utils.extend(staticDesc, UiObjectWithLayoutInfoDescription);
    staticDesc._defineByPropertyBag(props);
    return staticDesc;
}
 ...
 * @memberof StdWin
 */
function StaticTO(session, description) {
    description = description || Static();
    var staticTO = new UiObjectBaseTO("Static", session, description);
    staticTO._mergeBehavior(UiObjectWithLayoutInfoBehaviour);
    return staticTO;
}

module.exports.Static = Static;
module.exports.StaticTO = StaticTO;
...
// SIG // P7AlGjDAPhaPZZZ3Q0L8rj9Pjw+YAF7RuRhefMmhrPmg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDkIMtkaaYxdmNsyfs5xneb
// SIG // 6EX3hpuNeKMsn7iupWPl+jANBgkqhkiG9w0BAQEFAASC
// SIG // AQAb0L8BbMbdhk4qYJJEKTBAPbEggTS3v0qdBQ1KBoW4
// SIG // 9yS8bs4My7xUREWHVQZRjnagMNod2umyGJEZxgWrPBoM
// SIG // pT24rsAJkW0aLOOQMX/Q2+wqG0kGbzQPaWW4OGvNGjeA
// SIG // eDxJ4+xvLht7ELMW1sH3CdN9H2Yhi5xMpblW/bqveMYr
// SIG // RMtsG3sxutn1Fz+LaBjtjfBMCm29+JPQAZG9oBwutED0
// SIG // N8pE24KzNDTbt1BipkswX/LDiQlPKA2uwx2a1UBcS9hj
// SIG // BQ1y0YUwOG6+1+FWTNPQtj3k+nnbleterrtmP4nJzXZx
// SIG // plC05/EAFd+z9UXjgrL8MxbX2P8Wm9k4CrYfoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgD3lxJPay0BUwMB6s
// SIG // 3qiDmerrNfdrZqFR2PMZsJEwXjQCFQDnWIE0wL+lcp8a
// SIG // 5+c59mtltAtj5BgPMjAxODAyMTMxNjQ5MzJaMAMCAR6g
...
// SIG // CSqGSIb3DQEJBDEiBCAGqwlzw4lw6n9HvlCzW0QgJh1R
// SIG // Rw93EGEyO9P3G1I9JzA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAfKQqxseHf+VEGePn
// SIG // I0LdhYS/jRG3XkZ+7ksMJjy938kwyIkIafw8YKBfqYsv
// SIG // FfRNfvJ8j23CXB8YFerf6m6wWYIZ7DgYnoGd1+E54NvS
// SIG // mvDvm4P3ma0AYzp4dupcPrJs1QTgFNfKM+w8wA0ZfYB+
// SIG // CCbhzSVXSG3LTXcpVr6CWjRh23r44BfEUpE7mwPb4RXU
// SIG // KQQn9Cz2MrYD+/EUnyrVXEXqFB9jpCzneorGuwmXStHW
// SIG // 3TzbyGcTuIFr4QOonqxBY/6/JntbhxdIVnsGToGqIT5y
// SIG // UTeUJLjpoRHG6UEef83tnKuOhfk01ak+GtyV41bOAFXi
// SIG // ArQthzAvjMSzP+nb9Q==
