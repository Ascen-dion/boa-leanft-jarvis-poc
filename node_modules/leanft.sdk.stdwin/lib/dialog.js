...
var WindowTO = WindowPackage.WindowTO;
 ...
 * @mixes StdWin.DialogDescriptionBehavior
 */
function Dialog(props) {
    var dialogDesc = new UiObjectBaseDescription("Dialog");
    Utils.extend(dialogDesc, WindowObjectDescriptionBaseBehavior);
    Utils.extend(dialogDesc, UiObjectWithLayoutInfoDescription);
    Utils.extend(dialogDesc, WindowDescriptionBehavior);
    dialogDesc._defineByPropertyBag(props);
    return dialogDesc;
}
...
function DialogTO(session, description) {
    ...
    var dialogTO = new UiObjectBaseTO("Dialog", session, description);
    dialogTO._mergeBehavior(UiObjectWithLayoutInfoBehaviour);
    dialogTO._mergeBehavior(WindowObjectBaseBehavior);
    dialogTO._mergeBehavior(WindowObjectBaseExtendedBehavior);
    dialogTO._mergeBehavior(WindowBasePropsBehavior);
    dialogTO._mergeBehavior(WindowTOBehavior);
    return dialogTO;   
}
...
// SIG // RLKRqR3LuuaSCXgxbAGyWS4Qa8MeEUQNegCutGUj+omg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBnPnvfZytSxslJ6IhOXTlB
// SIG // xKVmrxuw931dpqqqwx9+rzANBgkqhkiG9w0BAQEFAASC
// SIG // AQDIWYX1FhwLfcwuGi2AcTn7zbcOARTqQMCBjg+1q+oy
// SIG // r76yyJqsKa9TLpYlkUSNWqrsn1UgaJ/XeYvSf9dW87K/
// SIG // PRVFh6sqDm7dhTU3dTC9yglrBMsZHkwW9qZh7v7lvF8f
// SIG // dgI41hIG2WLJEo6WmAvNdbaoeJ5Ie/2ciwqXKfGbtuhH
// SIG // 4EYtZyL6nrqMpOwf85kcqXzdJyOym61REr3gkvdZ8mKm
// SIG // qPG6nq9lYS1TXBa0ZQ8HOIUvZtxHFK+G8pBpuyeTb5hp
// SIG // 1nid4+L4im0L4RfriEfsFEsAGt99GV7EajhLB2IljeHS
// SIG // iGCEQ1MMDM8GlZCHUP9AC9U5gDjKcUZ7EUyyoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgUhQntpFjafOuwEeO
// SIG // lKBkeTxeexGsh5LaQwXNfZMdYIUCFHGTeni/MhV+niGp
// SIG // 13HY8mQEmKEoGA8yMDE4MDIxMzE2NDkyMlowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDkyMlowLwYJ
// SIG // KoZIhvcNAQkEMSIEIMnfl3epaQHpCDCzbY1URAs7XVML
// SIG // tALlO7DprlDc7tDWMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBBoxSKCV4B4ZSu6nfO
// SIG // oW9tU5WPiLZzFwQFMt8F1PrJ6RLH907dcMv+e6/p6B0k
// SIG // MtX7BWUYYgy76PQqiyWBEokVmOWQKMwXoQ9tw97zlLWN
// SIG // w7Bw6lEb4sCM2d5BVZEs5PR4btvzwo1Xxc76oBthuqnc
// SIG // K9dCEKZIhp+QV9pVdTsjzalqGLAZY9fT0dTrfg98E0js
// SIG // oIk9ThOums80e5t66CZ4A1NTRabaGfhJsq5887O3weuA
// SIG // QMfMne3Lo8vNytYA9Xg+KyYF3RcsSOcfIeHt1zZcRLsL
// SIG // J+PdShtb1ahE9DTtvmsCidHCQs0Q50fTmtUkYAJuYP2F
// SIG // HGOQ64x18KvtWvku
