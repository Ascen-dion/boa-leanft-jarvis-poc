...
var ListViewItemBaseBehavior = Core.ListViewItemBaseBehavior;
 ...
 * @constructor
 * @class ListViewItem 
 * @mixes ItemDragAndDropBehavior
 * @mixes ListViewItemBaseBehavior
 * @memberof StdWin
 */
function ListViewItem(ownerListViewBox, identifier, textRepresentation) {
    ObjectUtils.extend(this, MergeBehavior);
    this._mergeBehavior(ItemDragAndDropBehavior);
    this._mergeBehavior(ListViewItemBaseBehavior);
    this._ownerListViewBox = ownerListViewBox;
    this._identifier = identifier;
    this._textRepresentation = textRepresentation;
    this._executeWithEventsOnItem = this._ownerListViewBox._executeWithEventsOnItem.bind(this._ownerListViewBox, this);
    this._executeWithEventsOnItemOnError = this._ownerListViewBox._executeWithEventsOnItemOnError.bind(this._ownerListViewBox, this);
}
...
// SIG // LS2f5xEaKPqwaSHmcnxe5rU/iv0ODb1w8Js03zsI+cqg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDz2AcJRFGfK866TKwOYEaq
// SIG // NPUFCIQZtyQgMiLDricFpTANBgkqhkiG9w0BAQEFAASC
// SIG // AQAxZ8nwNIQQy5lhO9SI/tnRFPU3p3hsbFUR3r5q5lVi
// SIG // vmVvfp+8FZtbzazjVax09r72IXbS66mB98ICzwOFbrUR
// SIG // zDLCmYMC0ocYgasH3bj6ZuYuO5Lwsco2eANj/567Qn67
// SIG // ytzuv7KSltBXRxWqJV8SS/mexisUeZ2nEkMHrerWXBNK
// SIG // ae8EdNNfy9PLp16I85eI1OQkyCcoYex97y+5xLXKIVeP
// SIG // xsEMBqez3tznWDgV9kvy9IaboRN7FVlJpO8YkC8Fj2iV
// SIG // rRBgVBMnfcJNTNmTfN8pW8387xGMsj+yYq8g0qQHM9gg
// SIG // ce9gvN/WUyxtf+tNQKuy7R0W2oI+pG9D8JTHoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQguf8d+FkG62OM/ZND
// SIG // TjLSCwX79IzRowYBXtFq9H1o91MCFDkQrXICkfIXrRMQ
// SIG // DWGn4SR1dDWkGA8yMDE4MDIxMzE2NDkzMlowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDkzMlowLwYJ
// SIG // KoZIhvcNAQkEMSIEIDPe3ZagCcY3yvxcVJNeYUxmOccb
// SIG // y7AQwt5FG6MQ7FyaMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBeikFmPqcLfBNCaxiR
// SIG // CXkKCgRw/J7zWNu1vVmZiJT5IiAkII2yMUKeQ4IKc3x9
// SIG // WVycg6hUqNS70J72I8Cm+rMB9mCytFy6zTMvinnByJ0r
// SIG // 8cw+yRQzzIlxCZtJ68VppnLMXPGO4KEE0W3DhQ1+gK2b
// SIG // jr7obV7SoiwAW4ZeP5fo80cw2hJWOqCszb8KkflMrKZ0
// SIG // KMx+205OMXS4v6SFD94gNJC7oTSKXKCT5icvEi5dA4zJ
// SIG // KofszQIit1q5gS+zdAAxZe6qLypatnHWk03KdntckCIN
// SIG // nkNX+pRHibYipS3LUmSBl2keV9yyKs1En1JEB/I4AeqF
// SIG // b+sRajvDD/5cJbxb
