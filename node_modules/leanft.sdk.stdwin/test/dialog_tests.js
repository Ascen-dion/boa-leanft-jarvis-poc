...
describe("Dialog Test Object", function () {

    var WindowTO = require("../lib/window.js").WindowTO;
    var DialogTO = require("../lib/dialog.js").DialogTO;
    var windowTOUnderTest;
    var dialogTOUnderTest

    beforeEach(function () {
        windowTOUnderTest = new WindowTO();
        dialogTOUnderTest = new DialogTO();
    });

    describe("Dialog tests", function () {
        it("should check all properties and methods of DialogTO and WindowTO are the same", function () {
            Object.keys(windowTOUnderTest).forEach(function(key){
                assert((Object.keys(dialogTOUnderTest)).indexOf(key) >= 0);
            });
        });
    });
});
...
// SIG // VZeIIVM1rkmKmLzdd5qOWIRvvcIxsZ1XOb1FxPX+yBqg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBKgrvegpRT6yl/IBzmdYgP
// SIG // /fbtJVUweWh9guQUyZAw2jANBgkqhkiG9w0BAQEFAASC
// SIG // AQC8B1HIMNJuRY+Oa0NQ1LeuNYrK9BT99QFbkbgPDUjh
// SIG // J3cu3B8hXy1Ue9Z1ctTjs0/4Rt4YQXUeiejn8veamuR3
// SIG // ZpwuZ1LG46myX94F60jLIkO65xrk5EgJwVeM0WkWavT0
// SIG // STmI4zIn0NH7qjoblrTX3nD/JJoUalpa8p/JOO+1a8in
// SIG // 5L+3wh8cmeo+D3V5U9kYIVsp55lpfBAYTGr+1P/KF+se
// SIG // OYChQsquygRLwvbZLh1YAc0402oESrhELqCEauew+TM0
// SIG // a/FIFMtyOvXFl/YQaL5BL4ILDLTxflmGTQrtcoGrsbs6
// SIG // xMZV+PSfPYm3qbLMns6Bj/VbiZDbtZqgcZhNoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgUG5E8WtXQFYXHCBl
// SIG // v2XlOi8U+g1vOw6Qg3umqw7C37ACFQCFfUHlZ7fCWibH
// SIG // fhkohq/FyUFpCRgPMjAxODAyMTMxNjQ5NTJaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjQ5NTJaMC8G
// SIG // CSqGSIb3DQEJBDEiBCDb/hUei/9eEN4EhghhoBXSoB/H
// SIG // vRdPmeRpCBVhCJDBbDA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEABqxb3HNR7Ko15qX4
// SIG // FQmP9uxzRwnjJ+DnEZreagTFD07pR8UGF0mQ6OJFB73A
// SIG // gMUAsj78fvQQsDM1mc6XUXWl308q5A2gpd8C87dvGrTi
// SIG // o9AQ8QPdwAaqdx1djya8Ti8V0tbQriHCrdv0HPyT34/3
// SIG // rA7zZ5/RaQOP86o/UtZNy/5UTIxLde0dWn4MQIAzb8kF
// SIG // GV3ahuB+oD91Ar7UKuPjnRPizfNDOtcrvEEXhf2P78Iq
// SIG // +R02H91kk/BOVsIYsC4LKBymvc+C3lW+I2iwn5GPMwAV
// SIG // aUGleZ0CDNPBNIBK76Mv0H0JfMYT1ZtPCq/lrVADSq1C
// SIG // zZA+vafhZMNtyy3rMg==
