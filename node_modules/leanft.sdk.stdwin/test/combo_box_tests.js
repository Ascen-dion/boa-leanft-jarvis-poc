...
describe("ComboBox Test Object", function () {
    ...
    describe("open method", function () {
        it("should return the execution promise", function () {
            var executionPromise = {};
            comboboxTOUnderTest._executeWithEvents.returns(executionPromise);
            var res = comboboxTOUnderTest.open();
            assert.equal(res, executionPromise);
        });

        it("should execute _executeWithEvents 'Open' with correct parameters", function () {
            comboboxTOUnderTest.open();
            sinon.assert.calledOnce(comboboxTOUnderTest._executeWithEvents);
            sinon.assert.calledWith(comboboxTOUnderTest._executeWithEvents, sinon.match({ }), "Open");
        });
    });
...
// SIG // LbE0LHANtxnq2F8O3WpLRO9NpKxFqUEv055DiDo4uO2g
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDDYyrCnsPs55c/QYE5spbe
// SIG // BzKUZCM/XfsF2Lqq3J7c3TANBgkqhkiG9w0BAQEFAASC
// SIG // AQCZC+dEvlxYlyMprJ2xuF5h41XZGNYVvmYkfKAmg+Ip
// SIG // FloffMZMvX/p3mNiN1x7lVq+mggbDRGn9Qyrffi0N6wa
// SIG // VlCArGStOD0kgeKi6kiGzfgwLIWggbnZOUtQE47QXM8Y
// SIG // wWlsBlWLlJ4cbAhUlHrEWsHdZvKTPWUYCFOSMmGryy90
// SIG // 6DyHUclsaBxz7xtIJzxfHoMzYqbXjlzdL58jz5g1VGuo
// SIG // gxQb5gg5/aNz0ScSfxlvS+RuFdNqUwjvIWu7CPuqy4Wm
// SIG // i4JVPShVuJCks1XauNQE7gvdqjxHCbkv22nlZKVLUCxf
// SIG // Jtr/BWgt7Bh4gc+Fwh+H9eddd4BcH/Ph35/soYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgi79wyDcu/EZUg6mG
// SIG // ezGgk3/SN3Z4m8pK0HwFqoihj6kCFElvX8s0h4C+4vQq
// SIG // Y/gC9wbodpBZGA8yMDE4MDIxMzE2NDk1M1owAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDk1M1owLwYJ
// SIG // KoZIhvcNAQkEMSIEIHDN0mXtd3TLEnN8yrCTfPgr6vqp
// SIG // CXzybt1BAYscAWn3MDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQAj3LNZ22PJ0dff8rZW
// SIG // W+T7Oizpe5Zj17GQLxVjf4pkw3SnhgWgsEFyhKLkt9P0
// SIG // Q8RmPbQr+BlNx6qidFGTTDmVxnfn5fBwXmiXv82oJrs0
// SIG // jX8aOv5lQEx7udIfoRv9RavOd4+TY2bdyXYrP+reJi/h
// SIG // cncxuyBvB6J8OpDTxdkk3YAqXHuhe5q5hi6ZXnbQ580i
// SIG // /hV9XHZNKNNlgBBlJeljHhhotmi+dmBLgfaKVuwvbD4c
// SIG // 3/cDhAUXIxBpMsj3RxMoQTQAFwIpwHoFu24SzkVTCrg6
// SIG // nIAwXi40JpYZZWyIYR0oADW10IHHLOisupZN0tquPwJ2
// SIG // U0mVAq478MJ2fOcX
