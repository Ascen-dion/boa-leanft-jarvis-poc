...
var ElementTO = require("./element.js").ElementTO;
var WindowTO = require("./window.js").WindowTO;
var TableTO = require("./table.js").TableTO;
var LabelTO = require("./label.js").LabelTO;
var OKCodeTO = require("./ok_code.js").OKCodeTO;
var EditTO = require("./edit.js").EditTO;
var EditorTO = require("./editor.js").EditorTO;
var GridTO = require("./grid.js").GridTO;
var APOGridTO = require("./apogrid.js").APOGridTO;
var ComboBoxTO = require("./combo_box.js").ComboBoxTO;
...
var TreeViewTO = require("./tree_view.js").TreeViewTO;
var StatusBarTO = require("./status_bar.js").StatusBarTO;
var TabControlTO = require("./tab_control.js").TabControlTO;
var CalendarTO = require("./calendar.js").CalendarTO;
var MenubarTO = require("./menu_bar.js").MenubarTO;
var ToolBarTO = require("./tool_bar.js").ToolBarTO;

function SapGuiFactory(session){
    this._logger = new Logger("SAPGUI.TestObjectFactory");
    this._session = session;
    this._technology = "SAPGUI";

    ObjectUtils.extend(this, ConcreteFactoryBehavior);
}

SapGuiFactory.prototype = {
    _logger: null,
    _session: null,
    _technology: null,

    _constructors: {
        "guisession": GuiSessionTO,
        "element": ElementTO,
        "window": WindowTO,
        "table": TableTO,
        "label": LabelTO,
        ...
        "treeview": TreeViewTO,
        "statusbar": StatusBarTO,
        "tabcontrol": TabControlTO,
        "calendar": CalendarTO,
        "menubar": MenubarTO,
        "toolbar": ToolBarTO
    },
    ...
    _nativeClassToLeanFtType: {
        "sapguisession": "guisession",
        "sapguielement": "element",
        "sapguiwindow": "window",
        "sapguitable": "table",
        "sapguilabel": "label",
        "sapguiokcode": "okcode",
        "sapguiedit": "editfield",
        "sapguitextarea": "editor",
        "sapguigrid": "grid",
        "sapguicombobox": "combobox",
        "sapguiapogrid": "apogrid",
        "sapguibutton": "button",
        "sapguicheckbox": "checkbox",
        "sapguiradiobutton": "radiobutton",
        "sapguitree": "treeview",
        "sapguistatusbar": "statusbar",
        "sapguitabstrip": "tabcontrol",
        "sapguicalendar": "calendar",
        "sapguimenubar": "menubar",
        "sapguitoolbar": "toolbar"
    }
};
module.exports.SapGuiFactory = SapGuiFactory;
...
// SIG // mc8Tq6LDqgV5qro9sTNjGJe0CaBJuYlJFBKCFNMXWKKg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDmzR9b2fOUV70lP/xQ7srS
// SIG // XMNTnSnuRiB9XsnuVdExmTANBgkqhkiG9w0BAQEFAASC
// SIG // AQALqg0Bzzz9e+VaRglp08oFhitXaEoNkJ6VIEGTQTTb
// SIG // HPw/Zs1+t+xQXesEwhcQm4HVtqgsoW91qI4SD1nbD0+q
// SIG // DIZKOh6YqgMDwQyCzdDS5bVIqYBuTixEBGZrxgWHukJa
// SIG // Pnc3/eyD3PtYfQXS2ZMRIWmvmLZ8e2B8A2RR83kxd98Q
// SIG // Ww6a0BSkz0hjbT9kNT8/QOIBVgRYIF6jcFfoaaurGH/n
// SIG // tyk721463fvhGqfIEEIvthA0LAX0IlBg2c8vSBFWEI1X
// SIG // AX/hwwiG/u10Ciilmh0hDjRYPpbEupV5aD83NLEKP/o6
// SIG // phfh7JCgDGAN2JTHs45mX4+xwrM9FXiifmpXoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQg1hQ2ox03+rXcN48+
// SIG // bvbAyUO6hzKm8+Hg7E/VuNIdZekCFQCqI9nIDiNYTyDL
// SIG // id2YzJdEiT7DABgPMjAxODAyMTMxNjQ3MzBaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjQ3MzBaMC8G
// SIG // CSqGSIb3DQEJBDEiBCCAUn+G/OMWV69jdOgI6aE6GWqG
// SIG // 29I3bBgr7hNFEltR1zA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAZDr/W2o8CmiNd3rH
// SIG // c7owcA2VlVfvdSsJGnNlqdlQToe8vxNNoEf062stUg5h
// SIG // EN8f0v7BCKLBUrELRflP5xRN/SPy0nu1Br1SSvi7RTzt
// SIG // 8659IIrmmXcfFJqm5FYhOuSmyIHDp/gYf8/LJ6W2yB4Y
// SIG // NxvA4J+5FMJOX6o6REaAfMKslTHXem+BxTEfo0vavi44
// SIG // CB4APVDobFuA1I39NqfUYlClzfZvxfezp+vvwG91EaMh
// SIG // idP5tF4QkjaMunDJf3ehFa5xrR9gDrqj/KHmr3COmPUq
// SIG // YaSVRFyuPdI0xE4+nr5KeZyXWnGkAFweBj+yemSBfXzG
// SIG // 16r+UFa7iNIF5obwbQ==
