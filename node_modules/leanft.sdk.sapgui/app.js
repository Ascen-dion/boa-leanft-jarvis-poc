...
var SapGuiFactory = require("./lib/sap_gui_factory.js").SapGuiFactory;
var DescriptionsAndEnums = {
    ComponentType: require("./lib/component_type.js").ComponentType,
    SapFunctionKey: require("./lib/sap_function_key.js").SapFunctionKey,
    GuiSession: require("./lib/gui_session.js").GuiSession,
    Element: require("./lib/element.js").Element,
    Window: require("./lib/window.js").Window,
    Table: require("./lib/table.js").Table,
    TableSelectionMode: require("./lib/table.js").TableSelectionMode,
    Label: require("./lib/label.js").Label,
    OKCode: require("./lib/ok_code.js").OKCode,
    Edit: require("./lib/edit.js").Edit,
    Editor: require("./lib/editor.js").Editor,
    Grid: require("./lib/grid.js").Grid,
    GridSelectionMode: require("./lib/grid.js").GridSelectionMode,
    APOGrid: require("./lib/apogrid.js").APOGrid,
    ...
    ComboBox: require("./lib/combo_box.js").ComboBox,
    TreeView: require("./lib/tree_view.js").TreeView,
    TreeSelectionMode: require("./lib/tree_view.js").TreeSelectionMode,
    TreeType: require("./lib/tree_view.js").TreeType,
    StatusBar: require("./lib/status_bar.js").StatusBar,
    StatusBarMessageType: require("./lib/status_bar.js").StatusBarMessageType,
    TabControl: require("./lib/tab_control.js").TabControl,
    Calendar: require("./lib/calendar.js").Calendar,
    Menubar: require("./lib/menu_bar.js").Menubar,
    ToolBar: require("./lib/tool_bar.js").ToolBar
};
module.exports.GuiSessionFactory = require("./lib/gui_session_factory.js").GuiSessionFactory;
...
// SIG // BtUj8ziWlXE1kp0NsKAEFuSm4ksHp3b0hIMkeMFZl9+g
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCABtRTLrH+TSfNQwP12bhe3
// SIG // dcYpnYyB1WXySqJvXfliuDANBgkqhkiG9w0BAQEFAASC
// SIG // AQC7eYIVkQ5fP1QOHFpAT6AKg6l0cM2BCurHIshWYdXA
// SIG // PN8oZ/S1YvD9xxYFOys5NJ4jPW+2y5IrEeaSJC6LNO/a
// SIG // XsbVPRmK4Bw0Sv4AucQP4oE1clO6pTkF6e6p2wFSvitx
// SIG // wRdmaoB6oICmBmth30I8/iRvEGJHp8PmsFd5JeCa2LW9
// SIG // id/DoFk7/EoClYFHbzcnfcRIuUI9lIzkQl0WNSc5WJuF
// SIG // Udnl6eXHXnVKQBC7uBfUFz17o53D4vzFmXEBKFvMpcHU
// SIG // d3AHiEWGWEYR0SVaMWevKkMSDfT2F1FHC30hfwi7nhNO
// SIG // CiAW0mrg3Pau1PER7F/ZqbFXx2wOH4CuSPlSoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQglMkpuBEandqseuC0
// SIG // D4FA4jer1mlhotwCmWPy9U8L/J4CFHCQzfofS2RzGjUZ
// SIG // aFn3Mkvb43D/GA8yMDE4MDIxMzE2NDcwOFowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDcwOFowLwYJ
// SIG // KoZIhvcNAQkEMSIEID1jom7bTSfFGeOAggGBjZCSvZHQ
// SIG // oDakFXM0KLuIiB1qMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBaCRZwRHonx+ULjxS1
// SIG // DqXg0eT+r9eLv5Rog3CpecxAXirURWI4fkhI8jghlsvZ
// SIG // 482kd5y6UzbOEc16rwyexRW4vJvfFxaAVwvuz7D8r7Pr
// SIG // 3eJ+ptQuAQjgAFdsDRnZ0r0gOj+R9fN/HkRVNzu80Xal
// SIG // ozVyPwLmHsl+tpuJJ8l1CSTR5fIP7fD7LE4It/mcOLCp
// SIG // Rj2lTeUcKaWR8aN3g1HFZOoqDroomZ0MZ5GalSGDTUvk
// SIG // npyAy8n7WQVr3IImLqNFe0OMVmOcKG0HIWHDdnr+HxhL
// SIG // bhtV9oBs2OAZC43nuligJ6ZTAPU0CY6bQXu/9WK1NdMT
// SIG // H0NxH6a5CoTZNQfe
