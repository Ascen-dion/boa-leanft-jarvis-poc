...
function populateCssBuilder(json, cssPath) {
    var array = ["VerifySuccess", "VerifyFailure"];
...
function generateHtmlFile(jsonFile,cssFile,resultFile) {
    ...
    // styles - style.css
    htmlContent += fs.readFileSync(path.join(scriptsFolder, 'style.min-dyn.css'), 'utf8');
    
    // styles - nv_d3.css
    htmlContent += fs.readFileSync(path.join(scriptsFolder, 'nv_d3.min.css'), 'utf8');

    // styles - ext.css
    htmlContent += fs.readFileSync(path.join(extensionsFolder,'extStyles.css'), 'utf8');
...
// SIG // rQFk72S6ic3svR+qG4IavLhjQKvwYjwW2DfNY3bOJLig
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDRKQacelaXaIPs3mTG2/tR
// SIG // 4b6IgL4qMmRmVfiRyeriLDANBgkqhkiG9w0BAQEFAASC
// SIG // AQCeW2XmbwzTuB0yxERWEj1BI8/cd0NFImbRggrM08fW
// SIG // eJnUYT1yPl9R6TU21pLGLJy+ndCNBtR5UGRCmJhm4wqX
// SIG // T4ym0R299siTnHQgYNjGm3+eo/60IqgvHnXBZg1qip/m
// SIG // QnQW5c+6w6V7EFp7cKDNEqiNmoK0kZTI8t7RnzAuOSzK
// SIG // 3cEjPvO00HDJHvxs7taZyxdCtfl5MR6h2L9vxdMrTBPw
// SIG // c1J91+6i4QhOG9gTk2NLBiTGN3oR3qs/X90+NFSYGsXv
// SIG // GZBAZIBOuqS2eWaOegMXBW0qzRWuL5EvbL7uYJMbA5TW
// SIG // G29VcDlOe5WO3WRMEAFiikuwJZPtrWeG4zUxoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgMOf+Kg8EMVsJmGw4
// SIG // qFiY1mwXvcJ3i/0FOePANmUDIwoCFEKuQm1ris39o0sm
// SIG // HNat2SD/0ptjGA8yMDE4MDIxMzE2NDMwMlowAwIBHqCB
...
// SIG // KoZIhvcNAQkEMSIEIBCvDpmIT+Cpw0tUxlZCo3vUrK4f
// SIG // Gh7+kgQxl0n808ujMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBXEtct9ZQRPCHO7t/h
// SIG // VwmtoYZsE3RAGbd0HlDV0Viq2jwY44UwwEEeUQqvsqdt
// SIG // wu4LWknlixyswazzyWPIoD7z4eflq6+Xl2prpljcIWpc
// SIG // 4N1v4e4YMR82J70ZsNMubSF6OVMSTOQVPJegoucNCkqr
// SIG // HHolvXdsjPOD5+AoyO+yo4jnO1I/RQdzbjgSbminqFp0
// SIG // xmSxHx/lc0kkW/CyefQUPX2J5vjDwBuG5sOJMnfKWZNQ
// SIG // wrQtPFMDkVkGdJP6V8omBwJklybxpYuYdcgqnTrvLFx+
// SIG // rj7CdNvnWfDgVAl4C++Mk25Zp0oa23Oyncufvpzjp4H6
// SIG // 9evLqmYTdgBL34qF
