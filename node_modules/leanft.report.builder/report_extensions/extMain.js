...
(function () {
	...
	__reportExtension.addExternalRender('RKey:TestFlowTree.Node.Caption.Icon', {
		...
		preCheck: function (context, args) {
			...
			if (nodeType === nodeTypes.suite || nodeType === nodeTypes.spec)
				args.needExec = true;
		},
		...
		execute: function (context, args) {
			...
			switch(nodeType) {
				case nodeTypes.suite:
					...
					break;
				case nodeTypes.spec:
					context.icon_key = 'my-node-spec-icon';
					break;
			}
		}
	});
...
// SIG // ZtIaBwE+2shZqFhcF+m370d5X+P3x37mDljRPHxiSnCg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCC1u9SFsNc6b7cX2V5dmwEU
// SIG // +86nLNq2Jzhhji/hXbz/nzANBgkqhkiG9w0BAQEFAASC
// SIG // AQAX4/2koQeFJJ2mR7DVvQEwKWHhWvyLpCHAA/JuXPA4
// SIG // YYDkWoG2MJRxKrURmbL87lcOPYbT2VYe2ymr1DLt2+BD
// SIG // CcnxKzViPFSZvcgYtwwf3N84/1lH39M9VsMaImYskiN/
// SIG // IppEK4qc5ahykThc9ikUxZptyoxaST9qlxjbBGAuq9fM
// SIG // hKP0hdkZvNKoOLAGqaknO7peO1V2Bj6X96JnnBDIlF/O
// SIG // LMq8QUgW86ibU04KYwSfwJgqfOieeFPy8QDgh1ReF5qI
// SIG // nq2/Cj+pk188uOzVX3XH44XqG76yJgbLP4cNGpzn9Fzv
// SIG // L4FLoZPuB2J9TsM5wMQTV3EwInv/b/RQTienoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgPZ+pDBeouny+eTfX
// SIG // cpMfKB824JFS62gKab1iuVECPkwCFQCgzQ7DFrdjNBH0
// SIG // 4bTZQD0KMJ4hSxgPMjAxODAyMTMxNjQzMjlaMAMCAR6g
...
// SIG // CSqGSIb3DQEJBDEiBCCrAMk2m7vQaK3npdLOWl8CJeda
// SIG // OaYTBoQXss/XQk3LBjA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAFgSPGvjCg+q9Vc2N
// SIG // YqYvzFkZnlg4hgZVPPTlWhUvuZCGXCeW/BcbaYd24a1L
// SIG // AsrbQMJZaW4NA6WJAVLqAFXU+wvfIlJZRKuXEuV1ivTe
// SIG // HN3oi4/AQvr6aM3jFZiDvWdVM7mfQOxujUD0yFOgw4B2
// SIG // 1lEBNgNGtHNjSxqylNX+FPvz4vldPR9dmKHbGDve4Tlg
// SIG // np8Xt3rBhPLHh/G5rrqt1bW0rbANZ9RFCD/DG6Gc/zl8
// SIG // UDH+moASuL52r0GBbMKesQZR2Df7mORITYcbhjmSBEK/
// SIG // nqZFAxdxz64aLGdnZaYpy+rJOG3LJvO70pZ/QU5QIzz7
// SIG // jWkwdtOOHnxJbj69GA==
