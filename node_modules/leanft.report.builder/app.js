...
var buildReport = require("./lib/report.builder.js");
if (process.argv[1] === __filename){
    var outputFolder = process.argv[2];
    if (!outputFolder) {
        console.log("Output folder is null or empty");
        process.exit(1);
    }
    var xmlPath = Path.join(outputFolder, "runresults.xml");
    var jsonPath = Path.join(outputFolder, "runresults.json");
    var cssPath = Path.join(outputFolder, "runresults.css");
    var htmlPath = Path.join(outputFolder, "runresults.html");
    buildReport({xmlPath : xmlPath ,jsonPath : jsonPath , cssPath : cssPath, htmlPath : htmlPath });
    return;
}
else{
...
// SIG // hKrExHflUszUBKnL+nujdxusQYA9yRHHbpgfY7TULd+g
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCCtRL7dKY7TqWqncok6oSyE
// SIG // 8UX0Iu5D95nZ8cqUeKXvojANBgkqhkiG9w0BAQEFAASC
// SIG // AQA5BG/2aSh1C7W8nxgto6jAkKMHUXywUaCBcpCtccen
// SIG // NnhIQgd4Xc6O6piweb4HEM87sHBJNlb5uZ5jxcitgRqU
// SIG // 7STPcWVWu0VxxgYybZQXPZmuFOswFMei9xvSGvF5iYpt
// SIG // PsN9wKVgTlts5dhHNlplx1jwkh0RgDclXy7i5NBLrUs3
// SIG // 5bZNc9rfUsdpYXwX4cfg6uQ6xXkGlPz2Wl1izIECY+xo
// SIG // 4m76QIpAOsATJa9VqreZVFKHPX0ovdW+WrkM9ySzrkda
// SIG // ADnSA9uHYXUeRp8dAFW7Le0N6ulj/OXZVSIFHVbnCOtH
// SIG // tixF8OCPuwhle8qCD0EUV0TsxilfOcg7DvoZoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgZ7a21DfOknLsxohH
// SIG // JtWJJfnPxoJw1G/a/jzFkEXIvuICFAULUprRZCWkaJ3f
// SIG // WGfBaAvheNkXGA8yMDE4MDIxMzE2NDMyOVowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDMyOVowLwYJ
// SIG // KoZIhvcNAQkEMSIEIBQqgO9JzbGmi82Dm9a7x1WW3GBB
// SIG // T1wfx4zcjtdmrgn1MDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBd36wNeD2KfCPL4AK9
// SIG // lZaWbDDjyG4O3NAVcOji+KBij7iUI7XwF5LT0dkfpMg/
// SIG // 7q5haBrIvx9UhMCgWrG6e20QHU8sHyu5PPjuhClb9U8u
// SIG // nGKvaPCLcgWzmWWSx2it8AuIGILmwFrtnJTySZCUO6Gc
// SIG // hB0lArO6xAenOu9iE7VRltIQ50t/0Ov8cDsZnsyQtp9b
// SIG // eN+3fJMbOc/hPddCYpP8NVocUTU0GlfcLP7RVPApiQdb
// SIG // XRApi6d4TkctEIFUlY9ITLfUWOVbWff+EMKlpuPhjOUH
// SIG // pHNmBlz6CZsDBKbCmUMO3CJgtyXQs9HGIBjeVWCrRnOY
// SIG // SaNSStvLHMN0JmY6
