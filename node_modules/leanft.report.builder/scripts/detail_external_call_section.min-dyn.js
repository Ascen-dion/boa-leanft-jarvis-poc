function DetailExternalCallSection(b,c){this._cssNames={sectionWrapper:"detail-section-wrapper",section:"detail-section",externalCallSection:"external-call-section",layout:"section-layout",captionLabel:"caption-label",additionalCaption:"additional-caption",dataLabel:"data-label",dataContent:"data-content"};this._sectionData=b;this._sectionUIMetadata=c;this._sectionWrapper=__uiElements.create_div().addClassNames(this._cssNames.sectionWrapper).appendTo(this._sectionUIMetadata.sections);this._lazyCallbackKey="cb_detail_extcall_"+this._sectionUIMetadata.itemDataKey;var a=new CallbackInfo(this._lazyCallbackKey);a.register(this,this._initialize,"init");__uiViewObjectsCenter.addLazyTask(this._lazyCallbackKey,a);}DetailExternalCallSection.prototype.updateUILayout=function(){__uiViewObjectsCenter.forceExecuteLazyTask(this._lazyCallbackKey);return this;};DetailExternalCallSection.prototype._initialize=function(){this._section=__uiElements.create_div().addClassNames(this._cssNames.section,this._cssNames.externalCallSection).appendTo(this._sectionWrapper);this._sectionLayout=__uiElements.create_div().addClassNames(this._cssNames.layout).appendTo(this._section);this._contentTable=__uiElements.create_table().appendTo(this._sectionLayout);var c=__uiElements.add_table_row(this._contentTable);var b=__uiElements.add_table_cell(c);var a=__commonUtils.str.normalizeAll(__commonUtils.general.getValue(this._sectionData.caption,this._sectionData));this._createSearchableElement(this._getUIId("caption"),a).addClassNames(this._cssNames.captionLabel).appendTo(b);this._createRows_ExternalLink();return this;};DetailExternalCallSection.prototype._createRows_ExternalLink=function(){var d=__commonUtils.general.getValue(this._sectionData.link,this._sectionData);if(d){var b="";b+=__commonUtils.str.normalizeAll(__commonUtils.general.getValue(this._sectionData.link_label,this._sectionData));if(b){b+=": ";}b+='<a href="'+d+'" target="_self">';b+=__commonUtils.str.normalizeAll(__commonUtils.general.getValue(this._sectionData.link_text,this._sectionData),"LINK");b+="</a>";var c=__uiElements.add_table_row(this._contentTable);var a=__uiElements.add_table_cell(c);this._createSearchableElement(this._getUIId("link"),b).addClassNames(this._cssNames.dataContent).appendTo(a);}return this;};DetailExternalCallSection.prototype._getUIId=function(a){if(a){return"item_detail_extcall_section_"+a+"_"+this._sectionUIMetadata.itemDataKey;}else{return Math.uuid();}};DetailExternalCallSection.prototype._createSearchableElement=function(e,a,d){if(!e){e=Math.uuid();}if(!a){a="";}if(!d){d=this._sectionUIMetadata.searchRankBase+500;}var c={id:e,content:a,rank:d,unmatchHideUIId:this._sectionUIMetadata.searchUnmatchHideUIIds};var b=__fullTextSearchHelper.createSearchableNode(c);__fullTextSearchHelper.addSearchableNodes([b]);return __uiElements.get_wrapper(b);};
// SIG // Begin signature block
// SIG // MIIi1gYJKoZIhvcNAQcCoIIixzCCIsMCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // 6dgsP4LP58Wl/bbNfrVaMktFZUPNJcClnU7huBO2CqSg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCD28HnBPj0WZe/b6iNpBn73
// SIG // l27JRXI7tdU0c8pQNsrrQjANBgkqhkiG9w0BAQEFAASC
// SIG // AQAiW44cDuTHa18/K6UGJWmB7BZNiJEnF7dUNZ8ep4AZ
// SIG // /kygMbTgQqcPaZH7xkAglro6kdOhJiCs06EiXKI+7VQ7
// SIG // tHoFlN9RYRLfHWo1UljH5TDT7chzdeOMTucMx53dQXRi
// SIG // I724/v/OCMNhAmZpqC1bLGgSmHT0Y/5snxUtpXVsReuP
// SIG // oSnv64Qo7PVbXcapPii10CEJpF9Zrnh+JxIjxR3omSoL
// SIG // tSeGRGa+ZirbEgWtgkaxEUKsRU+qoEtSo4zHpLUND0SY
// SIG // PRrbD3Sbb/s5l2r5DlrnpmCGlukEsDaJBxPjVCI063GM
// SIG // DtjDLFeY0pYpRqTLgZX+xNHuwxjCqBHaIwTKoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgGPY9D6r2JQO9GA+W
// SIG // X8xC3VA0Qj9a4Yn8P36zSiWoJZYCFFF6IQMUIVyhWztO
// SIG // w5gffGzyaylFGA8yMDE4MDIxMzE2NDMwMlowAwIBHqCB
...
// SIG // KoZIhvcNAQkEMSIEIDj1ifGilLEvrPFCUfOLtL5kwyyw
// SIG // bU6ARtlX5l05jiO5MDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQA+SKknypuq0wzzFScH
// SIG // UmNrSjIioxnNEs1pmpCD5/t4LbMWSnqejRQBpDWYZE4V
// SIG // kKdO3IaqFvEEXmnio5vlucFWuMRw+6B+jXYILleS/ytf
// SIG // Bm7WOg4u/wS3cur/QYBxWvwhUk4g7pGFpyBr6qV6E0SB
// SIG // IVHzJv67MO2pOQll7UeFO8rGwgerOLCkF0ann4ouQ49c
// SIG // wUIDOOMLD9HohBsVaBeeDid3e2sjG91f0QmdtJ+kBWDS
// SIG // 9OQNADE0f507SaOVq+KRiiUHjdKMDqZqacn4MWKUIecY
// SIG // 8OUINOdtXrWQKS4TksOuMr2NdTeonmr937Xz2TVVCtLm
// SIG // frGsijtucMzAGT4y
