function SystemMonitorPane(a){this._cssNames={linkItem:"link-item",};this._dataModel=a;this._paneWrapper=__uiElements.get_wrapper(document.getElementById("system_monitor"));var e=__commonUtils.general.getValue(__dataModel.system_monitor_link_url,__dataModel);if(e&&document.getElementsByClassName("monitor_title").length==0){var d=__uiElements.create_div().addClassNames("monitor_title");var c=__uiElements.get_wrapper(document.createElement("span")).setInnerHTML(monitorData.application).appendTo(d);var b=__uiElements.create_link("####").addClassNames(this._cssNames.linkItem).setInnerHTML(__commonUtils.general.getValue(this._dataModel.system_monitor_link_label,this._dataModel)).setCustomProperty("hostObj",this).setCustomProperty("linkURL",e).setOnClickHandler(this._systemMonitorLinkClickHandler).appendTo(d);this._paneWrapper.e.insertBefore(d.e,this._paneWrapper.e.childNodes[0]);}}SystemMonitorPane.prototype.addGraph=function(a){nv.addGraph(function(){this._chart=nv.models.lineChart().options({duration:300,useInteractiveGuideline:true});this._chart.xAxis.axisLabel(__res.get("xAxisLSM","Time (s)")).tickFormat(d3.format(",.1f")).staggerLabels(true);this._chart.yAxis.axisLabel(" ").tickFormat(function(e){if(e==null){return"N/A";}return d3.format(",.2f")(e);});var b=monitorData.runResults;var d=(b.length/7|0)+1;var c=92;d3.select("#system_monitor").append("svg").style("height",c+d*2.6+"%").datum(b).call(this._chart);nv.utils.windowResize(this._chart.update);return this._chart;});nv.addGraph(a);};SystemMonitorPane.prototype._systemMonitorLinkClickHandler=function(){var a=__uiElements.get_custom_prop(this,"linkURL");window.open(a,Math.uuid());return false;};SystemMonitorPane.prototype.show=function(a){if(a){this._paneWrapper.appendTo(a);}return this;};SystemMonitorPane.prototype.updateLayout=function(a){this._paneWrapper.setHeight(a);if(this._chart){this._chart.update();}return this;};
// SIG // Begin signature block
// SIG // MIIi1wYJKoZIhvcNAQcCoIIiyDCCIsQCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // to1PnluRaxY3WyZ9QYLBJyUGuHXLqVZFKrbw2xI+gHag
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCD00zZT32S32vyCv4OgSwzn
// SIG // ak0R4U7f4j0Lx2B7CREXPzANBgkqhkiG9w0BAQEFAASC
// SIG // AQAijgtae849R094zdXq8KKU4fiRhxDZKImFd+zfX/BE
// SIG // FwRY8fRxenbNJrs3phaA1thnDIyeJFbx/RyFyXglRZUQ
// SIG // Knnt769iFo5xM46dSi48vwBgGqfD/tPp1hOtO4SLepyh
// SIG // zDy+EfszDb5i0b9e4abQ3xIoBGj2qS2tw3+moGqwve17
// SIG // YIhRd/K+bazsnUUQaEsPQXSwdhgKOZpbI/5xO4a1pVvD
// SIG // 1vuqP6nZ/8OL81xYjDoA5DVRcWnWBQUm9x2lm53NWwhy
// SIG // Zfa0mnWDcN8gMTF/8dDWT2orQCOLzpA9V3kWUs0wTHf2
// SIG // s7gLGYw6gIEfDbmRx0XPSzfIRSk4YywrxXrDoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgmC6QZyyJO97Xhoy2
// SIG // gmtOYA1phMuyX8lYTPqlE0LwriwCFQDQSBHtqdpteZRQ
// SIG // Ms0873gpga52mxgPMjAxODAyMTMxNjQzMjRaMAMCAR6g
...
// SIG // CSqGSIb3DQEJBDEiBCCCtYW+sLxR/zrS3ku9gtVJwH/Y
// SIG // co2IfYpZsHIBQy/z8DA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAU5/uGTIbHhyeDnYi
// SIG // VRE9F7HRVangos1wXjdUdjYMtOw8LVvx8p5IYeZhveNn
// SIG // elV1pZc1bKnpH8yHQCjHyCCQu8MtJl5CYtQkZHNiCsGu
// SIG // jZOvptvfeiKEFn65lLl9Ra0my0m6KC4FGzVOpPlrSdGr
// SIG // 955Rx3eSag9nmUoXdG6Hq+TXMHTODf9CvU8QrtkrdzK0
// SIG // E/W7ikUbmHRyXoE2LifYkuOX701aTukO2ZlBrs5p+jVJ
// SIG // AMNg9nVsgUPq6KGe++2TNWnzEsxzVbh20aitRjlCedps
// SIG // XTU/y/zKXTnjyQuGRLqXA4e3h4vsSog93wIX+Ecmaf6/
// SIG // m0xQgPEB9d4uQc+5/g==
