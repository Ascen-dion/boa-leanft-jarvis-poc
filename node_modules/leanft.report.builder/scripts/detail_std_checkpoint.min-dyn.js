function DetailStdCheckpointSection(b,c){this._cssNames={sectionWrapper:"detail-section-wrapper",section:"detail-section",checkpointSection:"checkpoint-section",stdCheckpoint:"std-checkpoint",layout:"section-layout",captionLabel:"caption-label",additionalCaption:"additional-caption",dataLabel:"data-label",dataContent:"data-content",propTable:"prop-table",propTableHead:"prop-table-head",propDifference:"prop-diff",settingsWrapper:"settings-wrapper",settingsEntry:"settings-entry"};this._sectionData=b;this._sectionUIMetadata=c;this._sectionWrapper=__uiElements.create_div().addClassNames(this._cssNames.sectionWrapper).appendTo(this._sectionUIMetadata.sections);this._lazyCallbackKey="cb_detail_stdchkpt_"+this._sectionUIMetadata.itemDataKey;var a=new CallbackInfo(this._lazyCallbackKey);a.register(this,this._initialize,"init");__uiViewObjectsCenter.addLazyTask(this._lazyCallbackKey,a);}DetailStdCheckpointSection.prototype.updateUILayout=function(){__uiViewObjectsCenter.forceExecuteLazyTask(this._lazyCallbackKey);return this;};DetailStdCheckpointSection.prototype._initialize=function(){this._section=__uiElements.create_div().addClassNames(this._cssNames.section,this._cssNames.checkpointSection,this._cssNames.stdCheckpoint).appendTo(this._sectionWrapper);this._sectionLayout=__uiElements.create_div().addClassNames(this._cssNames.layout).appendTo(this._section);this._contentTable=__uiElements.create_table().appendTo(this._sectionLayout);var c=__uiElements.add_table_row(this._contentTable);var b=__uiElements.add_table_cell(c);var a=__commonUtils.str.normalizeAll(__commonUtils.general.getValue(this._sectionData.caption,this._sectionData));this._createSearchableElement(this._getUIId("caption"),a).addClassNames(this._cssNames.captionLabel).appendTo(b);this._createRows_CheckpointTimeout()._createRows_CheckpointPropertiesTable();return this;};DetailStdCheckpointSection.prototype._createRows_CheckpointTimeout=function(){var d=__commonUtils.general.getValue(this._sectionData.timeout_text,this._sectionData);if(d){var b=__commonUtils.str.normalizeAll(__commonUtils.general.getValue(this._sectionData.label_timeout,this._sectionData));var f=__commonUtils.str.normalizeAll(d);var c=__uiElements.add_table_row(this._contentTable);var a=__uiElements.add_table_cell(c);this._createSearchableElement(this._getUIId("timeout_label"),b).addClassNames(this._cssNames.dataLabel).appendTo(a);var g=__uiElements.add_table_row(this._contentTable);var e=__uiElements.add_table_cell(g);this._createSearchableElement(this._getUIId("timeout_value"),f).addClassNames(this._cssNames.dataContent).appendTo(e);}return this;};DetailStdCheckpointSection.prototype._createRows_CheckpointPropertiesTable=function(){var y=__commonUtils.array.makeArray(__commonUtils.general.getValue(this._sectionData.properties,this._sectionData));if(y&&y.length>0){var l=__commonUtils.str.normalizeAll(__commonUtils.general.getValue(this._sectionData.label_props,this._sectionData));var m=__uiElements.add_table_row(this._contentTable);var k=__uiElements.add_table_cell(m);this._createSearchableElement(this._getUIId("props_table"),l).addClassNames(this._cssNames.dataLabel).appendTo(k);var F=__uiElements.add_table_row(this._contentTable);var E=__uiElements.add_table_cell(F);var c=__uiElements.create_div().addClassNames(this._cssNames.dataContent).appendTo(E);var A=__uiElements.create_table().addClassNames(this._cssNames.propTable).appendTo(c);var g=__uiElements.add_table_row(A);var n=__commonUtils.str.normalizeAll(__commonUtils.general.getValue(this._sectionData.head_caption_name,this._sectionData),"Name");var o=__uiElements.add_table_cell(g).addClassNames(this._cssNames.propTableHead);this._createSearchableElement(this._getUIId("props_table_header_name"),n).appendTo(o);var d=__commonUtils.str.normalizeAll(__commonUtils.general.getValue(this._sectionData.head_caption_expected,this._sectionData),"Expected");var e=__uiElements.add_table_cell(g).addClassNames(this._cssNames.propTableHead);this._createSearchableElement(this._getUIId("props_table_header_expected"),d).appendTo(e);var a=__commonUtils.str.normalizeAll(__commonUtils.general.getValue(this._sectionData.head_caption_actual,this._sectionData),"Actual");var b=__uiElements.add_table_cell(g).addClassNames(this._cssNames.propTableHead);this._createSearchableElement(this._getUIId("props_table_header_actual"),a).appendTo(b);var q=__commonUtils.general.getValue(this._sectionData.spec_value_none,this._sectionData);for(var h=0;h<y.length;h++){var r=y[h];if(r){var z=__uiElements.add_table_row(A);var w=__commonUtils.str.normalizeAll(__commonUtils.general.getValue(r.name,r));var x=__uiElements.add_table_cell(z);this._createSearchableElement(this._getUIId("prop"+(h+1)+"_name"),w).appendTo(x);var u=__commonUtils.str.normalizeAll(__commonUtils.general.getValue(r.expected,r));if(!u){u=q;}var v=__uiElements.add_table_cell(z);this._createSearchableElement(this._getUIId("prop"+(h+1)+"_expected"),u).appendTo(v);var B=__commonUtils.general.getValue(r.regexp,r);var f=__commonUtils.general.getValue(r.formula,r);if(B||f){var C=__uiElements.create_div().addClassNames(this._cssNames.settingsWrapper).appendTo(v);if(B){var D=__commonUtils.general.getValue(this._sectionData.settings_regexp,this._sectionData);this._createSearchableElementWithTag(this._getUIId("prop"+(h+1)+"_regexp"),D,null,"span").addClassNames(this._cssNames.settingsEntry).appendTo(C);}if(f){var D=__commonUtils.general.getValue(this._sectionData.settings_formula,this._sectionData);this._createSearchableElementWithTag(this._getUIId("prop"+(h+1)+"_formula"),D,null,"span").addClassNames(this._cssNames.settingsEntry).appendTo(C);}}var s=__commonUtils.str.normalizeAll(__commonUtils.general.getValue(r.actual,r));if(!s){s=q;}var t=__uiElements.add_table_cell(z);this._createSearchableElement(this._getUIId("prop"+(h+1)+"_actual"),s).appendTo(t);var j=__commonUtils.general.getValue(r.pass,r);if(typeof j=="undefined"||j==null){j=(u==s);}if(!j){t.addClassNames(this._cssNames.propDifference);}}}}return this;};DetailStdCheckpointSection.prototype._getUIId=function(a){if(a){return"item_detail_stdchkpt_section_"+a+"_"+this._sectionUIMetadata.itemDataKey;}else{return Math.uuid();}};DetailStdCheckpointSection.prototype._createSearchableElement=function(c,a,b){return this._createSearchableElementWithTag(c,a,b);};DetailStdCheckpointSection.prototype._createSearchableElementWithTag=function(f,a,d,e){if(!f){f=Math.uuid();}if(!a){a="";}if(!d){d=this._sectionUIMetadata.searchRankBase+100;}if(!e){e="div";}var c={id:f,content:a,rank:d,tag:e,unmatchHideUIId:this._sectionUIMetadata.searchUnmatchHideUIIds};var b=__fullTextSearchHelper.createSearchableNode(c);__fullTextSearchHelper.addSearchableNodes([b]);return __uiElements.get_wrapper(b);};
// SIG // Begin signature block
// SIG // MIIi1wYJKoZIhvcNAQcCoIIiyDCCIsQCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // /DWPbtjBzDiJ7OAmB3IV5x5gZfkfkvSBObY3p+kYjTag
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCAF2J/DabAbXu/YEF4I0up1
// SIG // fUO/abAX6qqxmJKrJ4e1ezANBgkqhkiG9w0BAQEFAASC
// SIG // AQBIHTrOFB3Owf1fZ+T4r19pjblc2tW7AZkrGYxO0PLi
// SIG // GDA9m3ZCVtBallkp7qCg95lByPPyrghzZ/KrrZMGFyPs
// SIG // l7o5wYOBOJp/IC5btRk56DHDBoExlntf0jud0wl+70+4
// SIG // aLAeIYtQiLOZ6iJ0i9mBKASF/CSY8G1eqmMkXavBbe+y
// SIG // qWDVeP4I/HOBu7HsVFoQ0syDQbaLO94T1Dt3DZQnxjFX
// SIG // Gz7gFCJuSJ89TY9Z+tPQZyv69dHVamq2U6nChJ+hJAWv
// SIG // 6mxp00czrCHd+ajkUTnjf5e2/dcU/czHwwSuG25Omf1n
// SIG // A9DK+3OTcY8/ErrcDFnEf26zE7tv5Ntg6wSmoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgdT4cS0utGHroyXT/
// SIG // k9iD/zIR/8i8yWs1rSnctb5Vr08CFQDc1AWio7AM5kGj
// SIG // 0dgecSaoBJE9AxgPMjAxODAyMTMxNjQzMDJaMAMCAR6g
...
// SIG // CSqGSIb3DQEJBDEiBCAsL8m/zPR4DcRo31OItADfVpeQ
// SIG // V+yyGVrmGSNDOtICmTA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEABPev+nSsWQvHIzUh
// SIG // AV1BjB5cbJ/gxU11C743PdGTdHSMNYD1epbb0O21vnO8
// SIG // mfGUP5yGfigM74Ei9FsDphnTqIPl/zNE/kQAS+8z9j2g
// SIG // i2BW7S9fc2BxD4qapOFWcQwgWpviDzrxzav4Qmaifaay
// SIG // Jf8+L/SVKxFPVyDEHo49BsKwMzicJhO+Aj5f9pJxzlYs
// SIG // w8+s3b0SPPLGcxQ8MrqMcWkVRHAzM8YDCd63uBax0Cpc
// SIG // jMEbZUnBVG5Q4yO7ovAvS+8bzIIvUXO0BF3Eedb10NWV
// SIG // km4ft8TtEDxL9355kRCUhbT9iMTEO/e6ST6sA0aZVYb6
// SIG // HgwNy6lNQ5WqcA3mAA==
