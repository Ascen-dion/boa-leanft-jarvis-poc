function LogoStrip(a){this._cssNames={stripWrapper:"logo-strip-wrapper",strip:"logo-strip"};this._dataModel=a;this._stripWrapper=__uiElements.create_div().addClassNames(this._cssNames.stripWrapper);this._strip=__uiElements.create_div().addClassNames(this._cssNames.strip).appendTo(this._stripWrapper);}LogoStrip.prototype.show=function(b){if(b&&this._stripWrapper&&this._strip&&this._dataModel){var a={defaultLogoIconCSS:"bgicon-logo32",defaultLogoText:__commonUtils.general.getValue(this._dataModel.logo_text,this._dataModel),logoStrip:this._strip};var c=__defaultRenders.keys["LogoStrip._All"];if(!__reportExtension.executeExternalRenders(c,a)){__defaultRenders.execute(c,a);}__uiElements.create_cleardiv().appendTo(this._stripWrapper);this._stripWrapper.appendTo(b);}return this;};LogoStrip.prototype.getTotalHeight=function(){if(this._stripWrapper){return this._stripWrapper.getHeight();}};function LogoStripRenderer(b,c,a){this._cssNames={logoIcon:"logo-icon",iconBg:b||"bgicon-logo32",logoText:"logo-text",languageBar:"language-bar",firstLanguage:"first-lang"};this._logoText=c||"Report";this._disableLanguageBar=a;}LogoStripRenderer.prototype.render=function(c){if(c){if(!this._disableLanguageBar){LogoStripRenderer.renderLanguageBar(c,this._cssNames.languageBar,this._cssNames.firstLanguage);}var a=__uiElements.create_div().addClassNames(this._cssNames.logoIcon).appendTo(c);var f=__defaultRenders.keys["LogoStrip.Icon"];var b={defaultIconCSSName:this._cssNames.iconBg,logoIconElement:a,logoStrip:c};if(!__reportExtension.executeExternalRenders(f,b)){a.addClassNames(this._cssNames.iconBg);}var d=__uiElements.create_div().addClassNames(this._cssNames.logoText).appendTo(c);var g=__defaultRenders.keys["LogoStrip.Text"];var e={defaultText:this._logoText,logoTextElement:d,logoStrip:c};if(!__reportExtension.executeExternalRenders(g,e)){d.setInnerHTML(this._logoText);}}return this;};LogoStripRenderer.renderLanguageBar=function(e,d,b){if(__res.preferredLangId!=__res.neutralLangId){var a={languageBar:d||"language-bar",firstLanguage:b||"first-lang"};var g=__res.getLangDisplayName(__res.preferredLangId);var f=__res.getLangDisplayName(__res.neutralLangId);if(g&&f){var c=__uiElements.create_div().addClassNames(a.languageBar).appendTo(e);__uiElements.create_link('javascript:location.search="'+LogoStripRenderer._getNewLocationSearch(__res.preferredLangId)+'"',"_self").addClassNames(a.firstLanguage).setInnerHTML(g).appendTo(c);__uiElements.create_link('javascript:location.search="'+LogoStripRenderer._getNewLocationSearch(__res.neutralLangId)+'"',"_self").setInnerHTML(f).appendTo(c);}}};LogoStripRenderer._getNewLocationSearch=function(d){if(d){var a=location.search;var h="";var f="langid";if(!a){h="?"+f+"="+d;}else{var e=false;var l=a.match(new RegExp("[?&][^?&]+=[^?&]*","g"));if(l&&l.length>0){for(var b=0;b<l.length;b++){var j=l[b];var k=j[0];var c=j.slice(1).split("=");if(c&&c.length>0){var g=c[0];if(g==f){h+=k+g+"="+d;e=true;}else{h+=j;}}}}if(!e){h+="&"+f+"="+d;}}return h;}};(function(){__defaultRenders.add(__defaultRenders.keys["LogoStrip._All"],function(d){if(!d){return;}var b=d.logoStrip;if(!b){return;}var a=d.defaultLogoIconCSS;var c=d.defaultLogoText;new LogoStripRenderer(a,c).render(b);});})();
// SIG // Begin signature block
// SIG // MIIi1gYJKoZIhvcNAQcCoIIixzCCIsMCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // L5+ajMpES2cQ7GWsVmv2frUNHHueZhXy9wvOYSezyL+g
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCACHxbrHrlZoXoe32T+jG8Q
// SIG // osexGKaMZJGyWtzFmkdpfjANBgkqhkiG9w0BAQEFAASC
// SIG // AQCSTTWl5COn9oALkb6LcD/B32a8Cl+emBp1EedS4yso
// SIG // 6OWFjqMsK6mXbHqT6DM6C/4UomO/SGVEb9+Z2l4j9NAu
// SIG // vUGgSyFMiFP8iAh9WmN3WycVkHJcycnDxDznRNs8qlv3
// SIG // gN2xcTcu0OKY90yT2UCycpNiPrii4lVkZjYDlsBFO45k
// SIG // CFDuupacqDh+wW97TOwh5qMZ14tGglBsGsGtbLpWmI0v
// SIG // +rV1z4PQqt8fq8Z1SiGRu0ahmz7tKhUWZ5pUIs/3iiiK
// SIG // Z+l8Oc9K+t2Wks9hDBRfcn+m9iiddtI9xZ6cOjnKk4Gh
// SIG // nQcFUgOMorqoxOSTmVVpnbow4gjIzi9zCuyHoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQg1Ks+jy/lBCWZK376
// SIG // TgfZbLtj1GiDSl2RThRN9e72iPQCFHeMN6fZROB7u1p9
// SIG // JOggJxYGcIfzGA8yMDE4MDIxMzE2NDMyNFowAwIBHqCB
...
// SIG // KoZIhvcNAQkEMSIEIJ1y49yXYSn2dspZqHL2sVd6ORT8
// SIG // DI30kmMEP246k1ShMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBW303kPJfkHb667q0I
// SIG // TvpoojAACQjS6WzLQElsAk1d2tZ3zYxmiP+5hOptd4P0
// SIG // SwRLWYoFp2qTM+P78cL8d7UDOeLNMqOU9QbJipJMalwF
// SIG // F4JadpkX3gejtEF5V1y7un5B5SOk86koqy1oegw7BV7a
// SIG // fBSVVqBlzVZy9Sj002tjEVOU8ggob1wHO4/a0X5H/dAB
// SIG // J1MAs07RGsDKs6reFYLiSJ0sQJXSF2KM2/G/bitP03C8
// SIG // iwDHpZuVFiq8Mtsh4xgPihVG4HUlg07mjyHJuKPOsF63
// SIG // SIhojYye4eFAvix1Gn6agHh3swtiSMlHyYZEhn7uSb2M
// SIG // F1kUz3GbOH4divmc
