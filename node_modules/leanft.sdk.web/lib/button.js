...
//Consts
var disabledWiredName = "disabled";
...
var ButtonTOBehavior = {
    ...
    _properties: {
        ...
        /**
         * Returns the state of the 'disabled' attribute of the button.
         * @returns {Promise<boolean>} a promise that is fulfilled with a boolean indicating the state of the 'disabled' attribute of the button.
         * @function
         */
        isEnabled: {
            wiredName: disabledWiredName,
            getter: function () {
                return this._getROProperty(disabledWiredName, arguments).then(HelperFuncs.intToOppositeBool);
            }
        },
        /**
...
// SIG // LaRaeJhnoLlaKbDo7osWKYnJOs2z94NMh7gPXsmfhYWg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDdgqHhlzYmCRyaoRyibNYz
// SIG // cppPitaCXqjKMnHGn5dF1jANBgkqhkiG9w0BAQEFAASC
// SIG // AQAobFbuBtT0RkSplByHApiOaLSnhIjJ/CCiDsbto+Tt
// SIG // PQpK5qgh1cNUU+y8Iz9GYyDfCnAY9+ZHUinNq7p5/Dnz
// SIG // /nfM2aXr7S7hjaa1Te5cJMyy4D3VaRmArZce3BWStveH
// SIG // OGnZ5ht6bOM4Y6H8P1BrPfGcOcYKKbmtxQlzckmhfWxU
// SIG // Ap0SWtpv1WKdYnHBx63nczTokoqGYkx/eVWd7DCyb8MF
// SIG // 1TJoOvJN5NPNsvbUkfswBXoILxZtDWboBaTsmNAzDly5
// SIG // 7S2M5Nj4zTMTqA6IrUAIdraopCYcq552XdZridI4p7+v
// SIG // mP+Kx0tmZr7xfC81jy8tbfJyGBsQ/T94oP4/oYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgMLGyYdObD8gZQ4F8
// SIG // RCyXmHJ22wgnNY+XgrOVeh9QbwcCFGoN9WYusC05Q7I7
// SIG // lctH0tAJQEp3GA8yMDE4MDIxMzE2NTAzMFowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NTAzMFowLwYJ
// SIG // KoZIhvcNAQkEMSIEIGDyPlGfji10ZHSCwsDr9eemtVP5
// SIG // zN8En/xzCGontDvRMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQAKk7vaT+moV0s3d+HT
// SIG // 4iSmbdMRlhTbqnyaRhm78hf8opDLS+y++9qX65oQNPJg
// SIG // UmAC3l2kgCBnGcLWBh5jm6wm3e4aKM3t20PaPZCDw0ax
// SIG // YzxTVhnHldgWej3MFuKLxoR+T+mVTGc7q5IAs/2JV/2H
// SIG // aK9ymWaHOcwKDPAZcAvSEIbYPICiCeCwv/jamoBjoZlB
// SIG // W6MmKwr0Liggi04u1RBwnNcOIdl0IWaa6V8KH1UT2Prc
// SIG // ySBTMw6OfjMqU2IwwEE51uw5NNELvt9o90Z7qlZ/Gb7Q
// SIG // KtnLo5d65nSHyBnJAqtbHfDD3ghduaNJq54JPhLZA9mC
// SIG // Cw367q2sGxiumAAi
