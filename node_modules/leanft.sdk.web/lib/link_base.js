...
/**
 * Common methods for Link description
 * @memberof Web
  * @ignore
 */
var LinkBaseDescriptionBehavior = {
    /**
     * The location to which the browser navigates when the image is clicked.
     * @param {string} [href] When provided, this method acts as a setter and sets the href value.
     * @returns {string | Description} If no parameter is provided, the method acts as a getter and returns the current stored href value;
     * otherwise it returns 'this' for use with the builder pattern.
     */
    href: function (href) {
        return this._propertyHandler("href", href);
    },
    /**
     * The target frame of the navigation.
     * @param {string} [target] When provided, this method acts as a setter and sets the target value.
     * @returns {string | Description} If no parameter is provided, the method acts as a getter and returns the current stored target value;
     * otherwise it returns 'this' for use with the builder pattern.
     */
    target: function (target){
        return this._propertyHandler("target", target);
    }
};

/**
 * Common methods for Link test object
 * @memberof Web
 * @ignore
 */
var LinkBaseTestObjectBehavior = {
    /**
     * @memberof Web.LinkBaseTestObjectBehavior
     * @ignore
     */
    _properties: {
        /**
         * Returns the location to which the browser navigates when the link is clicked.
         * @returns {Promise<string>} a promise this is fulfilled with the location to which the browser navigates when the link is clicked.
         * @function
         */
        href: {
         ...
         * @returns    {Promise<string>} a promise this is fulfilled with the target frame of the navigation. Possible values: Any valid HTML target attribute value, for example, <i>framename</i>, _blank, or _self.
         * @function
         */
        target: {
...
module.exports.LinkBaseDescriptionBehavior = LinkBaseDescriptionBehavior;
module.exports.LinkBaseTestObjectBehavior = LinkBaseTestObjectBehavior;
...
// SIG // MkQzmc0ynaqVcvUEq+MK5vybpSaEw0YKM3BPzGALbVqg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCC/1xxnvbtVttELrQyrmEKK
// SIG // 0XiSN0rrh1YNZlrBwKCnizANBgkqhkiG9w0BAQEFAASC
// SIG // AQCE1K6PJ6Tv50UsKyDPb/WHWtHk8TlH3ipI35bva00H
// SIG // pJPntqU2c9IIYVjE25q/3fiT2N+q6cEkSDPvl9LeH27f
// SIG // kZJx+6lKsp7lX5N97ok93SIFagrtLnNTKK+uyXAFxAPR
// SIG // zOeiEyGt22hOVsRXHsPXtFgPOV1DC1XRijqeAasBL4Lf
// SIG // 3igo3h53H9eJCuQ5qj2emcrL1Jy5s1E7tA/kdit+KDzZ
// SIG // s353ev2NzkBUdOS/iat8i9bn+xhUErYC5r0iNMWYCzPF
// SIG // tezdnYiorXcj3qQgHQoVpt8rSFzSLDJE+6jZrT4be5U+
// SIG // 4d0D0VF4sRH4pcCAUSkSktitK1++U0RKewo1oYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgQio/uYgFh6quT7Ro
// SIG // GQeoHHLR1Hemb4R7WLvEOHrSrHUCFQCmYTpoFNuhMVFB
// SIG // WvAiADKzE2HyIxgPMjAxODAyMTMxNjUwMzdaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjUwMzdaMC8G
// SIG // CSqGSIb3DQEJBDEiBCAaF2+9qngk2YQ5LZylRrVdR6yj
// SIG // 4r+OH+a03XsS7ir5lzA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEASYOiM63LT8DTICFU
// SIG // NuHBdZoPhwBqDXkdQtXHzupGAww6GUjt9aD0UP9XQ08O
// SIG // XaOyWG+oxQhcL659yos2l2LpO0EZsH7m6ghfUjwTLciN
// SIG // UEWNTWc9dv60tFZZPPB3gNB1VhvWJB2AytcRezWzK/30
// SIG // 3fwortsRexE2zvRwF7bG13tAxw21o31DO64xI09j5rNh
// SIG // VqozhTS1xXkQOTQW62yV6OiXcZc7e8bcOkibU4GEyfIA
// SIG // xOXDiLY/UrU4YmHLLGXmZ37CVdTI2bfL/AWYkuJ0Oa/J
// SIG // DmGNpEb4zssM9xPAhIVoMuUftjDZIGLLQ64L+ack9LbC
// SIG // 4pb14FH25plaui3xww==
