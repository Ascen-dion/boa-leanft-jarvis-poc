...
var EmulatedDevice = {
    ...
    /**
     * Predefined Samsung Galaxy S5 device.
     */
    GalaxyS5: {
        ...
        height: 640,
        scaleFactor: 3,
        userAgent: "Mozilla/5.0 (Linux; Android 5.0; SAMSUNG SM-G900F/G900FXXU1POK5 Build/LRX21T) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/34.0.1847.76 Mobile Safari/537.36",
        isTouchable: true,
        isMobile: true
    },

    /**
     * Predefined Google Nexus 5X device.
     */
    Nexus5X: {
        ...
        height: 731,
        scaleFactor: 2.627,
        userAgent: "Mozilla/5.0 (Linux; Android 6.0; Nexus 5X Build/MDB08I) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.43 Mobile Safari/537.36",
        isTouchable: true,
        isMobile: true
    },

    /**
     * Predefined Google Nexus 6P device.
     */
    Nexus6P: {
    ...
    /**
     * Predefined Apple iPhone 5 device.
     */
    IPhone5: {
        name: "Apple iPhone 5",
        width: 320,
    ...
    /**
     * Predefined Apple iPhone 6 device.
     */
    IPhone6: {
        name: "Apple iPhone 6",
        width: 375,
    ...
    /**
     * Predefined Apple iPhone 6 Plus device.
     */
    IPhone6Plus: {
...
var _deviceMap = {
    "galaxy s5" : EmulatedDevice.GalaxyS5,
    "nexus 5x" : EmulatedDevice.Nexus5X,
    "nexus 6p" : EmulatedDevice.Nexus6P,
    "iphone 5" : EmulatedDevice.IPhone5,
    "iphone 6" : EmulatedDevice.IPhone6,
    "iphone 6 plus" : EmulatedDevice.IPhone6Plus,
    "ipad" : EmulatedDevice.IPad,
};

/*jshint eqnull:true */
var EmulatedDeviceConverter = {

    convert: function(emulatedDevice){
        var emulatedDeviceObj = _deviceMap[emulatedDevice.toLowerCase()];
        if (emulatedDeviceObj == null) {
            throw new Error("Predefined emulated device '" + emulatedDevice + "' not found.");
        }
        return emulatedDeviceObj;
    },
};

module.exports.EmulatedDevice = EmulatedDevice;
module.exports.EmulatedDeviceConverter = EmulatedDeviceConverter;
...
// SIG // 54swBdVkrCwTVtCLBXiki1RJifJhU5DCoJGxrpOOrgGg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCCUuwxhQAD/FeGz/FI39lyh
// SIG // gNczDKc1fbQmRxNDIqNwSzANBgkqhkiG9w0BAQEFAASC
// SIG // AQDHPJxJJSWdY2ac7tApeHpTbbS6F4r/41MUvO71jdEa
// SIG // QHjnC3mByrVFLoKi/J4vVKKpOkNrOeF624sBgfs1c/wL
// SIG // 8i+eWHs0XehPWNzOXUkf++md0+sV4ENt2X9yJcS8wx4H
// SIG // bLCliwWn/97sfiM/mm2Viz8iiXZnYNNmbr+ZDegxLYJ2
// SIG // S+fvrq/9Kj6i+VLjdQSRfYdsgvhzzI5hWvKECBnZYgkg
// SIG // OCd2Jr7ccBwTf+koYSmL4Xet4/izd3N8c2EfOzN8siMS
// SIG // yYhGi6EsNM+tt4hMX8M0VD2PACDVnYzpQs5XHvtMxC8b
// SIG // T/q8ZEm2wjzlqot1nhyusaNBE9hvDe8vnff6oYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgGtLrTUxBwAcj+2hI
// SIG // NqohB8RKn6vMWn2jQDZRGxU1PS8CFH9fAXdksKlfWkMv
// SIG // F3+HW1Nj6VZiGA8yMDE4MDIxMzE2NTAzN1owAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NTAzN1owLwYJ
// SIG // KoZIhvcNAQkEMSIEICi92Yozb5aOzQO90cuwh7lY9DxW
// SIG // XpOXAe5sCIIGJKbeMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQB7JfCb7BQh9A8SfNZT
// SIG // B12d7u6SBOql5RWBibCZpoa/vTD26gK2abxARvwHpnbK
// SIG // orrEgEwlRLqIPxhhu9oJyYGp0WWGfwHAEO8ou8dmzJIu
// SIG // szQVnOX5XLCAOrCdUaY3QxDdoL9NkP1rimy2AtHNcZp2
// SIG // 76n1N2YFbrZutRKb4LFefY4d4Sp90qSj0ou4xGHQQ12a
// SIG // S9DRV5jpQcqJMmlxk7QM/RHTsgEG2Ai/uahKo+isVBB2
// SIG // oOK/g8hnSh1/y/pQv+eOlg+uE9YjQ97e0lcbcoK3SVw6
// SIG // AriRf3RkpM7p5tRsgYGdVhrYhILCozSxJu49pVkNX2Fg
// SIG // PKVk9kKt6+qzAh89
