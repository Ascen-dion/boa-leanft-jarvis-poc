 ...
 * The Web factory which creates test objects by LeanFT types.
 */
...
var PageTO = require("./page.js").PageTO;
var WebElement = require("./webelement.js").WebElementTO;
...
var AreaTO = require("./area.js").AreaTO;
var ImageTO = require("./image.js").ImageTO;
var FrameTO = require("./frame.js").FrameTO;
var AudioControlTO = require("./audio_control.js").AudioControlTO;
var VideoControlTO = require("./video_control.js").VideoControlTO;
var FileFieldTO = require("./file_field.js").FileFieldTO;
...
var NumericFieldTO = require("./numeric_field.js").NumericFieldTO;
var SliderTO = require("./slider.js").SliderTO;
var Browser = require("./browser.js").Browser;

function WebFactory(session){
    this._logger = new Logger("Web.TestObjectFactory");
    this._session = session;
    this._technology = "Web";

    ObjectUtils.extend(this, ConcreteFactoryBehavior);
}

WebFactory.prototype = {
    _logger: null,
    _session: null,
    _technology: null,
    ...
    _constructors: {
        ...
        "area": AreaTO,
        "frame": FrameTO,
        "audiocontrol": AudioControlTO,
        "filefield": FileFieldTO,
        "videocontrol": VideoControlTO,
        "table": TableTO,
        "menu": MenuTO,
	    "tabstrip": TabStripTO,
	    "treeview": TreeTO,
	    "numericfield": NumericFieldTO,
        "slider": SliderTO,
        "browser": Browser
    },
    ...
    _nativeClassToLeanFtType: {
        ...
        "webarea": "area",
        "frame": "frame",
        "webaudio": "audiocontrol",
        "webvideo": "videocontrol",
        "webfile": "filefield",
        "webtable": "table",
        "webmenu": "menu",
        "webtabstrip": "tabstrip",
        "webtree": "treeview",
	    "webnumber": "numericfield",
        "webrange": "slider",
        "browser": "browser"
    }
};
...
// SIG // NKSUVXtgM/ORh9pIPZmdi2AOvOyguKEBemBgWvPSaXOg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCCKQuv4C9KMckaLJtqa40yT
// SIG // 0v6N8M/2udptsGTx+tHwtzANBgkqhkiG9w0BAQEFAASC
// SIG // AQBQrv9sZXH6Q8Mtoc5BV0iCwf72ivDJGF0LVZq3qAmp
// SIG // mautzed+d9xpXh2LAys9j3ifYgPd/EeCu5q8FZccie7A
// SIG // eDDsb1fi+PInQxYDAJtxa+3oFaKVo353xtwSuyOMqpwU
// SIG // QDIvOW0QwB6HF+aHwk8ZfJS9UGdxnYHwAXnk44lWwM8O
// SIG // /qJ3F/a4W3Uz7OY2FekNTPjzutqpwTvQeITIsbXXi1TC
// SIG // YJuJG4/j9hF2q6EEm/6rKTgRCbzcZWcfvwT0lquq9XA7
// SIG // jkUIDxQrKd7IY2/i2zobaMDvi28tJIglXKMzwE8IO33z
// SIG // gePKuhT53h3Rg8xMBIqV+RiUR8xK+L/N+InCoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgVqFjPO3KjYm0vxA4
// SIG // t2y/Ebu/VocESyruVEwnyPkzWf8CFAgW5s52lHQANl3R
// SIG // dmXf4i393s0lGA8yMDE4MDIxMzE2NTA1MlowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NTA1MlowLwYJ
// SIG // KoZIhvcNAQkEMSIEIBYEXQbAjsgfdC/+uHvL6yYjMcU9
// SIG // pNu4XjbiFSxOrRiNMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBsoHQdq/HaCwnFAEny
// SIG // TeLkCOqLzRHYMWMoqruesP/OMqkytERTCva/HwH+9QWy
// SIG // HuKUKrVQvX+jsd4/GAJwxjr4PUk3oWGSDIBI+3FHaPys
// SIG // 10eOExy3qFZAalpP1GFTAzMiqnkIo1kGlp2fNgCfPlNB
// SIG // xBV0pQvG+Zh9Hl6/jw/nqNMCF1zTkoEYvgSahPaaEbTm
// SIG // RlZPy0OycQ0ZN/+xpdYbTt0QbOc+VV14qawbj6rttJjj
// SIG // zKhEnuylm465LZByEzm0rU4EJiBUDHUYrDijQ3o9RXi4
// SIG // Z/Lcvke8rxttPgoF69ibJKjH4E+EoJZcFEqiPnM2WpDj
// SIG // 8XGnj24NJ+G52cuS
