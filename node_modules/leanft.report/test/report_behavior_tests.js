...
var defaultReporterBehaviorUnderTest = require("../lib/default_reporter_behavior.js");
var emptyReporterBehaviorUnderTest = require("../lib/empty_reporter_behavior.js");

describe("Report behaviors", function(){

    it("should have the same number of functions", function(){
        assert.equal(Object.keys(emptyReporterBehaviorUnderTest).length, Object.keys(defaultReporterBehaviorUnderTest).length);
    });

    it("should implement the same functions", function(){
        defaultReporterBehaviorKeys = Object.keys(defaultReporterBehaviorUnderTest).sort();
        emptyReporterBehaviorKeys = Object.keys(emptyReporterBehaviorUnderTest).sort();

        for(var i = 0; i < defaultReporterBehaviorKeys.length; i++){
            assert.equal(emptyReporterBehaviorKeys[i], defaultReporterBehaviorKeys[i]);
        }
    });
...
// SIG // Xy6R9mli08G5qpM4TreldJusi6gb3RbW4ECViUL2Dm+g
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCCDheUS/uQbDNPt1j92y/oJ
// SIG // 6dJ6HY9/t5Rb5/AC2xM4nDANBgkqhkiG9w0BAQEFAASC
// SIG // AQBIVOW0w6kIEHpxKjwcCwZkJ+hOzwTu3DKVvjLUd4DP
// SIG // K8uL2SElbotT+bLMLMDAzUgOc04aiM6u3kKtupZOzL9M
// SIG // 6RNXb1loJaTaPJqJUq7JwbjADHQd+blu5k9Oim/l7apY
// SIG // qb8Swi3ac/3V/GMMRBZoe8+JQRMD/Qar+NrXv8JsNvBn
// SIG // w624xVpmzhw73l9fvthQOEzAlea5l7AqYfonh0E/tHlJ
// SIG // Fr8+IptCuxxk5qQwsWv+/36aEVB1fMK2iL0xls0t84Yy
// SIG // WjIxoK/vmMqq6riVXTJOL8imQKjY4ZmbWo3w/HyCNvTt
// SIG // aAjXC8fogH7eKcUstTOrAc8J5ctwrbZns3TzoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgjpgib0sKyMdUQokZ
// SIG // /qrymIsNAo6i1tBYFSv8UHuYpH8CFQDkhRQ/rGhwrOTt
// SIG // VNQnALHbimr/AhgPMjAxODAyMTMxNjQzNDdaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjQzNDdaMC8G
// SIG // CSqGSIb3DQEJBDEiBCCV9oC1yBEfW2WRoVl1wWDDUEdd
// SIG // r3vgYb4qR/K53PfAKjA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAgp7pKRCScQFAX4Oo
// SIG // OLJgJk+jLgf4TighDIhEnoWJ7mGFgO++O07iPUPQP5zt
// SIG // SvhQMn7WZ01gwulryujBHJnEuaLBvddN/vTXo0fp84wz
// SIG // NNZcBEJeEbfMLBA71lEH96W07TX8sR0NH2Brql6IAfBk
// SIG // EErWtGQ/p7nACO0ChOY9wFvBRPnNoigbZrmaLz5yuAGd
// SIG // juaFwXCA8p5Mn8YuVeZ7OBMz907vyh+FdywmqQ9RCd7r
// SIG // PPnO5W3OJuRVlcEnVJd41BCDdjzExYym2ETtL/sPp17L
// SIG // jNiTUxeDIu/8WKWvidG3xBLKdY2dE32bHSNv9wioS2UU
// SIG // VrWpxqSkLV2qxsSVKQ==
