...
function RunUnitVerificationNode(node){
    this.init(node);
    this._nodeType = Enums.RunUnitNodeType.Verify;
    this._isNestingAllowed = true;
    this._operation = node.operation || null;
    this._parameters = node.parameters || null;
    this._verifyDesc = node.verifyDesc || null;
}

Utils.inherit(RunUnitVerificationNode, RunUnitNodeBase, {
    _operation: null,
    _parameters: null,
    _verifyDesc: null
});

module.exports.RunUnitVerificationNode = RunUnitVerificationNode;
...
// SIG // 9liY1oPGHKSWDPR+rA0W4hOqkjkSKTpqpGxrW1Ui5OCg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDETMZjCOxdNiwy3iN5fSQT
// SIG // V1GV4BswhKQ5MtdJrvam9DANBgkqhkiG9w0BAQEFAASC
// SIG // AQCK3W+kCoADZrKsvTT+Kg9kUcaWakoxx/fTGh4vKjqq
// SIG // lt6ygAlB+a/pW33V45vHZ0m582Exbmqq39pFjaBbFzrZ
// SIG // FM4shoisxK6y42yXkei1U2NXiz9QgMNAPRewj/UrJz+p
// SIG // 8ZuMa/nx0pj4gvHKOSR62nLZmks4rEOjUrDiNL6GxCnp
// SIG // zvGkI8eIvU7Grdfpa/NMsXZaWmgRtBBcptpJRXZsmg+Y
// SIG // qYuY1zywVGCErcMJRJR+gcxrNVIYGnYSCszQswx1qZBG
// SIG // dC9mciUcowf6LY1WJXTaTIowfurdMLWtAFvhYUacDoIH
// SIG // b4iR29NDfCPZQGxHUYC8SMz0ZvfWdtplYUy8oYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgzeJZtsjUOkgBQTDu
// SIG // KH3y+Gq7Zd9t7VJwTdd+ZYG25ecCFG9arQ7NJe9uhoX6
// SIG // 12oXFwmYcHvJGA8yMDE4MDIxMzE2NDM0NlowAwIBHqCB
...
// SIG // KoZIhvcNAQkEMSIEIAi+LUP0UbUqpeCugAXcsaOytlaR
// SIG // y2uyNKoajoC3EG0uMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBRj0nP3xjnCOGcdPD7
// SIG // Ok5pCKbSlJe4+loQIOsAciJ7J5LGY97zCzlEVRJ7M2Gw
// SIG // SuQCGCLTFr8T/X4JBvCbU0qJmX/aW59hncpSx+qVSw0R
// SIG // TkcubDU4tAgmz7W5MEjO5yNHDflJ0QfJwVp1bPaYfhki
// SIG // c81HbRwHQ+pnuEiG1gaE66k7+Lqugw6NAJvLB2qPjbCl
// SIG // bIYSLomoj8ugMLa/Uj7yG3qK3rnhrBQWWEZhsJ61aKcp
// SIG // UTq+IHzsw96gbQzKLkr5pBDBENXgHiQTKl5/aouS7F59
// SIG // 6RdAzkYXHnyWjreDFhqaNHYxVmVFhUK/61MvXedV+G8j
// SIG // DcPm5rSeGhHW+h9F
