...
ReporterProvider.prototype = {
     ...
     * @returns {Reporter.Status} the runtime status of the LeanFT report.
     * @memberof Reporter#
     */
    getStatus: function () {
    ...
    _initializeSettings: function (configuration) {
        ...
        if(envTargetDir) {
            config.targetDirectory = envTargetDir;
        }
    ...
    _reportEvent: function (stepName, description, status, image, error, base64image) {
    ...
    _reportVerification: function (status, data) {
        return this._session._promiseManager.syncedBranchThen(function () {
            ...
            var newStep = new RunUnitVerificationNode(
                {
                    name: data._name,
                    description: '<p>' + data._description + '</p><br>' + this.buildArgumentsTable(args),
                    status: status,
    ...
    _specialValueHandler: {
        TestObject: function (data, cb) {
            ...
            node._description = this.buildArgumentsTable(node._parameters, cb) || "";
        ...
        BrowserFactory: function (data) {
            ...
            browserNode._description = this.buildArgumentsTable(browserNode._parameters) || "";

            // hints to XmlReport that need to replace title with new title
            var titleToPresent = "Browser.<span class='emphasis'>" + methodName + "(\"" + browserType + "\")</span>";
        ...
        MobileLab: function (data) {
            ...
            mobileNode._description = this.buildArgumentsTable(mobileNode._parameters) || "";
        ...
        GuiSessionFactory: function (data) {
            ...
            mobileNode._parameters = this._buildParametersWithNames(data);
            mobileNode._description = this.buildArgumentsTable(node._parameters) || "";
        ...
        APITestRunner: function (data) {
            ...
            apiNode._description = this.buildArgumentsTable(apiNode._parameters) || "";
        ...
        BitmapCheckpoint: function (data) {
            ...
            node._description = this.buildArgumentsTable(node._parameters, function () { return true; }) || "";
        ...
        getUtilityNode: function (utilityName, data) {
            ...
            node._parameters = this._buildParametersWithNames(data);
            node._description = this.buildArgumentsTable(node._parameters) || "";
    ...
    _specialValueResultHandler: {
        BitmapCheckpoint: function (node, result) {
            ...
            if (result.imagesMatch !== undefined) {
                ...
                node._status = Status.Failed;
                node._description = node._description + Const.HtmlTableCssStyle + "<p><div class=data-label>Result</div><font color='red'>Could not locate image</font></p>";
    ...
    _handleResultOfMobileOperation: function (node, result, operationTitle, resourceFolder, fileConstPart, linkName) {
        ...
        node._description = "<a href=\"" + Path.join(relativePath, fileName)  + "\" target=\"_blank\">" + linkName + "</a>";
    }
};
...
// SIG // /U8Sz4S7hvP7oh4BW1/plH/K2xs4Mh6PBa+3zNHCRxmg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBIxMcDNj8UV02i3t4wVg6A
// SIG // 3fQK1m7l/WpmPSAUhYxPFzANBgkqhkiG9w0BAQEFAASC
// SIG // AQAhv41WAtaeh4iuTsPuEMqtiprHsZMxcVWYelfh1W0q
// SIG // HhiUvwzPZqHqgcHUlmbcj73nFFF10UTx3qXFMvM8Szxw
// SIG // MnzWHRrdzF2BAYCwn0fDy9QqQMGJ9lEizYAYT6y0J0bB
// SIG // jl7wPj0lfHAS03j5XHs0WfGI5v3OzlH4lfCT8CvPiNS5
// SIG // +RIn0ZvciCmLZQuvUHjb7jhfnR6VfivSJFK/Uq7i/Lo0
// SIG // wXVECA4zey21S3eMJqvR0/eVfZek0Y1mqq4OUGf1rmg9
// SIG // DxWMlgnPCJlNSbybmYHP5NMt3PlMpWVb1VImy8P4841/
// SIG // wCGWMGQ/E0vk3wCK9PxKYdwWAxebbMkLghn+oYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgzTlmw3C8myxtmW4D
// SIG // Az99M06s0pai2AEzI6pt/bi6nagCFATIQKdsZXyLjzZx
// SIG // nNWBugHGuOVfGA8yMDE4MDIxMzE2NDM0NlowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDM0NlowLwYJ
// SIG // KoZIhvcNAQkEMSIEIFAlPTeK8sYMPHj6Hi/+kZxIImMC
// SIG // 9MzW+2pZCskZsla/MDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQBXtvFWtv96X/VcxcSB
// SIG // Jysp71XvI6Uqy8Mp5ZelfgiK1Wi/2bmfPR1rXmug5U4r
// SIG // N98RAywZIGqhiKdKiD47FjAx9rekAGY5vXBW4XXc39zO
// SIG // Z7eGBOGsxNRG+vNivTfOCT6RcIh5ww7o0fANUUNq7ylS
// SIG // QzfD5+zq5jhGmlIInfYVjzJglQmq9GPDX+KFNxo8oBNJ
// SIG // xoYmQ71y12h2TxvfqWNpsEJKohMY1rgYnLzVSuYJtuaA
// SIG // kpvvc0taYe7JqsGAzDSjk0x5+emVrIQQDPE75KOuazbU
// SIG // 5EzYqYMmz3c3YovI/tnONYK9w5e5bCRhJnv329f04X/f
// SIG // NI6fTTE5dwq4ncHH
