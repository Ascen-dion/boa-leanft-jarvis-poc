...
function RunUnitOperationNode(node){
    this.init(node);
    this._nodeType = Enums.RunUnitNodeType.Step;
    this._isNestingAllowed = true;
    this._objectType = node.objectType;
    this._operation = node.operation;
    this._properties = node.properties || null;
    this._technology = node.technology;
    this._objectPath = node.objectPath || null;
    this._testObject = node.testObject || null;
    this._parameters = node.parameters || null;
    this._result = node.result || null;
    this._externalReportLink = node.externalReportLink || null;
    this._wiredName = node.wiredName || null;
}

Utils.inherit(RunUnitOperationNode, RunUnitNodeBase, {
    _objectType: null,
    _operation: null,
    _technology: null,
    _nativeType: null,
    ...
    _parameters: null,
    _result: null,
    _externalReportLink: null,
    _wiredName: null
});

module.exports.RunUnitOperationNode = RunUnitOperationNode;
...
// SIG // cV5tw6EOYCb3p92pKGwnnG/GEqgUhEd7zJ9SHPdb6FSg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBWKl3Wu9Av2n+Fr8hrKunj
// SIG // Jr4rbQzSKyzVMHYvI5+DxzANBgkqhkiG9w0BAQEFAASC
// SIG // AQAmpoB3aL5f6IACyHnEPIIA/DdioDovaFMOIND/cXaf
// SIG // EPFSrrMM6JL/BsPD8SNdViX/bqjoGPN2M58GzpHtLwXw
// SIG // O/SnYXcdXAd2ZdVP+yQTEGyBzXR7WmE6ThVVrZRlWDab
// SIG // heyNRWGZnr/IlZGeGeznxPUneNrCXELjN3HkXtPD74Rm
// SIG // 9ex50DVQwExmbuFX3RYwKfHzrFB0+ACRx/NscRLHRXBN
// SIG // ryDuyIPOZDIfu+3Fexs8Vf/QH9RoqliFcO5Dkh2yLy1V
// SIG // QC6wVvhxFSOUgBF0pi1wWESigJTsQbwAcxe7aFjuepr6
// SIG // GgcB/F6aKUZRLbvn3zRpJOVAXLkKWQpzDT0doYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgxaJaSmIBUi+qfW13
// SIG // O8BAdUePDFg643HwDObnthUmvy4CFQCzZT1lKOIOc43V
// SIG // i9qpNfM+S1RKVxgPMjAxODAyMTMxNjQzNDdaMAMCAR6g
...
// SIG // CSqGSIb3DQEJBDEiBCCezXAvIAIExWYNCG56vjNHCYw1
// SIG // zyg1zB5Kc6+8RvBBLTA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAe4+Q/4ezduPKoZrV
// SIG // w6Ug4vpwynFYQa0Du1UBaw9IpcWDy/fpHEz+mPCTUfK6
// SIG // I1g5cKQPAwpkKc1FMOYWjAIg+ZluWqiU5pN2OyAz4v9p
// SIG // Cc1UOAYwrwmKxjopb773aBgWVO3MPQlV0lQU75pXEUzG
// SIG // jrv0Nid2UPFHKcKwwvkA5M+GiXyz64tNN46OCpqFj926
// SIG // Gl+rySow+a4R4RtSSKMIMVsF6Zn3sC0q+cUY2SbdYF0s
// SIG // KBErMmtUr369yYK/9TZlWjl0ohV8TghYQoA1fxDlSr6T
// SIG // gqb7LNsGQc5nsG5M9ENCwLMnFztqVkJRoeRr3GP0OExn
// SIG // 0CluheItMEXIiQUzvA==
