...
var lwePathProvider = {
    "win32": function() {
        ...
        var leanFtHomeBin = path.join(progFiles, "HPE", "LeanFT", "lwe", "lightweight-engine");
        var uftHomeBin = path.join(progFiles, "HPE", "Unified Functional Testing", "lwe", "lightweight-engine");

        return Q.nfcall(fs.access, leanFtHomeBin).then(function() {
            return leanFtHomeBin;
        }).catch(function() {
            //fallback to leanft installed with uft
            return uftHomeBin;
        });
    },
    "linux": function() {
        return Q.when("/opt/leanft/lwe/lightweight-engine/");
    },
    "darwin": function() {
        var userLeanFtHome = path.join(process.env.HOME, "Applications", "LeanFT", "lwe", "lightweight-engine");
        return Q.nfcall(fs.access, userLeanFtHome).then(function() {
            return userLeanFtHome;
        }).catch(function() {
            return "/Applications/LeanFT/lwe/lightweight-engine/";
        });
    }
};
...
// SIG // vzDZY6ISkE+VTIq9fJp+eGxrZcjKtGsSlEPo1eyNRn6g
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBpCkAURzeOcXR+wt1/vEnJ
// SIG // YwXWBjrZij4xGuR9JxRA1jANBgkqhkiG9w0BAQEFAASC
// SIG // AQBDFImKiGFzhsjRVsa6zyt65quUAvRZLGH1f4hKrRnf
// SIG // nb+ZyKaz0DTjl43rXhyoPQPgbvpmzVtBE/2Jr/UuhFIp
// SIG // Hd63aTuxbxMkHpgn59qOB8RLMig9525NtUUI2kyP9MdN
// SIG // Fsr2E5bTxfEJvVIS5p+zAtam+SVRDVql0JuXAwuaUq+j
// SIG // NzZ9mMjhGNMZc9FCgjkwlw2HMTNAqhiotw/OFOvfqP9C
// SIG // MXb+obRvSq4QN5bBnt/NNcHVQdxDrRtlmnx4q9iRMrKK
// SIG // SB/teRGwKr3FJNoFsftqvXbhmkld+KsfY2nf2RxoyGMR
// SIG // Uq1fbm7JofvJ/mgB6wFua8KMz89GigCXSjwXoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgu0jwl/hIi/9GtO0v
// SIG // pfey8FnVTwqXsXyfWpbmIjA5TcICFQD5GyEiGpXs/McW
// SIG // psivN+zWis1BOxgPMjAxODAyMTMxNjUzMDRaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjUzMDRaMC8G
// SIG // CSqGSIb3DQEJBDEiBCAGxxJeDKYxdy/DfKxOl99Re/pw
// SIG // MpG18NREuJLSY5YyiDA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAmcCO8IMWqiNsLENN
// SIG // 0pTezlvOJxWuK22s6JYx8D14h0TXw9QK4n6W3Ve06bCN
// SIG // ztDrH0e49zRXonHb4g8gI4SjThAU8YOTIHhW7dagwTsw
// SIG // 8HoRRmyt/XGvmmyLMjafbPwou2hlcmIOYB23JuEjRoXM
// SIG // zRbkSA28l+fmAm0cOIuhulb9dGvgi9TDKmMFmYl9KdV5
// SIG // CvU3vZbi41C/dV/7NUN1FOLiYZhgO2gt3SRwYkpe0Lz/
// SIG // ll407I/Yf8J8JGY3KybLqV2zDshWQaKpkBSsSCLzbH5c
// SIG // 90aa1ID0ya1UlcJD69uSeQAXrRIK5KKAIV/Wg8Ku6bNO
// SIG // lP5/AqOLTiHoSvYUSw==
