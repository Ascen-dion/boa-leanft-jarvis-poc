...
ConfigurationBuilder.prototype = {
    ...
    build: function(config, libraryMode){
       ...
       if(config) { //configuration was set in code it should be top priority
        ...
        var settingsObj = {
            address: nconf.get('address') || nconf.get('LFT_ADDRESS'),
            autoLaunch: nconf.get('autoLaunch'),
            mode: nconf.get('mode'),
            executionSynchronization : nconf.get("executionSynchronization"),
            ENVIRONMENT_ID: nconf.get("ENVIRONMENT_ID"),
            ENVIRONMENT_ADDRESS: nconf.get("ENVIRONMENT_ADDRESS"),
            ENVIRONMENT_DEVICE_BROWSER_TYPE: nconf.get("ENVIRONMENT_DEVICE_BROWSER_TYPE"),
            ENVIRONMENT_REPORT_CONTEXT: nconf.get("ENVIRONMENT_REPORT_CONTEXT"),
            lwePath: nconf.get("lwePath")
        };

        this._parseValuesOFSettings(settingsObj);
        ConfigurationBuilder.prototype._config = settingsObj;

        return ConfigurationBuilder.prototype._config;
    },

    _buildInLibraryMode: function (config) {
        var defaultsClone = ObjectUtils.clone(ConfigurationBuilder.prototype._defaultConfig);
        ConfigurationBuilder.prototype._config = ObjectUtils.extend(defaultsClone, config);
...
// SIG // tgDv1mU1bvX1/ZYneKsjRkBAeI6vop0SwX7YzY+8n/yg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDTNHeN5cFMbTobmooOMcaE
// SIG // rkM/2Lmb1LbATdN5l47iYDANBgkqhkiG9w0BAQEFAASC
// SIG // AQA2gN/AGYmDsMZglARf01ZNcXkGUsMDuhF7gMAIN77F
// SIG // VCrkiOAnB3bvHekUTtliE0GsrArlq3fkoDvSMNwEpleG
// SIG // Aeos7W5isnhg6kU9hIgLyQWWt57iRz6Nu378jdyZ8oiW
// SIG // FzdGfC1/SuqD7if8w9dFVppj9hKXE+0k/HlTwga0Bs0i
// SIG // GQ4EMEnsThrPa790jiSmIggq4i7+qYatZEnVNDtynwzs
// SIG // KAnhYfwvtrEdBJsISAX56pPJUtO4q0Y4B5pxRghps7bE
// SIG // GMGrptQrBvZ7vBYO+DVv6oEHFhFkt539vSCIXzaxUPZC
// SIG // FmXY/Lodky688OHgVNFV9TZ/dSUwXrUr3wFuoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgFLh1jCu6bNM1/i6t
// SIG // j/SZyMVK0Mc6W6c19Xxgcv6K5BcCFDi+S6hVK3a3sIYH
// SIG // hjdB+u5h+v4RGA8yMDE4MDIxMzE2NTMwNFowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NTMwNFowLwYJ
// SIG // KoZIhvcNAQkEMSIEINdA6y/xqIQLIQj+bRr1YPnVd6g8
// SIG // IMSDUVONwHw8ttmPMDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQA9w/CUgahHPOOogu7U
// SIG // qGIbKDIeQqarW6JbIrqZ2DScehAaJrbz7EuTLsRChK3Z
// SIG // yow5wF6G06AjcRRxNj4JCcRC3waPCCM1lbzALtBRVckk
// SIG // eayT1K1brrSXcyrL3xmT4kjfKNIwHhWso1uKLQYtbCQV
// SIG // XEbtdpsWmV7TcnsiOsSuzsFwISU5MX3m71O7w1HnzSma
// SIG // RWDNAhlqYlMRkBGVfhpNya42G8rSIG1eBwQU8PP5L9MS
// SIG // UkGCVB26qqTuQg2GJIZ8zP5AfLXH01riunnL66mSfx9Q
// SIG // Iv4+NefVSPUCXlTLrMtrTnuYDCkqd7iHVQWTN8ly2PDM
// SIG // awRN6bva349VrpWd
