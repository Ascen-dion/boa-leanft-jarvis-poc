...
describe("Password Description unit tests", function() {
    var PasswordDesc = require("../lib/password.js").Password;
    var passwordDescUnderTest;

    beforeEach(function() {
        passwordDescUnderTest = new PasswordDesc();
    });
    ...
    it("should have all keys of Web.Edit", function() {
        ...
        for(var webKey in webEditDesc) {
            assert(webKey in passwordDescUnderTest, "key: " + webKey + " is missing in Password");
        }
    });
});


describe("Password Test Object Behavior",function() {
    var PasswordTO = require("../lib/password.js").PasswordTO;
    var passwordTOBehaviorUnderTest;

    beforeEach(function () {
        passwordTOBehaviorUnderTest = PasswordTO({});
    });
    ...
    it("should have all keys of Web.Edit", function () {
        ...
        for (var webKey in webEditTO) {
            assert(webKey in passwordTOBehaviorUnderTest, "key: " + webKey + " is missing in Password");
        }
    });
});
...
// SIG // LPD8iyTXodqGBP7X7ZPGF4EQqTI8aoumvtUcRJMdn8yg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDXBfehxAX6oq7t7KBdpn1G
// SIG // w+u4UyJ5ZaX55awE6zLZJzANBgkqhkiG9w0BAQEFAASC
// SIG // AQAhWLmf4zlGHddT13vEhSDm/2mSahAJD/GPCcWAPA53
// SIG // At8esYgLhtlrdLUK7BkeA/fbmEiERk8qrB45Wc4i9al6
// SIG // LnksIufwcTGg+Azk++CKeEB3gCRlGmJyaRPith+xIxuG
// SIG // D6Fq7jFfHNhbVsRh0Eqk7fge2hAqGTCGiU2BqV78P00i
// SIG // gi0NyEqde1qIrfmZ36Qq908DFg+nTW+n21Sb2H7T4F9d
// SIG // FKh0MaCU5o+dBsnzdH9/SPhldsJcU0llqNdsnmYcDpke
// SIG // zlJy2djqt4uO3/e+0Wt2THjTqLSS/BrF8h0+EQDLIU7a
// SIG // oVD1Cqov3x+Rj+h4A6tHz8Zg1BbGzYelignjoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgCVqlyEUPGhtma1Vg
// SIG // Se20BIXLzR+iWfFLj4uc4+ID7tcCFQCOVtonVZdlsMjO
// SIG // oZ7oXDeQjS5RQxgPMjAxODAyMTMxNjQ5MTBaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjQ5MTBaMC8G
// SIG // CSqGSIb3DQEJBDEiBCCl9oAP/Npk/85uDNWGXlAIk/nO
// SIG // aNeXFxfIZ+HAlRX3XjA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAL9RZLI3x+W0Prqil
// SIG // n60oG8ZPuHKHjfx+qE5v+2Q6zsvNRmegrdVLUzH3Y4dE
// SIG // oBI3MR+3wBQ1OuK/0TQHwqrLXMcDmKq4gNxdygZIQNuI
// SIG // Ycf8ZQb+lSTtMH1enHOd7vwB8bCWSCKclOmKLeRHScE6
// SIG // jocfWssrfT1AaEAz4m4+8ZSlbDeQcV+CLuTYrtX2H5/+
// SIG // XjIvZ/7evBJDjUVzlgSjL1zphUFKrHYnn1QQPbYTJrW2
// SIG // INADP9jqaCMmNcOUZ3yCEjRVg0b58P+Gl7hWxtW4L26s
// SIG // gHbuRmN2YZocB6FZqv1sLTTWZeCkaZKAXxvU3lVHhyt2
// SIG // S6COJpbV+wN89ZYAwQ==
