 ...
 * @param {Object} [props] Initializes a Header test object using the supplied property bag.
 * @returns {Header} the description object that was initialized.
 * @constructor
 * @memberof SAPUI5
 * @extends SAPUI5.SAPUI5BaseDesc
 * @mixes SAPUI5.TextDescriptionBehavior
 */
function Header(props) {
    var headerDes = new SAPUI5BaseDesc("Header");

    ObjectUtils.extend(headerDes, HelperBehaviors.TextDescriptionBehavior);

    headerDes._defineByPropertyBag(props);
 ...
 * @mixes SAPUI5.TextTOBehavior._properties
 */
function HeaderTO(session, description) {
    description = description || Header();
    var headerTO = new SAPUI5BaseTestObject("SAPUIHeader", session, description);

    headerTO._mergeBehavior(HelperBehaviors.TextTOBehavior);

    return headerTO;
}

module.exports.Header = Header;
module.exports.HeaderTO = HeaderTO;
...
// SIG // M7ZQA8TdnAwMRSztU6amjBjvM8iQ2N6sTvwEj2cmqLag
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCCYnznDEgrRwO+bn8jaMREe
// SIG // RGCwbp2B9dZyJh+c3mFuzDANBgkqhkiG9w0BAQEFAASC
// SIG // AQB6CRqsBU9Ei0Bn40Z3uBHJ71cKo1zxzOKkLSeHRxWx
// SIG // dzWhRDdBXOhoDVtx6Nb9eMZOXUJSRa4dkPKXaFau0ACn
// SIG // NvquesRI5ZgHDmb6Diw3dyBDLr6NwgwqyTOabgzV9N1h
// SIG // VY/5/HVyeQB6D8j0x0WeIxzMIL/YKx0dTyMjyjYgex2u
// SIG // 6P7zxjmFNHoumKUzswZoqQqwBlnyrJoxbHnRMTJvQSm0
// SIG // pM5Ct9hsjeGXfMKXOf/ZRGrwvTbzJmrqc3YUif2ojqRw
// SIG // d7E+313h5HN9eWdXMn1sA4+12MK9HZHB5hfJdOuTAoWl
// SIG // htrPGc5tBZJilBWnv7D6ZL9Zyu+HbkmnXH6MoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgZkLKysYEmYXupupK
// SIG // bMTRkMOmBw0QYta7FhmJaugKvZICFQCK3lTDpZuYsaOH
// SIG // 5BHclZ4JFY0KGxgPMjAxODAyMTMxNjQ4MjZaMAMCAR6g
...
// SIG // CSqGSIb3DQEJBDEiBCCnQrX+5IHq7qhU1nS852Vk/NIg
// SIG // ieDgTM+xSsKpljbTXjA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAEvDjWC7BBXDJK9ir
// SIG // sKVfLWRIoNEMtphIWfB3wfZh+P7XnWTRP+lqXnWYZRLB
// SIG // 6CXo4AtRZ/S2jBmSvLl7LLmFeIO+LJXJtmgfpUqaB1sZ
// SIG // 2df5foce7ssLGUxrFZfJmG8BSrhXQ3kiLwajGKnr/q26
// SIG // 8oLq+7lMlhqM7NnoDNtt3NXtcIkUT3DjCOxmZ5bW3BZJ
// SIG // vAnid3WBjAAhduLJ2bORstzcwuSnjqPAwm3/RGc0fFhL
// SIG // hyOu6aIbNU8KBi5ebyMHGlRCrpw38qoCN0mwaGGxLR/M
// SIG // T3LvzJawZND60rbMAi9VzE3LTdkv5JvKrt7DIRD4BjgY
// SIG // LmqnMJdhCx+uBDHzYw==
