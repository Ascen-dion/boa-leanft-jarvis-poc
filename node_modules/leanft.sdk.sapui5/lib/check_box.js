 ...
 * @mixes SAPUI5.CheckBoxDescriptionBehavior
 */
function CheckBox(props) {
    var checkBoxDes = new SAPUI5BaseDesc("CheckBox");

    Core.ObjectUtils.extend(checkBoxDes, Web.FormFieldBehavior);
    Core.ObjectUtils.extend(checkBoxDes, HelperBehaviors.CheckedDescriptionBehavior);
    Core.ObjectUtils.extend(checkBoxDes, HelperBehaviors.EnabledDescriptionBehavior);
...
function CheckBoxTO(session, description) {
    ...
    var checkBoxTO = new SAPUI5BaseTestObject("SAPUICheckBox", session, description);

    checkBoxTO._mergeBehavior(Web.CheckBoxTOBehavior);
    checkBoxTO._mergeBehavior(HelperBehaviors.EnabledTOBehavior);
    checkBoxTO._mergeBehavior(HelperBehaviors.CheckedTOBehavior);
...
// SIG // IhpFY1tAIYk4F6F6CtNHi12CY55+m7DuxlsYLVKFQceg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCBKQlOVcIhsDq8KekNeKowE
// SIG // 9tNZmXa79mux3xRDlX8o8DANBgkqhkiG9w0BAQEFAASC
// SIG // AQCZLAyDHXIAJENOwOuFQ+en2F4BJHtFZ7sGxvNSUu1J
// SIG // MEy4BmOZwLxkIcnfhcScFJJ6lpjVVAOVYTBILsqTVPy3
// SIG // R7v7pqjkQ5esahZN71F+4qtL5rTcK51rqMDBwyUPrFZE
// SIG // n0IfsDD0bU4Wp9CZyaOelsAD3TyDnVVFf4wv+cpoV2p3
// SIG // XswWi3emAeeq/fZLdOK2V/CHz9zv4oOIjS/cqOETeq4p
// SIG // IxZdpK84w2glJcFbyBPygZotEAeHAGJWvu4FwqxoZkSh
// SIG // mJQrvBMCKX3o0RMPqozChpTE1vzOXLOPp27g5v2q7NfM
// SIG // YKTY09KMIcCI/+KqGjbODZNQJegsuBtubtECoYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQg61udoZyeaDTJAVpF
// SIG // krbu98LGD3hIGigsphO6ExBplagCFFF0uvmK1UvxhWNe
// SIG // ZwdWjfkd2Wd2GA8yMDE4MDIxMzE2NDgyNlowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDgyNlowLwYJ
// SIG // KoZIhvcNAQkEMSIEIOfBpxcWj5Zy/K+OXpMp/hEOkiGu
// SIG // JERoCz7Mb1i137v9MDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQCAPBd50rpFe4z9cS2V
// SIG // m8OoAeVu+9GHynPsTKu3LT4lGWoZu/qz/+lAluvJJusH
// SIG // 4wMzCXpkCrIxERw2/oOPV9BMcCMzNKrX3ygf4eyKQ/Ff
// SIG // UmrNxxnjSzW+V96RYeg5pC9Fyfm/SdxStr0OHca+7rVq
// SIG // UhW7LtxUsEiVtO2L0l7g7ePVWM0i0SOV7M0345euDTAR
// SIG // IaTAQqPcJ3+iXlaUbuGju66BgMEiUCfYIzJmz8fQu1o9
// SIG // FY7PbxE9OXhdEJrVKk8pRtx3xRxVBQhbNQeOw0qOSjfi
// SIG // Anj1H5aUD7dbX6TLfGqK1aW7YzpjRj734WawhPQfX4VE
// SIG // ycIO5NPEXymykJyL
