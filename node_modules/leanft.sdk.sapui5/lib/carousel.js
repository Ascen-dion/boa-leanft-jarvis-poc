 ...
 * @param {Object} [props] Initializes a Carousel test object using the supplied property bag.
 * @returns {Carousel} the description object that was initialized.
 * @constructor
 * @memberof SAPUI5
...
function Carousel(props) {
    var carouselDes = new SAPUI5BaseDesc("Carousel");

    Core.ObjectUtils.extend(carouselDes, HelperBehaviors.EnabledDescriptionBehavior);
    Core.ObjectUtils.extend(carouselDes, HelperBehaviors.OrientationDescriptionBehavior);
    Core.ObjectUtils.extend(carouselDes, HelperBehaviors.ItemsCountDescriptionBehavior);

    carouselDes._defineByPropertyBag(props);
 ...
 * @mixes SAPUI5.CarouselTOBehavior._properties
 */
function CarouselTO(session, description) {
    description = description || Carousel();
    var carouselTO = new SAPUI5BaseTestObject("SAPUICarousel", session, description);

    carouselTO._mergeBehavior(HelperBehaviors.EnabledTOBehavior);
    carouselTO._mergeBehavior(HelperBehaviors.OrientationTOBehavior);
    carouselTO._mergeBehavior(HelperBehaviors.NavigationTOBehavior);
    carouselTO._mergeBehavior(CarouselTOBehavior);
 ...
 * @memberof SAPUI5
 */
var CarouselTOBehavior = {
    /**
     * @ignore
     * @memberof SAPUI5.CarouselTOBehavior
     */
    _properties: {
        /**
         * The number of items contained in the carousel.
         * @function
         * @returns {Promise<number>} a promise that is fulfilled with the number of items contained in the carousel.
         */
        itemsCount: {
            type: 'uint',
            wiredName: "items count"
        }
    }
};

module.exports.Carousel = Carousel;
module.exports.CarouselTO = CarouselTO;
...
// SIG // PcHwwgcOOAqA4ZdV8cK8DkGM4bp6Am4V2h3nj9nG3kmg
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDPu8wKQA7nxyNK/f/bqkX5
// SIG // Edn2rdPQc+ZwX0F8cRXV8jANBgkqhkiG9w0BAQEFAASC
// SIG // AQCjhUplOdJ+sfdRd9iK26lLmI8PYFz+drEPfTPwp8yh
// SIG // t+rg5Lff13OtAj0Qg3PFXnoRUdnhJHdslKM/32L+4VJl
// SIG // q6tPS2bQ/MbjwQXNq3MnJ81v5+Xgua5nmuauzgGq3pqy
// SIG // aoIkfhxCTn1krsd3coidqTD5Prh+3tFgJr1198kK2aAA
// SIG // uDrBhaxgxZgP3JAI78NmiOmHPjLS1aokegLbbb2FglEN
// SIG // NYXb0fKUxUerCmKtoBYJhYfSPQ9pTJn+JPYjO3eKQh+h
// SIG // jAgXaCLSMtyUZkWHdLNoayDiobwcfjaN1WQqGwbBj1CG
// SIG // Hpmxysd5EOyKTEcoSuH7NvPbK7CnKCa9rrGAoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgtHqRXjnx4O+cY+lQ
// SIG // 3FEiNjU4T+LkLBM2YtkQMwRvwRACFQDRa0wbjH4GIAdT
// SIG // lN4juFxNSoa4thgPMjAxODAyMTMxNjQ4MjZaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjQ4MjZaMC8G
// SIG // CSqGSIb3DQEJBDEiBCCkwRYafKueAaBzPb6h6UwMGJdz
// SIG // kYWP2Zy7myYQyZtAuzA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEADSAHC+m5vDrH8kQp
// SIG // RTgQpTyYHYkBPGHu1YSMhUO4aL5PC/lgxu8PiZKf3c/g
// SIG // nhw1WDRYhTM8G3ev2mZBVFMnm2k3Wo7DRF5fJUGks5g8
// SIG // yjCjgtQ4CydLXbGQTpFf9/tMzMYHsijEcyFeRuLNpewG
// SIG // W6G5Yv7EXA7rQxYZ9NiomuQrLM13f3OTr5wr3P+2ULPX
// SIG // T0wMkqcJ4S8dRIByjBOUATcvTQTHfaB8U2V0GM3usdbz
// SIG // STjsn4M8jMYBHju1suZXQdrfrpc3vafG5ELf2L/6hJIh
// SIG // +r94ljdzT8tshFUam8oUfzEb8khMmX9eWFdarcSa11j/
// SIG // /BbSJZMd9gFD3Z5ZEg==
