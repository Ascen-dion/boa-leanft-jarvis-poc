...
function Menubar(props) {
    var menubarDes = new SAPUI5BaseDesc("Menubar");

    Core.ObjectUtils.extend(menubarDes, HelperBehaviors.EnabledDescriptionBehavior);
    Core.ObjectUtils.extend(menubarDes, HelperBehaviors.ItemsCountDescriptionBehavior);
    Core.ObjectUtils.extend(menubarDes, HelperBehaviors.ItemsDescriptionBehavior);

    menubarDes._defineByPropertyBag(props);
 ...
 * @mixes SAPUI5.SelectItemTOBehavior._methods
 */
function MenubarTO(session, description) {
    description = description || Menubar();
    var menubarTO = new SAPUI5BaseTestObject("SAPUIMenubar", session, description);

    menubarTO._mergeBehavior(HelperBehaviors.EnabledTOBehavior);
    menubarTO._mergeBehavior(HelperBehaviors.ItemsTOBehavior);
    menubarTO._mergeBehavior(HelperBehaviors.SelectItemTOBehavior);
...
// SIG // YR/yiQI8eROKncPbu9QLCbD3Iaz4e28jglX0sQhtLxag
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDXZt0K2sV6RISLzsGAQEvF
// SIG // 3CkHXJA2Qywh5VHH+yURwDANBgkqhkiG9w0BAQEFAASC
// SIG // AQCfWnoQ0v9JG2L0Q/YQCO85b8pqwGZjfhEWwKwKqVZK
// SIG // hRXQfatjLEcZrYr+qPT81fGE4A2mNlWaDxxfmO9aS4ia
// SIG // VWW2B3i7PqBj4bo28DPSpccByCx9DSi7RBKWal9IdGkf
// SIG // IQtT+7FFO9YBU5uH9kcxYTle5DTlf0kcjIyR4cCf9bvc
// SIG // I3CY6zt6KOrZoTQuqGyK6BSNKLTF8sx3kMF0MSDOZ00S
// SIG // GM9nIG+dk16pIbvQnNB53IhgU/v1lUMIcdSpYoQwTzWE
// SIG // ErLj7OBlPBRyQa1TG4cOANGVgmyJF9ctZKLCVVH6nSyw
// SIG // NZzI24lffcY6mbR/Jq4L5rslOyY4REyRSJzboYIOPDCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgAEuTSpPJpF0iyAgd
// SIG // Gb4Ry65pcAZxh/4M5duTnbX7H/gCFANmU6M0bQsjWGEG
// SIG // Q8JsW98vAp+gGA8yMDE4MDIxMzE2NDgzMFowAwIBHqCB
...
// SIG // HAYJKoZIhvcNAQkFMQ8XDTE4MDIxMzE2NDgzMFowLwYJ
// SIG // KoZIhvcNAQkEMSIEIHg1oVjjJLUV7mtLsypq1MyvhdsH
// SIG // 2W0dn5Ls73DaunR4MDcGCyqGSIb3DQEJEAIvMSgwJjAk
// SIG // MCIEIM96wXrQR+zV/cNoIgMbEtTvB4tvK0xea6Qfj/LP
// SIG // S61nMAsGCSqGSIb3DQEBAQSCAQCRxYJ7T0dUqjNLu6Z7
// SIG // QmAvRYIzqMugUMF9exLrPUY90Kv28v9h29dtocPTit+b
// SIG // v7YVhkDtpPHYK/Xo6D0N0qDABoZ0Lqy8Pd1AAOEyHV1t
// SIG // KWvWkBcESjj6noxjgbY8YomZGz5Cu7upS5KXFSU8ywM/
// SIG // VCJe0RCeYtJz8p9fa2mz0fOyaEdPPPokGzu0fXKn1GMv
// SIG // eC4eGW+mLEh0D8rKRpExJWQbciCW6XHlSNYhu7TFSor8
// SIG // 85PsX5K2WVd+NK+SPrTnJP/WlFCYWO/TESK+t4olFWin
// SIG // gTKV1BMpQmnqBsHRR7zm4XvJEsg4xY6pgPF3cZKOuiq9
// SIG // JbJkqqdmh8PRueEk
