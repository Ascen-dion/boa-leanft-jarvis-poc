...
/**
 * The base description for all SAPUI5 elements
 * @class SAPUI5BaseDesc
 * @extends Web.WebBaseDescription
 * @mixes Web.WebElementDescriptionBehavior
 * @memberof SAPUI5
 * @ignore
 */
function SAPUI5BaseDesc(leanFtType) {
    var desc = new WebBehaviors.WebBaseDescription(leanFtType);
    desc.leanFTType.technology = "SAPUI5";
    Core.ObjectUtils.extend(desc, WebBehaviors.WebElementDescriptionBehavior);

    return desc;
}

/**
 * @class SAPUI5BaseTestObject
 * @param nativeClass
 * @param session
 * @param description
 * @constructor
 ...
 * @ignore
 */
function SAPUI5BaseTestObject(nativeClass,session,description) {
    var testObj = new WebBehaviors.WebBaseTestObject(nativeClass, session, description);

    testObj._mergeBehavior(Core.ClickBehavior);
    testObj._mergeBehavior(Core.DragAndDropBehavior);
    testObj._mergeBehavior(WebBehaviors.WebElementTOBehavior);

    return testObj;
}

module.exports.SAPUI5BaseDesc = SAPUI5BaseDesc;
module.exports.SAPUI5BaseTestObject = SAPUI5BaseTestObject;
// SIG // Begin signature block
// SIG // MIIi1wYJKoZIhvcNAQcCoIIiyDCCIsQCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // cKIWcBoMzqOkXZ5KnM7BoU/jxJOekgRsDHK5cCL6Uyag
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCDlyyfkDfs4jezFJF1oipfX
// SIG // xRehe763k9/FDH3KSTj9ODANBgkqhkiG9w0BAQEFAASC
// SIG // AQB37dDxZLrfllu4CEllbw6uBpQH5oUnKZN8gUOZPQiJ
// SIG // YtIPpBi3CK2sJF/luVMZ0eNGFyaVHfd+SyJxlb7c8zsW
// SIG // /tzMcptRlrwNgjbPSVovkK9HOAkyI9PACFfl9uJtk58o
// SIG // GqZR81oLRDgADB3+O9wkdak7GhJsraJmfhg2/Bh5sN1h
// SIG // 6DmBthIj0KZqjKEVVf3nZhLIqoe3FJB5T1KENAiIlHN+
// SIG // 4zKnLLs4j7S0fA4P5ljIB4sB/LWAcYtUFlA0iEqhBBSD
// SIG // BHm4zqtGGtW5xCvzKSnRlhYviBXe0L9GAMIpYrGRcgJ+
// SIG // rQdw5TAzLTiri53CUHGlO/HWEgWYpN/scZoDoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgQ3J5dboIXJjEtdyH
// SIG // uFYjN0N2dH5mlU5LubCRG8ptzegCFQDiOOnw/3SpFgrV
// SIG // zcJpZkmncFo6DhgPMjAxODAyMTMxNjQ4NDZaMAMCAR6g
...
// SIG // MBwGCSqGSIb3DQEJBTEPFw0xODAyMTMxNjQ4NDZaMC8G
// SIG // CSqGSIb3DQEJBDEiBCC2xHMcyM1wpA7bWyTl4FauPLo2
// SIG // rInn+I9QYFL0H1i31DA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAkF7J68QR+f13d5Zo
// SIG // uzkPge54Ove6RpSapSo4as/TPfc+CnEUuJNgk29ZHZN1
// SIG // Ve0YQnhcAMSJmPMtTGk6isnVlHNeq9QNPosyYM/1NQ5K
// SIG // OuomDYpyFJJSFCdNAQ4xWBgA3hEpSfmUg1tOVEpLsUB3
// SIG // TUwTnJkz4v1v7OabKjQS11u2Mxhi2qHpFOnSjKf7/qS7
// SIG // mhKRbmuv8U6n7UylI70tb6m4vQTfPDYaqgaU9VUJexzl
// SIG // BZZhg066sRlEx3ikoVklAEm28OyIenR3iDLv08jxG5vI
// SIG // tVLl7nVhI8KDT9+KgYryYDgVV7mYDGWh5KR0z5KgHlKm
// SIG // vokvtPmC25QH2jtjlw==
