...
/**
 * The description of an SAPUI5 Toggle Button test object.
 * @param {Object} [props] Initializes a Toggle Button test object using the supplied property bag.
...
function Toggle(props) {
    var toggleDes = new SAPUI5BaseDesc("ToggleButton");

    ObjectUtils.extend(toggleDes, Web.ButtonDescriptionBehavior);
    ObjectUtils.extend(toggleDes, HelperBehaviors.EnabledDescriptionBehavior);
    ObjectUtils.extend(toggleDes, HelperBehaviors.CheckedDescriptionBehavior);
...
function ToggleTO(session, description) {
    ...
    var toggleTO = new SAPUI5BaseTestObject("SAPUIToggleButton", session, description);

    toggleTO._mergeBehavior(Web.ButtonTOBehavior);
    toggleTO._mergeBehavior(Web.CheckBoxTOBehavior);
    toggleTO._mergeBehavior(HelperBehaviors.CheckedTOBehavior);
    toggleTO._mergeBehavior(HelperBehaviors.EnabledTOBehavior);
...
// SIG // LX4M2K83TmqqYyJSJH85OnR0DXYqJIw4ZPG+K+84KH2g
...
// SIG // MC8GCSqGSIb3DQEJBDEiBCASNDYBe6/6pgviZSj9KIYM
// SIG // Pz2sgeqxKb0HWnbD7+1KbzANBgkqhkiG9w0BAQEFAASC
// SIG // AQAbJRmx/Ho24MhPjZG+yi/fM7vj9XZDkvLBURAiqEu2
// SIG // wIUZTe6t99FbgDHlrdMTws2ubenYhMnDo7bBggTHLgRy
// SIG // tDjDoAYOm+hiUMePvguvbSXT+TxoEC5oe4b7WUMv/HoG
// SIG // DR0b+ZeuPihNxoj6I8nLmY+NLYQH3bSmM/QiPQjBi5NC
// SIG // 3Waqqwb+TEanqPeQQZoS9iiHku/lvUYH3QL5IO/UQkhu
// SIG // h/Mn5rB6sSh9gkj1adA93Mf5TjPTQ73FE5jEfTUHVc/w
// SIG // Ia96rmQj5ZAPlw2zkyzrcQwxgdEbv8Ai69wlP/C/CUyx
// SIG // NqVXHuNV1w+4QmsfiaE28BaSg+hRhZ+Wg1nWoYIOPTCC
...
// SIG // FwMwMTANBglghkgBZQMEAgEFAAQgXTAD7uhXsJ/4kLMu
// SIG // aQI1N/lt4iRi/8fjEsNgeq3w4gECFQCJtvKx3/cUxrqS
// SIG // XL3xBhmHghgMxBgPMjAxODAyMTMxNjQ4NDlaMAMCAR6g
...
// SIG // CSqGSIb3DQEJBDEiBCAJ/CPrePZRLglbhVgYzQUWJuvG
// SIG // CiolLduRJq8ZG1ltTDA3BgsqhkiG9w0BCRACLzEoMCYw
// SIG // JDAiBCDPesF60Efs1f3DaCIDGxLU7weLbytMXmukH4/y
// SIG // z0utZzALBgkqhkiG9w0BAQEEggEAAnTAtE4br+4ZPQcy
// SIG // 0t7phAe+VwCTj2a/evUPxbTSNGXDuu4MhRVdml6brKas
// SIG // Byx74o2E68QghefiFKEilUgz8TBv6Gcfalk/1OyDkuqm
// SIG // qFSQ4+cU0lQ7aykzQinyeUQbDsyJECSEM+yRPmlJJ/UV
// SIG // zANtv+V4V3cmDOpSCw9bEQh15MIr8vvxIOUgPFp4/spm
// SIG // 4sEE7VDYfTeDlXPaaHy5SUP2JboSFM67yioqgoa1uHeK
// SIG // o8E+PjFwpwKwoX8GxZR6RO8diBSfVefK57+3dZj0Ckw6
// SIG // QR5MOY4yH2sBhj08unUwEcJaQok2yN5aXa1t/SyzLHq2
// SIG // WejdXvRm4CqfoZ/qRw==
